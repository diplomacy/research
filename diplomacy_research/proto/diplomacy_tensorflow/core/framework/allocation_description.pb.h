...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2fallocation_5fdescription_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2fallocation_5fdescription_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2fallocation_5fdescription_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::AllocationDescription* Arena::CreateMaybeMessage<::diplomacy::tensorflow::AllocationDescription>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class AllocationDescription : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.AllocationDescription) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.AllocationDescription)
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2fallocation_5fdescription_2eproto::TableStruct;
};
// ===================================================================
...
inline ::google::protobuf::int64 AllocationDescription::requested_bytes() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.AllocationDescription.requested_bytes)
...
inline void AllocationDescription::set_requested_bytes(::google::protobuf::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.AllocationDescription.requested_bytes)
}
...
inline ::google::protobuf::int64 AllocationDescription::allocated_bytes() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.AllocationDescription.allocated_bytes)
  return allocated_bytes_;
}
inline void AllocationDescription::set_allocated_bytes(::google::protobuf::int64 value) {
  
  allocated_bytes_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.AllocationDescription.allocated_bytes)
}
...
inline const ::std::string& AllocationDescription::allocator_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.AllocationDescription.allocator_name)
...
inline void AllocationDescription::set_allocator_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.AllocationDescription.allocator_name)
}
#if LANG_CXX11
inline void AllocationDescription::set_allocator_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.AllocationDescription.allocator_name)
}
#endif
inline void AllocationDescription::set_allocator_name(const char* value) {
  ...
  allocator_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.AllocationDescription.allocator_name)
}
inline void AllocationDescription::set_allocator_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.AllocationDescription.allocator_name)
}
inline ::std::string* AllocationDescription::mutable_allocator_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.AllocationDescription.allocator_name)
...
inline ::std::string* AllocationDescription::release_allocator_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.AllocationDescription.allocator_name)
...
inline void AllocationDescription::set_allocated_allocator_name(::std::string* allocator_name) {
  ...
  allocator_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), allocator_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.AllocationDescription.allocator_name)
}
inline ::std::string* AllocationDescription::unsafe_arena_release_allocator_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.AllocationDescription.allocator_name)
...
inline void AllocationDescription::unsafe_arena_set_allocated_allocator_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.AllocationDescription.allocator_name)
}
...
inline ::google::protobuf::int64 AllocationDescription::allocation_id() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.AllocationDescription.allocation_id)
  return allocation_id_;
}
inline void AllocationDescription::set_allocation_id(::google::protobuf::int64 value) {
  
  allocation_id_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.AllocationDescription.allocation_id)
}
...
inline bool AllocationDescription::has_single_reference() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.AllocationDescription.has_single_reference)
...
inline void AllocationDescription::set_has_single_reference(bool value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.AllocationDescription.has_single_reference)
}
...
inline ::google::protobuf::uint64 AllocationDescription::ptr() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.AllocationDescription.ptr)
  return ptr_;
}
inline void AllocationDescription::set_ptr(::google::protobuf::uint64 value) {
  
  ptr_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.AllocationDescription.ptr)
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2fallocation_5fdescription_2eproto
