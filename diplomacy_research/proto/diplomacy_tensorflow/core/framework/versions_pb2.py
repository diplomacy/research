...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/core/framework/versions.proto',
...
_VERSIONDEF = _descriptor.Descriptor(
  name='VersionDef',
  full_name='diplomacy.tensorflow.VersionDef',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='producer', full_name='diplomacy.tensorflow.VersionDef.producer', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='min_consumer', full_name='diplomacy.tensorflow.VersionDef.min_consumer', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bad_consumers', full_name='diplomacy.tensorflow.VersionDef.bad_consumers', index=2,
...
VersionDef = _reflection.GeneratedProtocolMessageType('VersionDef', (_message.Message,), dict(
  ...
  __module__ = 'diplomacy_tensorflow.core.framework.versions_pb2'
