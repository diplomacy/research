...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/core/framework/graph.proto',
  ...
  ,
  dependencies=[diplomacy__tensorflow_dot_core_dot_framework_dot_node__def__pb2.DESCRIPTOR,diplomacy__tensorflow_dot_core_dot_framework_dot_function__pb2.DESCRIPTOR,diplomacy__tensorflow_dot_core_dot_framework_dot_versions__pb2.DESCRIPTOR,])
...
_GRAPHDEF = _descriptor.Descriptor(
  name='GraphDef',
  full_name='diplomacy.tensorflow.GraphDef',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='node', full_name='diplomacy.tensorflow.GraphDef.node', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='versions', full_name='diplomacy.tensorflow.GraphDef.versions', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='version', full_name='diplomacy.tensorflow.GraphDef.version', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='library', full_name='diplomacy.tensorflow.GraphDef.library', index=3,
...
_GRAPHDEF.fields_by_name['node'].message_type = diplomacy__tensorflow_dot_core_dot_framework_dot_node__def__pb2._NODEDEF
_GRAPHDEF.fields_by_name['versions'].message_type = diplomacy__tensorflow_dot_core_dot_framework_dot_versions__pb2._VERSIONDEF
_GRAPHDEF.fields_by_name['library'].message_type = diplomacy__tensorflow_dot_core_dot_framework_dot_function__pb2._FUNCTIONDEFLIBRARY
...
GraphDef = _reflection.GeneratedProtocolMessageType('GraphDef', (_message.Message,), dict(
  ...
  __module__ = 'diplomacy_tensorflow.core.framework.graph_pb2'
