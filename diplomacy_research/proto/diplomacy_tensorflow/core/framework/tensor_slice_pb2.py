...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/core/framework/tensor_slice.proto',
...
_TENSORSLICEPROTO_EXTENT = _descriptor.Descriptor(
  name='Extent',
  full_name='diplomacy.tensorflow.TensorSliceProto.Extent',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='start', full_name='diplomacy.tensorflow.TensorSliceProto.Extent.start', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='length', full_name='diplomacy.tensorflow.TensorSliceProto.Extent.length', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='has_length', full_name='diplomacy.tensorflow.TensorSliceProto.Extent.has_length',
...
_TENSORSLICEPROTO = _descriptor.Descriptor(
  ...
  full_name='diplomacy.tensorflow.TensorSliceProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='extent', full_name='diplomacy.tensorflow.TensorSliceProto.extent', index=0,
...
TensorSliceProto = _reflection.GeneratedProtocolMessageType('TensorSliceProto', (_message.Message,), dict(
  ...
  Extent = _reflection.GeneratedProtocolMessageType('Extent', (_message.Message,), dict(
    ...
    __module__ = 'diplomacy_tensorflow.core.framework.tensor_slice_pb2'
