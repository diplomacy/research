...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/core/framework/tensor_shape.proto',
...
_TENSORSHAPEPROTO_DIM = _descriptor.Descriptor(
  name='Dim',
  full_name='diplomacy.tensorflow.TensorShapeProto.Dim',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='size', full_name='diplomacy.tensorflow.TensorShapeProto.Dim.size', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='diplomacy.tensorflow.TensorShapeProto.Dim.name', index=1,
...
_TENSORSHAPEPROTO = _descriptor.Descriptor(
  ...
  full_name='diplomacy.tensorflow.TensorShapeProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dim', full_name='diplomacy.tensorflow.TensorShapeProto.dim', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='unknown_rank', full_name='diplomacy.tensorflow.TensorShapeProto.unknown_rank', index=1,
...
TensorShapeProto = _reflection.GeneratedProtocolMessageType('TensorShapeProto', (_message.Message,), dict(
  ...
  Dim = _reflection.GeneratedProtocolMessageType('Dim', (_message.Message,), dict(
    ...
    __module__ = 'diplomacy_tensorflow.core.framework.tensor_shape_pb2'
