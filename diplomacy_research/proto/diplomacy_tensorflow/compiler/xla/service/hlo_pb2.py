...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/compiler/xla/service/hlo.proto',
  package='xla',
  syntax='proto3',
  ...
  ,
  dependencies=[diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2.DESCRIPTOR,])
...
_HLOINSTRUCTIONPROTO.fields_by_name['shape'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._SHAPEPROTO
_HLOINSTRUCTIONPROTO.fields_by_name['metadata'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._OPMETADATA
_HLOINSTRUCTIONPROTO.fields_by_name['literal'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._LITERALPROTO
_HLOINSTRUCTIONPROTO.fields_by_name['window'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._WINDOW
_HLOINSTRUCTIONPROTO.fields_by_name['convolution_dimension_numbers'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._CONVOLUTIONDIMENSIONNUMBERS
_HLOINSTRUCTIONPROTO.fields_by_name['slice_dimensions'].message_type = _HLOINSTRUCTIONPROTO_SLICEDIMENSIONS
_HLOINSTRUCTIONPROTO.fields_by_name['padding_config'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._PADDINGCONFIG
_HLOINSTRUCTIONPROTO.fields_by_name['distribution'].enum_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._RANDOMDISTRIBUTION
_HLOINSTRUCTIONPROTO.fields_by_name['outfeed_shape'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._SHAPEPROTO
_HLOINSTRUCTIONPROTO.fields_by_name['dot_dimension_numbers'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._DOTDIMENSIONNUMBERS
_HLOINSTRUCTIONPROTO.fields_by_name['fft_type'].enum_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._FFTTYPE
_HLOINSTRUCTIONPROTO.fields_by_name['gather_dimension_numbers'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._GATHERDIMENSIONNUMBERS
_HLOINSTRUCTIONPROTO.fields_by_name['sharding'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._OPSHARDING
_HLOINSTRUCTIONPROTO.fields_by_name['replica_groups'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._REPLICAGROUP
_HLOINSTRUCTIONPROTO.fields_by_name['scatter_dimension_numbers'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._SCATTERDIMENSIONNUMBERS
_HLOINSTRUCTIONPROTO.fields_by_name['precision_config'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._PRECISIONCONFIG
_HLOINSTRUCTIONPROTO.fields_by_name['source_target_pairs'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._SOURCETARGET
_HLOINSTRUCTIONPROTO.fields_by_name['domain_entry_sharding'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._OPSHARDING
_HLOINSTRUCTIONPROTO.fields_by_name['domain_exit_sharding'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._OPSHARDING
_HLOINSTRUCTIONPROTO.fields_by_name['operand_shapes_with_layout'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._SHAPEPROTO
_HLOCOMPUTATIONPROTO.fields_by_name['instructions'].message_type = _HLOINSTRUCTIONPROTO
_HLOCOMPUTATIONPROTO.fields_by_name['program_shape'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._PROGRAMSHAPEPROTO
...
_HLOSNAPSHOT.fields_by_name['arguments'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._LITERALPROTO
_HLOSNAPSHOT.fields_by_name['result'].message_type = diplomacy__tensorflow_dot_compiler_dot_xla_dot_xla__data__pb2._LITERALPROTO
...
HloInstructionProto = _reflection.GeneratedProtocolMessageType('HloInstructionProto', (_message.Message,), dict(
  ...
  SliceDimensions = _reflection.GeneratedProtocolMessageType('SliceDimensions', (_message.Message,), dict(
    ...
    __module__ = 'diplomacy_tensorflow.compiler.xla.service.hlo_pb2'
