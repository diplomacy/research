...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fdebug_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fdebug_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fdebug_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::DebugOptions* Arena::CreateMaybeMessage<::diplomacy::tensorflow::DebugOptions>(Arena*);
template<> ::diplomacy::tensorflow::DebugTensorWatch* Arena::CreateMaybeMessage<::diplomacy::tensorflow::DebugTensorWatch>(Arena*);
template<> ::diplomacy::tensorflow::DebuggedSourceFile* Arena::CreateMaybeMessage<::diplomacy::tensorflow::DebuggedSourceFile>(Arena*);
template<> ::diplomacy::tensorflow::DebuggedSourceFiles* Arena::CreateMaybeMessage<::diplomacy::tensorflow::DebuggedSourceFiles>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class DebugTensorWatch : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.DebugTensorWatch) */ {
 public:
  DebugTensorWatch();
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.DebugTensorWatch)
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fdebug_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class DebugOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.DebugOptions) */ {
 public:
  DebugOptions();
  ...
  ::diplomacy::tensorflow::DebugTensorWatch* mutable_debug_tensor_watch_opts(int index);
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::DebugTensorWatch >*
      mutable_debug_tensor_watch_opts();
  const ::diplomacy::tensorflow::DebugTensorWatch& debug_tensor_watch_opts(int index) const;
  ::diplomacy::tensorflow::DebugTensorWatch* add_debug_tensor_watch_opts();
  const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::DebugTensorWatch >&
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.DebugOptions)
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::DebugTensorWatch > debug_tensor_watch_opts_;
...
class DebuggedSourceFile : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.DebuggedSourceFile) */ {
 public:
  DebuggedSourceFile();
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.DebuggedSourceFile)
 private:
...
class DebuggedSourceFiles : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.DebuggedSourceFiles) */ {
 public:
  DebuggedSourceFiles();
  ...
  ::diplomacy::tensorflow::DebuggedSourceFile* mutable_source_files(int index);
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::DebuggedSourceFile >*
      mutable_source_files();
  const ::diplomacy::tensorflow::DebuggedSourceFile& source_files(int index) const;
  ::diplomacy::tensorflow::DebuggedSourceFile* add_source_files();
  const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::DebuggedSourceFile >&
      source_files() const;

  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.DebuggedSourceFiles)
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::DebuggedSourceFile > source_files_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fdebug_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::std::string& DebugTensorWatch::node_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DebugTensorWatch.node_name)
...
inline void DebugTensorWatch::set_node_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DebugTensorWatch.node_name)
}
#if LANG_CXX11
inline void DebugTensorWatch::set_node_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.DebugTensorWatch.node_name)
}
#endif
inline void DebugTensorWatch::set_node_name(const char* value) {
  ...
  node_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.DebugTensorWatch.node_name)
}
inline void DebugTensorWatch::set_node_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.DebugTensorWatch.node_name)
}
inline ::std::string* DebugTensorWatch::mutable_node_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.DebugTensorWatch.node_name)
...
inline ::std::string* DebugTensorWatch::release_node_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.DebugTensorWatch.node_name)
...
inline void DebugTensorWatch::set_allocated_node_name(::std::string* node_name) {
  ...
  node_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), node_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.DebugTensorWatch.node_name)
}
inline ::std::string* DebugTensorWatch::unsafe_arena_release_node_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.DebugTensorWatch.node_name)
...
inline void DebugTensorWatch::unsafe_arena_set_allocated_node_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.DebugTensorWatch.node_name)
}
...
inline ::google::protobuf::int32 DebugTensorWatch::output_slot() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DebugTensorWatch.output_slot)
  return output_slot_;
}
inline void DebugTensorWatch::set_output_slot(::google::protobuf::int32 value) {
  
  output_slot_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DebugTensorWatch.output_slot)
}
...
inline const ::std::string& DebugTensorWatch::debug_ops(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DebugTensorWatch.debug_ops)
  return debug_ops_.Get(index);
}
inline ::std::string* DebugTensorWatch::mutable_debug_ops(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.DebugTensorWatch.debug_ops)
  return debug_ops_.Mutable(index);
}
inline void DebugTensorWatch::set_debug_ops(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DebugTensorWatch.debug_ops)
...
inline void DebugTensorWatch::set_debug_ops(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  debug_ops_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.DebugTensorWatch.debug_ops)
}
inline void DebugTensorWatch::set_debug_ops(int index, const char* value, size_t size) {
  debug_ops_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.DebugTensorWatch.debug_ops)
}
inline ::std::string* DebugTensorWatch::add_debug_ops() {
  // @@protoc_insertion_point(field_add_mutable:diplomacy.tensorflow.DebugTensorWatch.debug_ops)
  return debug_ops_.Add();
}
inline void DebugTensorWatch::add_debug_ops(const ::std::string& value) {
  debug_ops_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.DebugTensorWatch.debug_ops)
}
#if LANG_CXX11
...
inline void DebugTensorWatch::add_debug_ops(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  debug_ops_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:diplomacy.tensorflow.DebugTensorWatch.debug_ops)
}
inline void DebugTensorWatch::add_debug_ops(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:diplomacy.tensorflow.DebugTensorWatch.debug_ops)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
DebugTensorWatch::debug_ops() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.DebugTensorWatch.debug_ops)
  return debug_ops_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
DebugTensorWatch::mutable_debug_ops() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.DebugTensorWatch.debug_ops)
  return &debug_ops_;
}
...
inline const ::std::string& DebugTensorWatch::debug_urls(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DebugTensorWatch.debug_urls)
  return debug_urls_.Get(index);
}
inline ::std::string* DebugTensorWatch::mutable_debug_urls(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.DebugTensorWatch.debug_urls)
  return debug_urls_.Mutable(index);
}
inline void DebugTensorWatch::set_debug_urls(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DebugTensorWatch.debug_urls)
...
inline void DebugTensorWatch::set_debug_urls(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  debug_urls_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.DebugTensorWatch.debug_urls)
}
inline void DebugTensorWatch::set_debug_urls(int index, const char* value, size_t size) {
  debug_urls_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.DebugTensorWatch.debug_urls)
}
inline ::std::string* DebugTensorWatch::add_debug_urls() {
  // @@protoc_insertion_point(field_add_mutable:diplomacy.tensorflow.DebugTensorWatch.debug_urls)
  return debug_urls_.Add();
}
inline void DebugTensorWatch::add_debug_urls(const ::std::string& value) {
  debug_urls_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.DebugTensorWatch.debug_urls)
}
#if LANG_CXX11
...
inline void DebugTensorWatch::add_debug_urls(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  debug_urls_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:diplomacy.tensorflow.DebugTensorWatch.debug_urls)
}
inline void DebugTensorWatch::add_debug_urls(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:diplomacy.tensorflow.DebugTensorWatch.debug_urls)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
DebugTensorWatch::debug_urls() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.DebugTensorWatch.debug_urls)
  return debug_urls_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
DebugTensorWatch::mutable_debug_urls() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.DebugTensorWatch.debug_urls)
  return &debug_urls_;
}
...
inline bool DebugTensorWatch::tolerate_debug_op_creation_failures() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DebugTensorWatch.tolerate_debug_op_creation_failures)
...
inline void DebugTensorWatch::set_tolerate_debug_op_creation_failures(bool value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DebugTensorWatch.tolerate_debug_op_creation_failures)
}
...
inline ::diplomacy::tensorflow::DebugTensorWatch* DebugOptions::mutable_debug_tensor_watch_opts(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.DebugOptions.debug_tensor_watch_opts)
  return debug_tensor_watch_opts_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::DebugTensorWatch >*
DebugOptions::mutable_debug_tensor_watch_opts() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.DebugOptions.debug_tensor_watch_opts)
  return &debug_tensor_watch_opts_;
}
inline const ::diplomacy::tensorflow::DebugTensorWatch& DebugOptions::debug_tensor_watch_opts(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DebugOptions.debug_tensor_watch_opts)
  return debug_tensor_watch_opts_.Get(index);
}
inline ::diplomacy::tensorflow::DebugTensorWatch* DebugOptions::add_debug_tensor_watch_opts() {
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.DebugOptions.debug_tensor_watch_opts)
  return debug_tensor_watch_opts_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::DebugTensorWatch >&
DebugOptions::debug_tensor_watch_opts() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.DebugOptions.debug_tensor_watch_opts)
  return debug_tensor_watch_opts_;
}
...
inline ::google::protobuf::int64 DebugOptions::global_step() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DebugOptions.global_step)
  return global_step_;
}
inline void DebugOptions::set_global_step(::google::protobuf::int64 value) {
  
  global_step_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DebugOptions.global_step)
}
...
inline bool DebugOptions::reset_disk_byte_usage() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DebugOptions.reset_disk_byte_usage)
  return reset_disk_byte_usage_;
}
inline void DebugOptions::set_reset_disk_byte_usage(bool value) {
  
  reset_disk_byte_usage_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DebugOptions.reset_disk_byte_usage)
}
...
inline const ::std::string& DebuggedSourceFile::host() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DebuggedSourceFile.host)
  return host_.Get();
}
inline void DebuggedSourceFile::set_host(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DebuggedSourceFile.host)
}
#if LANG_CXX11
inline void DebuggedSourceFile::set_host(::std::string&& value) {
  ...
  host_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.DebuggedSourceFile.host)
}
#endif
inline void DebuggedSourceFile::set_host(const char* value) {
  ...
  host_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.DebuggedSourceFile.host)
}
inline void DebuggedSourceFile::set_host(const char* value,
    size_t size) {
  ...
  host_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.DebuggedSourceFile.host)
}
inline ::std::string* DebuggedSourceFile::mutable_host() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.DebuggedSourceFile.host)
...
inline ::std::string* DebuggedSourceFile::release_host() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.DebuggedSourceFile.host)
...
inline void DebuggedSourceFile::set_allocated_host(::std::string* host) {
  ...
  host_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), host,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.DebuggedSourceFile.host)
}
inline ::std::string* DebuggedSourceFile::unsafe_arena_release_host() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.DebuggedSourceFile.host)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void DebuggedSourceFile::unsafe_arena_set_allocated_host(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.DebuggedSourceFile.host)
}
...
inline const ::std::string& DebuggedSourceFile::file_path() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DebuggedSourceFile.file_path)
...
inline void DebuggedSourceFile::set_file_path(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DebuggedSourceFile.file_path)
}
#if LANG_CXX11
inline void DebuggedSourceFile::set_file_path(::std::string&& value) {
  ...
  file_path_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.DebuggedSourceFile.file_path)
}
#endif
inline void DebuggedSourceFile::set_file_path(const char* value) {
  ...
  file_path_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.DebuggedSourceFile.file_path)
}
inline void DebuggedSourceFile::set_file_path(const char* value,
    size_t size) {
  ...
  file_path_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.DebuggedSourceFile.file_path)
}
inline ::std::string* DebuggedSourceFile::mutable_file_path() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.DebuggedSourceFile.file_path)
...
inline ::std::string* DebuggedSourceFile::release_file_path() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.DebuggedSourceFile.file_path)
...
inline void DebuggedSourceFile::set_allocated_file_path(::std::string* file_path) {
  ...
  file_path_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), file_path,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.DebuggedSourceFile.file_path)
}
inline ::std::string* DebuggedSourceFile::unsafe_arena_release_file_path() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.DebuggedSourceFile.file_path)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void DebuggedSourceFile::unsafe_arena_set_allocated_file_path(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.DebuggedSourceFile.file_path)
}
...
inline ::google::protobuf::int64 DebuggedSourceFile::last_modified() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DebuggedSourceFile.last_modified)
  return last_modified_;
}
inline void DebuggedSourceFile::set_last_modified(::google::protobuf::int64 value) {
  
  last_modified_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DebuggedSourceFile.last_modified)
}
...
inline ::google::protobuf::int64 DebuggedSourceFile::bytes() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DebuggedSourceFile.bytes)
  return bytes_;
}
inline void DebuggedSourceFile::set_bytes(::google::protobuf::int64 value) {
  
  bytes_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DebuggedSourceFile.bytes)
}
...
inline const ::std::string& DebuggedSourceFile::lines(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DebuggedSourceFile.lines)
  return lines_.Get(index);
}
inline ::std::string* DebuggedSourceFile::mutable_lines(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.DebuggedSourceFile.lines)
  return lines_.Mutable(index);
}
inline void DebuggedSourceFile::set_lines(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DebuggedSourceFile.lines)
...
inline void DebuggedSourceFile::set_lines(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  lines_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.DebuggedSourceFile.lines)
}
inline void DebuggedSourceFile::set_lines(int index, const char* value, size_t size) {
  lines_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.DebuggedSourceFile.lines)
}
inline ::std::string* DebuggedSourceFile::add_lines() {
  // @@protoc_insertion_point(field_add_mutable:diplomacy.tensorflow.DebuggedSourceFile.lines)
  return lines_.Add();
}
inline void DebuggedSourceFile::add_lines(const ::std::string& value) {
  lines_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.DebuggedSourceFile.lines)
}
#if LANG_CXX11
...
inline void DebuggedSourceFile::add_lines(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  lines_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:diplomacy.tensorflow.DebuggedSourceFile.lines)
}
inline void DebuggedSourceFile::add_lines(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:diplomacy.tensorflow.DebuggedSourceFile.lines)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
DebuggedSourceFile::lines() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.DebuggedSourceFile.lines)
  return lines_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
DebuggedSourceFile::mutable_lines() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.DebuggedSourceFile.lines)
  return &lines_;
}
...
inline ::diplomacy::tensorflow::DebuggedSourceFile* DebuggedSourceFiles::mutable_source_files(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.DebuggedSourceFiles.source_files)
  return source_files_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::DebuggedSourceFile >*
DebuggedSourceFiles::mutable_source_files() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.DebuggedSourceFiles.source_files)
  return &source_files_;
}
inline const ::diplomacy::tensorflow::DebuggedSourceFile& DebuggedSourceFiles::source_files(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DebuggedSourceFiles.source_files)
  return source_files_.Get(index);
}
inline ::diplomacy::tensorflow::DebuggedSourceFile* DebuggedSourceFiles::add_source_files() {
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.DebuggedSourceFiles.source_files)
  return source_files_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::DebuggedSourceFile >&
DebuggedSourceFiles::source_files() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.DebuggedSourceFiles.source_files)
  return source_files_;
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fdebug_2eproto
