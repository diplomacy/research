...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/core/framework/node_def.proto',
...
_NODEDEF_ATTRENTRY = _descriptor.Descriptor(
  name='AttrEntry',
  full_name='diplomacy.tensorflow.NodeDef.AttrEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='diplomacy.tensorflow.NodeDef.AttrEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='diplomacy.tensorflow.NodeDef.AttrEntry.value', index=1,
...
_NODEDEF_EXPERIMENTALDEBUGINFO = _descriptor.Descriptor(
  ...
  full_name='diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='original_node_names', full_name='diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo.original_node_names', index=0,
...
_NODEDEF = _descriptor.Descriptor(
  name='NodeDef',
  full_name='diplomacy.tensorflow.NodeDef',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='diplomacy.tensorflow.NodeDef.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='op', full_name='diplomacy.tensorflow.NodeDef.op', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='input', full_name='diplomacy.tensorflow.NodeDef.input', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='device', full_name='diplomacy.tensorflow.NodeDef.device', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attr', full_name='diplomacy.tensorflow.NodeDef.attr', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='experimental_debug_info', full_name='diplomacy.tensorflow.NodeDef.experimental_debug_info', index=5,
...
_NODEDEF_ATTRENTRY.fields_by_name['value'].message_type = diplomacy__tensorflow_dot_core_dot_framework_dot_attr__value__pb2._ATTRVALUE
...
NodeDef = _reflection.GeneratedProtocolMessageType('NodeDef', (_message.Message,), dict(
  ...
  AttrEntry = _reflection.GeneratedProtocolMessageType('AttrEntry', (_message.Message,), dict(
    ...
    __module__ = 'diplomacy_tensorflow.core.framework.node_def_pb2'
    # @@protoc_insertion_point(class_scope:diplomacy.tensorflow.NodeDef.AttrEntry)
    ))
  ,
