...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_tensorflow_5fserving_2fconfig_2flog_5fcollector_5fconfig_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_LogCollectorConfig;
}  // namespace protobuf_tensorflow_5fserving_2fconfig_2flog_5fcollector_5fconfig_2eproto
...
class SamplingConfigDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<SamplingConfig>
      _instance;
...
namespace protobuf_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto {
static void InitDefaultsSamplingConfig() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_SamplingConfig =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsSamplingConfig}, {}};
...
::google::protobuf::internal::SCCInfo<2> scc_info_LoggingConfig =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsLoggingConfig}, {
...
void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_SamplingConfig.base);
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::serving::SamplingConfig, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::serving::SamplingConfig, sampling_rate_),
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::serving::LoggingConfig, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::serving::LoggingConfig, log_collector_config_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::serving::LoggingConfig, sampling_config_),
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::tensorflow::serving::_SamplingConfig_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&::tensorflow::serving::_LoggingConfig_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "tensorflow_serving/config/logging_config.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::protobuf_tensorflow_5fserving_2fconfig_2flog_5fcollector_5fconfig_2eproto::AddDescriptors();
}
...
SamplingConfig::SamplingConfig(::google::protobuf::Arena* arena)
  ...
  ::google::protobuf::internal::InitSCC(&protobuf_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto::scc_info_SamplingConfig.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* SamplingConfig::descriptor() {
  ...
  return ::protobuf_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata SamplingConfig::GetMetadata() const {
  protobuf_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
LoggingConfig::LoggingConfig(::google::protobuf::Arena* arena)
  : ::google::protobuf::Message(),
  _internal_metadata_(arena) {
  ::google::protobuf::internal::InitSCC(&protobuf_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto::scc_info_LoggingConfig.base);
  SharedCtor();
  RegisterArenaDtor(arena);
...
void LoggingConfig::SerializeWithCachedSizes(
  ...
  if (this->has_log_collector_config()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, this->_internal_log_collector_config(), output);
  }
  ...
  if (this->has_log_collector_config()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, this->_internal_log_collector_config(), deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::serving::SamplingConfig* Arena::CreateMaybeMessage< ::tensorflow::serving::SamplingConfig >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::serving::SamplingConfig >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::serving::LoggingConfig* Arena::CreateMaybeMessage< ::tensorflow::serving::LoggingConfig >(Arena* arena) {
