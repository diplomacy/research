...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2fversions_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2fversions_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2fversions_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::VersionDef* Arena::CreateMaybeMessage<::diplomacy::tensorflow::VersionDef>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class VersionDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.VersionDef) */ {
 public:
  VersionDef();
  virtual ~VersionDef();
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.VersionDef)
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2fversions_2eproto::TableStruct;
};
// ===================================================================
...
inline ::google::protobuf::int32 VersionDef::producer() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.VersionDef.producer)
  return producer_;
}
inline void VersionDef::set_producer(::google::protobuf::int32 value) {
  
  producer_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.VersionDef.producer)
}
...
inline ::google::protobuf::int32 VersionDef::min_consumer() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.VersionDef.min_consumer)
  return min_consumer_;
}
inline void VersionDef::set_min_consumer(::google::protobuf::int32 value) {
  
  min_consumer_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.VersionDef.min_consumer)
}
...
inline ::google::protobuf::int32 VersionDef::bad_consumers(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.VersionDef.bad_consumers)
...
inline void VersionDef::set_bad_consumers(int index, ::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.VersionDef.bad_consumers)
}
inline void VersionDef::add_bad_consumers(::google::protobuf::int32 value) {
  bad_consumers_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.VersionDef.bad_consumers)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
VersionDef::bad_consumers() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.VersionDef.bad_consumers)
  return bad_consumers_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
VersionDef::mutable_bad_consumers() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.VersionDef.bad_consumers)
  return &bad_consumers_;
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2fversions_2eproto
