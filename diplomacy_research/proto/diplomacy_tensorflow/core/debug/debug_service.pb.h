...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fdebug_2fdebug_5fservice_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fdebug_2fdebug_5fservice_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fdebug_2fdebug_5fservice_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::CallTraceback* Arena::CreateMaybeMessage<::diplomacy::tensorflow::CallTraceback>(Arena*);
template<> ::diplomacy::tensorflow::CallTraceback_OriginIdToStringEntry_DoNotUse* Arena::CreateMaybeMessage<::diplomacy::tensorflow::CallTraceback_OriginIdToStringEntry_DoNotUse>(Arena*);
template<> ::diplomacy::tensorflow::EventReply* Arena::CreateMaybeMessage<::diplomacy::tensorflow::EventReply>(Arena*);
template<> ::diplomacy::tensorflow::EventReply_DebugOpStateChange* Arena::CreateMaybeMessage<::diplomacy::tensorflow::EventReply_DebugOpStateChange>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class EventReply_DebugOpStateChange : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.EventReply.DebugOpStateChange) */ {
 public:
  ...
  ::diplomacy::tensorflow::EventReply_DebugOpStateChange_State state() const;
  void set_state(::diplomacy::tensorflow::EventReply_DebugOpStateChange_State value);
 ...
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fdebug_2fdebug_5fservice_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class EventReply : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.EventReply) */ {
 public:
  EventReply();
  virtual ~EventReply();
  ...
  ::diplomacy::tensorflow::EventReply_DebugOpStateChange* mutable_debug_op_state_changes(int index);
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::EventReply_DebugOpStateChange >*
      mutable_debug_op_state_changes();
  const ::diplomacy::tensorflow::EventReply_DebugOpStateChange& debug_op_state_changes(int index) const;
  ::diplomacy::tensorflow::EventReply_DebugOpStateChange* add_debug_op_state_changes();
  const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::EventReply_DebugOpStateChange >&
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::EventReply_DebugOpStateChange > debug_op_state_changes_;
...
class CallTraceback : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.CallTraceback) */ {
 public:
  CallTraceback();
  ...
  private:
  const ::diplomacy::tensorflow::tfprof::CodeDef& _internal_origin_stack() const;
  public:
  const ::diplomacy::tensorflow::tfprof::CodeDef& origin_stack() const;
  ::diplomacy::tensorflow::tfprof::CodeDef* release_origin_stack();
  ::diplomacy::tensorflow::tfprof::CodeDef* mutable_origin_stack();
  void set_allocated_origin_stack(::diplomacy::tensorflow::tfprof::CodeDef* origin_stack);
  ...
  private:
  const ::diplomacy::tensorflow::tfprof::OpLogProto& _internal_graph_traceback() const;
  public:
  const ::diplomacy::tensorflow::tfprof::OpLogProto& graph_traceback() const;
  ::diplomacy::tensorflow::tfprof::OpLogProto* release_graph_traceback();
  ::diplomacy::tensorflow::tfprof::OpLogProto* mutable_graph_traceback();
  void set_allocated_graph_traceback(::diplomacy::tensorflow::tfprof::OpLogProto* graph_traceback);
  ...
  ::diplomacy::tensorflow::CallTraceback_CallType call_type() const;
  void set_call_type(::diplomacy::tensorflow::CallTraceback_CallType value);
 ...
 private:
  ...
  ::diplomacy::tensorflow::tfprof::CodeDef* origin_stack_;
  ::diplomacy::tensorflow::tfprof::OpLogProto* graph_traceback_;
...
inline ::diplomacy::tensorflow::EventReply_DebugOpStateChange_State EventReply_DebugOpStateChange::state() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.EventReply.DebugOpStateChange.state)
  return static_cast< ::diplomacy::tensorflow::EventReply_DebugOpStateChange_State >(state_);
}
inline void EventReply_DebugOpStateChange::set_state(::diplomacy::tensorflow::EventReply_DebugOpStateChange_State value) {
  
  state_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.EventReply.DebugOpStateChange.state)
}
...
inline const ::std::string& EventReply_DebugOpStateChange::node_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.EventReply.DebugOpStateChange.node_name)
...
inline void EventReply_DebugOpStateChange::set_node_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.EventReply.DebugOpStateChange.node_name)
}
#if LANG_CXX11
inline void EventReply_DebugOpStateChange::set_node_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.EventReply.DebugOpStateChange.node_name)
}
#endif
inline void EventReply_DebugOpStateChange::set_node_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.EventReply.DebugOpStateChange.node_name)
}
inline void EventReply_DebugOpStateChange::set_node_name(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.EventReply.DebugOpStateChange.node_name)
}
inline ::std::string* EventReply_DebugOpStateChange::mutable_node_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.EventReply.DebugOpStateChange.node_name)
...
inline ::std::string* EventReply_DebugOpStateChange::release_node_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.EventReply.DebugOpStateChange.node_name)
...
inline void EventReply_DebugOpStateChange::set_allocated_node_name(::std::string* node_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.EventReply.DebugOpStateChange.node_name)
}
...
inline ::google::protobuf::int32 EventReply_DebugOpStateChange::output_slot() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.EventReply.DebugOpStateChange.output_slot)
  return output_slot_;
}
inline void EventReply_DebugOpStateChange::set_output_slot(::google::protobuf::int32 value) {
  
  output_slot_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.EventReply.DebugOpStateChange.output_slot)
}
...
inline const ::std::string& EventReply_DebugOpStateChange::debug_op() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.EventReply.DebugOpStateChange.debug_op)
...
inline void EventReply_DebugOpStateChange::set_debug_op(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.EventReply.DebugOpStateChange.debug_op)
}
#if LANG_CXX11
inline void EventReply_DebugOpStateChange::set_debug_op(::std::string&& value) {
  ...
  debug_op_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.EventReply.DebugOpStateChange.debug_op)
}
#endif
inline void EventReply_DebugOpStateChange::set_debug_op(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.EventReply.DebugOpStateChange.debug_op)
}
inline void EventReply_DebugOpStateChange::set_debug_op(const char* value, size_t size) {
  ...
  debug_op_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.EventReply.DebugOpStateChange.debug_op)
}
inline ::std::string* EventReply_DebugOpStateChange::mutable_debug_op() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.EventReply.DebugOpStateChange.debug_op)
...
inline ::std::string* EventReply_DebugOpStateChange::release_debug_op() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.EventReply.DebugOpStateChange.debug_op)
...
inline void EventReply_DebugOpStateChange::set_allocated_debug_op(::std::string* debug_op) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.EventReply.DebugOpStateChange.debug_op)
}
...
inline ::diplomacy::tensorflow::EventReply_DebugOpStateChange* EventReply::mutable_debug_op_state_changes(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.EventReply.debug_op_state_changes)
  return debug_op_state_changes_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::EventReply_DebugOpStateChange >*
EventReply::mutable_debug_op_state_changes() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.EventReply.debug_op_state_changes)
  return &debug_op_state_changes_;
}
inline const ::diplomacy::tensorflow::EventReply_DebugOpStateChange& EventReply::debug_op_state_changes(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.EventReply.debug_op_state_changes)
  return debug_op_state_changes_.Get(index);
}
inline ::diplomacy::tensorflow::EventReply_DebugOpStateChange* EventReply::add_debug_op_state_changes() {
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.EventReply.debug_op_state_changes)
  return debug_op_state_changes_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::EventReply_DebugOpStateChange >&
EventReply::debug_op_state_changes() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.EventReply.debug_op_state_changes)
  return debug_op_state_changes_;
}
...
inline const ::diplomacy::tensorflow::TensorProto& EventReply::_internal_tensor() const {
  return *tensor_;
}
inline const ::diplomacy::tensorflow::TensorProto& EventReply::tensor() const {
  const ::diplomacy::tensorflow::TensorProto* p = tensor_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.EventReply.tensor)
...
inline ::diplomacy::tensorflow::TensorProto* EventReply::release_tensor() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.EventReply.tensor)
  
  ::diplomacy::tensorflow::TensorProto* temp = tensor_;
  tensor_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::TensorProto* EventReply::mutable_tensor() {
  
  if (tensor_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::TensorProto>(GetArenaNoVirtual());
    tensor_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.EventReply.tensor)
  return tensor_;
}
inline void EventReply::set_allocated_tensor(::diplomacy::tensorflow::TensorProto* tensor) {
  ...
  tensor_ = tensor;
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.EventReply.tensor)
}
...
inline ::diplomacy::tensorflow::CallTraceback_CallType CallTraceback::call_type() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CallTraceback.call_type)
  return static_cast< ::diplomacy::tensorflow::CallTraceback_CallType >(call_type_);
}
inline void CallTraceback::set_call_type(::diplomacy::tensorflow::CallTraceback_CallType value) {
  
  call_type_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.CallTraceback.call_type)
}
...
inline const ::std::string& CallTraceback::call_key() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CallTraceback.call_key)
...
inline void CallTraceback::set_call_key(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.CallTraceback.call_key)
}
#if LANG_CXX11
inline void CallTraceback::set_call_key(::std::string&& value) {
  ...
  call_key_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.CallTraceback.call_key)
}
#endif
inline void CallTraceback::set_call_key(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.CallTraceback.call_key)
}
inline void CallTraceback::set_call_key(const char* value, size_t size) {
  ...
  call_key_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.CallTraceback.call_key)
}
inline ::std::string* CallTraceback::mutable_call_key() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.CallTraceback.call_key)
...
inline ::std::string* CallTraceback::release_call_key() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.CallTraceback.call_key)
...
inline void CallTraceback::set_allocated_call_key(::std::string* call_key) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.CallTraceback.call_key)
}
...
inline const ::diplomacy::tensorflow::tfprof::CodeDef& CallTraceback::_internal_origin_stack() const {
  return *origin_stack_;
}
inline const ::diplomacy::tensorflow::tfprof::CodeDef& CallTraceback::origin_stack() const {
  const ::diplomacy::tensorflow::tfprof::CodeDef* p = origin_stack_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CallTraceback.origin_stack)
...
inline ::diplomacy::tensorflow::tfprof::CodeDef* CallTraceback::release_origin_stack() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.CallTraceback.origin_stack)
  
  ::diplomacy::tensorflow::tfprof::CodeDef* temp = origin_stack_;
  origin_stack_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::tfprof::CodeDef* CallTraceback::mutable_origin_stack() {
  
  if (origin_stack_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::tfprof::CodeDef>(GetArenaNoVirtual());
    origin_stack_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.CallTraceback.origin_stack)
  return origin_stack_;
}
inline void CallTraceback::set_allocated_origin_stack(::diplomacy::tensorflow::tfprof::CodeDef* origin_stack) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.CallTraceback.origin_stack)
}
...
CallTraceback::origin_id_to_string() const {
  // @@protoc_insertion_point(field_map:diplomacy.tensorflow.CallTraceback.origin_id_to_string)
...
CallTraceback::mutable_origin_id_to_string() {
  // @@protoc_insertion_point(field_mutable_map:diplomacy.tensorflow.CallTraceback.origin_id_to_string)
...
inline const ::diplomacy::tensorflow::tfprof::OpLogProto& CallTraceback::_internal_graph_traceback() const {
  return *graph_traceback_;
}
inline const ::diplomacy::tensorflow::tfprof::OpLogProto& CallTraceback::graph_traceback() const {
  const ::diplomacy::tensorflow::tfprof::OpLogProto* p = graph_traceback_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CallTraceback.graph_traceback)
  return p != NULL ? *p : *reinterpret_cast<const ::diplomacy::tensorflow::tfprof::OpLogProto*>(
      &::diplomacy::tensorflow::tfprof::_OpLogProto_default_instance_);
}
inline ::diplomacy::tensorflow::tfprof::OpLogProto* CallTraceback::release_graph_traceback() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.CallTraceback.graph_traceback)
  
  ::diplomacy::tensorflow::tfprof::OpLogProto* temp = graph_traceback_;
  graph_traceback_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::tfprof::OpLogProto* CallTraceback::mutable_graph_traceback() {
  
  if (graph_traceback_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::tfprof::OpLogProto>(GetArenaNoVirtual());
    graph_traceback_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.CallTraceback.graph_traceback)
  return graph_traceback_;
}
inline void CallTraceback::set_allocated_graph_traceback(::diplomacy::tensorflow::tfprof::OpLogProto* graph_traceback) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.CallTraceback.graph_traceback)
}
...
inline ::google::protobuf::int64 CallTraceback::graph_version() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CallTraceback.graph_version)
  return graph_version_;
}
inline void CallTraceback::set_graph_version(::google::protobuf::int64 value) {
  
  graph_version_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.CallTraceback.graph_version)
}
...
template <> struct is_proto_enum< ::diplomacy::tensorflow::EventReply_DebugOpStateChange_State> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::diplomacy::tensorflow::EventReply_DebugOpStateChange_State>() {
  return ::diplomacy::tensorflow::EventReply_DebugOpStateChange_State_descriptor();
}
template <> struct is_proto_enum< ::diplomacy::tensorflow::CallTraceback_CallType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::diplomacy::tensorflow::CallTraceback_CallType>() {
  return ::diplomacy::tensorflow::CallTraceback_CallType_descriptor();
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fdebug_2fdebug_5fservice_2eproto
