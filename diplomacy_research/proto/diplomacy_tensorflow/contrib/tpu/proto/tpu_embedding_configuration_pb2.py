...
from diplomacy_tensorflow.contrib.tpu.proto import optimization_parameters_pb2 as diplomacy__tensorflow_dot_contrib_dot_tpu_dot_proto_dot_optimization__parameters__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/contrib/tpu/proto/tpu_embedding_configuration.proto',
  ...
  ,
  dependencies=[diplomacy__tensorflow_dot_contrib_dot_tpu_dot_proto_dot_optimization__parameters__pb2.DESCRIPTOR,diplomacy__tensorflow_dot_contrib_dot_tpu_dot_proto_dot_tpu__embedding__output__layout__pb2.DESCRIPTOR,])



_TPUEMBEDDINGCONFIGURATION_MODE = _descriptor.EnumDescriptor(
  name='Mode',
  full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.Mode',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_TPUEMBEDDINGCONFIGURATION_SHARDINGSTRATEGY = _descriptor.EnumDescriptor(
  ...
  full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.ShardingStrategy',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_TPUEMBEDDINGCONFIGURATION_TABLEDESCRIPTOR = _descriptor.Descriptor(
  ...
  full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.TableDescriptor',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.TableDescriptor.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='vocabulary_size', full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.TableDescriptor.vocabulary_size', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dimension', full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.TableDescriptor.dimension', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_features', full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.TableDescriptor.num_features', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='optimization_parameters', full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.TableDescriptor.optimization_parameters', index=4,
...
_TPUEMBEDDINGCONFIGURATION = _descriptor.Descriptor(
  ...
  full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='table_descriptor', full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.table_descriptor', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mode', full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.mode', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='batch_size_per_tensor_core', full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.batch_size_per_tensor_core', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_hosts', full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.num_hosts', index=3,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_tensor_cores', full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.num_tensor_cores', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sharding_strategy', full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.sharding_strategy', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pipeline_execution_with_tensor_core', full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.pipeline_execution_with_tensor_core', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_layout', full_name='diplomacy.tensorflow.tpu.TPUEmbeddingConfiguration.output_layout', index=7,
...
_TPUEMBEDDINGCONFIGURATION_TABLEDESCRIPTOR.fields_by_name['optimization_parameters'].message_type = diplomacy__tensorflow_dot_contrib_dot_tpu_dot_proto_dot_optimization__parameters__pb2._OPTIMIZATIONPARAMETERS
...
_TPUEMBEDDINGCONFIGURATION.fields_by_name['output_layout'].message_type = diplomacy__tensorflow_dot_contrib_dot_tpu_dot_proto_dot_tpu__embedding__output__layout__pb2._TPUEMBEDDINGOUTPUTLAYOUT
...
TPUEmbeddingConfiguration = _reflection.GeneratedProtocolMessageType('TPUEmbeddingConfiguration', (_message.Message,), dict(
  ...
  TableDescriptor = _reflection.GeneratedProtocolMessageType('TableDescriptor', (_message.Message,), dict(
    ...
    __module__ = 'diplomacy_tensorflow.contrib.tpu.proto.tpu_embedding_configuration_pb2'
