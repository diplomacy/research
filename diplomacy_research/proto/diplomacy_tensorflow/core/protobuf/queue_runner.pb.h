...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fqueue_5frunner_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fqueue_5frunner_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fqueue_5frunner_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::QueueRunnerDef* Arena::CreateMaybeMessage<::diplomacy::tensorflow::QueueRunnerDef>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class QueueRunnerDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.QueueRunnerDef) */ {
 public:
  QueueRunnerDef();
  ...
  ::diplomacy::tensorflow::error::Code queue_closed_exception_types(int index) const;
  void set_queue_closed_exception_types(int index, ::diplomacy::tensorflow::error::Code value);
  void add_queue_closed_exception_types(::diplomacy::tensorflow::error::Code value);
 ...
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fqueue_5frunner_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::std::string& QueueRunnerDef::queue_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.QueueRunnerDef.queue_name)
...
inline void QueueRunnerDef::set_queue_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.QueueRunnerDef.queue_name)
}
#if LANG_CXX11
inline void QueueRunnerDef::set_queue_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.QueueRunnerDef.queue_name)
}
#endif
inline void QueueRunnerDef::set_queue_name(const char* value) {
  ...
  queue_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.QueueRunnerDef.queue_name)
}
inline void QueueRunnerDef::set_queue_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.QueueRunnerDef.queue_name)
}
inline ::std::string* QueueRunnerDef::mutable_queue_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.QueueRunnerDef.queue_name)
...
inline ::std::string* QueueRunnerDef::release_queue_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.QueueRunnerDef.queue_name)
...
inline void QueueRunnerDef::set_allocated_queue_name(::std::string* queue_name) {
  ...
  queue_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), queue_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.QueueRunnerDef.queue_name)
}
inline ::std::string* QueueRunnerDef::unsafe_arena_release_queue_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.QueueRunnerDef.queue_name)
...
inline void QueueRunnerDef::unsafe_arena_set_allocated_queue_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.QueueRunnerDef.queue_name)
}
...
inline const ::std::string& QueueRunnerDef::enqueue_op_name(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.QueueRunnerDef.enqueue_op_name)
  return enqueue_op_name_.Get(index);
}
inline ::std::string* QueueRunnerDef::mutable_enqueue_op_name(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.QueueRunnerDef.enqueue_op_name)
  return enqueue_op_name_.Mutable(index);
}
inline void QueueRunnerDef::set_enqueue_op_name(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.QueueRunnerDef.enqueue_op_name)
...
inline void QueueRunnerDef::set_enqueue_op_name(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  enqueue_op_name_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.QueueRunnerDef.enqueue_op_name)
}
inline void QueueRunnerDef::set_enqueue_op_name(int index, const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.QueueRunnerDef.enqueue_op_name)
}
inline ::std::string* QueueRunnerDef::add_enqueue_op_name() {
  // @@protoc_insertion_point(field_add_mutable:diplomacy.tensorflow.QueueRunnerDef.enqueue_op_name)
...
inline void QueueRunnerDef::add_enqueue_op_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.QueueRunnerDef.enqueue_op_name)
}
#if LANG_CXX11
...
inline void QueueRunnerDef::add_enqueue_op_name(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  enqueue_op_name_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:diplomacy.tensorflow.QueueRunnerDef.enqueue_op_name)
}
inline void QueueRunnerDef::add_enqueue_op_name(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:diplomacy.tensorflow.QueueRunnerDef.enqueue_op_name)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
QueueRunnerDef::enqueue_op_name() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.QueueRunnerDef.enqueue_op_name)
  return enqueue_op_name_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
QueueRunnerDef::mutable_enqueue_op_name() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.QueueRunnerDef.enqueue_op_name)
  return &enqueue_op_name_;
}
...
inline const ::std::string& QueueRunnerDef::close_op_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.QueueRunnerDef.close_op_name)
...
inline void QueueRunnerDef::set_close_op_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.QueueRunnerDef.close_op_name)
}
#if LANG_CXX11
inline void QueueRunnerDef::set_close_op_name(::std::string&& value) {
  ...
  close_op_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.QueueRunnerDef.close_op_name)
}
#endif
inline void QueueRunnerDef::set_close_op_name(const char* value) {
  ...
  close_op_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.QueueRunnerDef.close_op_name)
}
inline void QueueRunnerDef::set_close_op_name(const char* value,
    size_t size) {
  ...
  close_op_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.QueueRunnerDef.close_op_name)
}
inline ::std::string* QueueRunnerDef::mutable_close_op_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.QueueRunnerDef.close_op_name)
...
inline ::std::string* QueueRunnerDef::release_close_op_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.QueueRunnerDef.close_op_name)
...
inline void QueueRunnerDef::set_allocated_close_op_name(::std::string* close_op_name) {
  ...
  close_op_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), close_op_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.QueueRunnerDef.close_op_name)
}
inline ::std::string* QueueRunnerDef::unsafe_arena_release_close_op_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.QueueRunnerDef.close_op_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void QueueRunnerDef::unsafe_arena_set_allocated_close_op_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.QueueRunnerDef.close_op_name)
}
...
inline const ::std::string& QueueRunnerDef::cancel_op_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.QueueRunnerDef.cancel_op_name)
...
inline void QueueRunnerDef::set_cancel_op_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.QueueRunnerDef.cancel_op_name)
}
#if LANG_CXX11
inline void QueueRunnerDef::set_cancel_op_name(::std::string&& value) {
  ...
  cancel_op_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.QueueRunnerDef.cancel_op_name)
}
#endif
inline void QueueRunnerDef::set_cancel_op_name(const char* value) {
  ...
  cancel_op_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.QueueRunnerDef.cancel_op_name)
}
inline void QueueRunnerDef::set_cancel_op_name(const char* value,
    size_t size) {
  ...
  cancel_op_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.QueueRunnerDef.cancel_op_name)
}
inline ::std::string* QueueRunnerDef::mutable_cancel_op_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.QueueRunnerDef.cancel_op_name)
...
inline ::std::string* QueueRunnerDef::release_cancel_op_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.QueueRunnerDef.cancel_op_name)
...
inline void QueueRunnerDef::set_allocated_cancel_op_name(::std::string* cancel_op_name) {
  ...
  cancel_op_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), cancel_op_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.QueueRunnerDef.cancel_op_name)
}
inline ::std::string* QueueRunnerDef::unsafe_arena_release_cancel_op_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.QueueRunnerDef.cancel_op_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void QueueRunnerDef::unsafe_arena_set_allocated_cancel_op_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.QueueRunnerDef.cancel_op_name)
}
...
inline ::diplomacy::tensorflow::error::Code QueueRunnerDef::queue_closed_exception_types(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.QueueRunnerDef.queue_closed_exception_types)
  return static_cast< ::diplomacy::tensorflow::error::Code >(queue_closed_exception_types_.Get(index));
}
inline void QueueRunnerDef::set_queue_closed_exception_types(int index, ::diplomacy::tensorflow::error::Code value) {
  queue_closed_exception_types_.Set(index, value);
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.QueueRunnerDef.queue_closed_exception_types)
}
inline void QueueRunnerDef::add_queue_closed_exception_types(::diplomacy::tensorflow::error::Code value) {
  queue_closed_exception_types_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.QueueRunnerDef.queue_closed_exception_types)
}
inline const ::google::protobuf::RepeatedField<int>&
QueueRunnerDef::queue_closed_exception_types() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.QueueRunnerDef.queue_closed_exception_types)
  return queue_closed_exception_types_;
}
inline ::google::protobuf::RepeatedField<int>*
QueueRunnerDef::mutable_queue_closed_exception_types() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.QueueRunnerDef.queue_closed_exception_types)
  return &queue_closed_exception_types_;
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fqueue_5frunner_2eproto
