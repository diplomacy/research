...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2fvariable_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2fvariable_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2fvariable_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::SaveSliceInfoDef* Arena::CreateMaybeMessage<::diplomacy::tensorflow::SaveSliceInfoDef>(Arena*);
template<> ::diplomacy::tensorflow::VariableDef* Arena::CreateMaybeMessage<::diplomacy::tensorflow::VariableDef>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class VariableDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.VariableDef) */ {
 public:
  VariableDef();
  virtual ~VariableDef();
  ...
  private:
  const ::diplomacy::tensorflow::SaveSliceInfoDef& _internal_save_slice_info_def() const;
  public:
  const ::diplomacy::tensorflow::SaveSliceInfoDef& save_slice_info_def() const;
  ::diplomacy::tensorflow::SaveSliceInfoDef* release_save_slice_info_def();
  ::diplomacy::tensorflow::SaveSliceInfoDef* mutable_save_slice_info_def();
  void set_allocated_save_slice_info_def(::diplomacy::tensorflow::SaveSliceInfoDef* save_slice_info_def);
  void unsafe_arena_set_allocated_save_slice_info_def(
      ::diplomacy::tensorflow::SaveSliceInfoDef* save_slice_info_def);
  ::diplomacy::tensorflow::SaveSliceInfoDef* unsafe_arena_release_save_slice_info_def();
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.VariableDef)
 private:
  ...
  ::diplomacy::tensorflow::SaveSliceInfoDef* save_slice_info_def_;
  bool is_resource_;
  bool trainable_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2fvariable_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class SaveSliceInfoDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.SaveSliceInfoDef) */ {
 public:
  SaveSliceInfoDef();
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.SaveSliceInfoDef)
 private:
...
inline const ::std::string& VariableDef::variable_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.VariableDef.variable_name)
...
inline void VariableDef::set_variable_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.VariableDef.variable_name)
}
#if LANG_CXX11
inline void VariableDef::set_variable_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.VariableDef.variable_name)
}
#endif
inline void VariableDef::set_variable_name(const char* value) {
  ...
  variable_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.VariableDef.variable_name)
}
inline void VariableDef::set_variable_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.VariableDef.variable_name)
}
inline ::std::string* VariableDef::mutable_variable_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.VariableDef.variable_name)
...
inline ::std::string* VariableDef::release_variable_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.VariableDef.variable_name)
...
inline void VariableDef::set_allocated_variable_name(::std::string* variable_name) {
  ...
  variable_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), variable_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.VariableDef.variable_name)
}
inline ::std::string* VariableDef::unsafe_arena_release_variable_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.VariableDef.variable_name)
...
inline void VariableDef::unsafe_arena_set_allocated_variable_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.VariableDef.variable_name)
}
...
inline const ::std::string& VariableDef::initial_value_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.VariableDef.initial_value_name)
...
inline void VariableDef::set_initial_value_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.VariableDef.initial_value_name)
}
#if LANG_CXX11
inline void VariableDef::set_initial_value_name(::std::string&& value) {
  ...
  initial_value_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.VariableDef.initial_value_name)
}
#endif
inline void VariableDef::set_initial_value_name(const char* value) {
  ...
  initial_value_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.VariableDef.initial_value_name)
}
inline void VariableDef::set_initial_value_name(const char* value,
    size_t size) {
  ...
  initial_value_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.VariableDef.initial_value_name)
}
inline ::std::string* VariableDef::mutable_initial_value_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.VariableDef.initial_value_name)
...
inline ::std::string* VariableDef::release_initial_value_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.VariableDef.initial_value_name)
...
inline void VariableDef::set_allocated_initial_value_name(::std::string* initial_value_name) {
  ...
  initial_value_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), initial_value_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.VariableDef.initial_value_name)
}
inline ::std::string* VariableDef::unsafe_arena_release_initial_value_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.VariableDef.initial_value_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void VariableDef::unsafe_arena_set_allocated_initial_value_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.VariableDef.initial_value_name)
}
...
inline const ::std::string& VariableDef::initializer_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.VariableDef.initializer_name)
...
inline void VariableDef::set_initializer_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.VariableDef.initializer_name)
}
#if LANG_CXX11
inline void VariableDef::set_initializer_name(::std::string&& value) {
  ...
  initializer_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.VariableDef.initializer_name)
}
#endif
inline void VariableDef::set_initializer_name(const char* value) {
  ...
  initializer_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.VariableDef.initializer_name)
}
inline void VariableDef::set_initializer_name(const char* value,
    size_t size) {
  ...
  initializer_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.VariableDef.initializer_name)
}
inline ::std::string* VariableDef::mutable_initializer_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.VariableDef.initializer_name)
...
inline ::std::string* VariableDef::release_initializer_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.VariableDef.initializer_name)
...
inline void VariableDef::set_allocated_initializer_name(::std::string* initializer_name) {
  ...
  initializer_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), initializer_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.VariableDef.initializer_name)
}
inline ::std::string* VariableDef::unsafe_arena_release_initializer_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.VariableDef.initializer_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void VariableDef::unsafe_arena_set_allocated_initializer_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.VariableDef.initializer_name)
}
...
inline const ::std::string& VariableDef::snapshot_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.VariableDef.snapshot_name)
...
inline void VariableDef::set_snapshot_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.VariableDef.snapshot_name)
}
#if LANG_CXX11
inline void VariableDef::set_snapshot_name(::std::string&& value) {
  ...
  snapshot_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.VariableDef.snapshot_name)
}
#endif
inline void VariableDef::set_snapshot_name(const char* value) {
  ...
  snapshot_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.VariableDef.snapshot_name)
}
inline void VariableDef::set_snapshot_name(const char* value,
    size_t size) {
  ...
  snapshot_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.VariableDef.snapshot_name)
}
inline ::std::string* VariableDef::mutable_snapshot_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.VariableDef.snapshot_name)
...
inline ::std::string* VariableDef::release_snapshot_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.VariableDef.snapshot_name)
...
inline void VariableDef::set_allocated_snapshot_name(::std::string* snapshot_name) {
  ...
  snapshot_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), snapshot_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.VariableDef.snapshot_name)
}
inline ::std::string* VariableDef::unsafe_arena_release_snapshot_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.VariableDef.snapshot_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void VariableDef::unsafe_arena_set_allocated_snapshot_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.VariableDef.snapshot_name)
}
...
inline const ::diplomacy::tensorflow::SaveSliceInfoDef& VariableDef::_internal_save_slice_info_def() const {
  return *save_slice_info_def_;
}
inline const ::diplomacy::tensorflow::SaveSliceInfoDef& VariableDef::save_slice_info_def() const {
  const ::diplomacy::tensorflow::SaveSliceInfoDef* p = save_slice_info_def_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.VariableDef.save_slice_info_def)
  return p != NULL ? *p : *reinterpret_cast<const ::diplomacy::tensorflow::SaveSliceInfoDef*>(
      &::diplomacy::tensorflow::_SaveSliceInfoDef_default_instance_);
}
inline ::diplomacy::tensorflow::SaveSliceInfoDef* VariableDef::release_save_slice_info_def() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.VariableDef.save_slice_info_def)
  
  ::diplomacy::tensorflow::SaveSliceInfoDef* temp = save_slice_info_def_;
...
inline ::diplomacy::tensorflow::SaveSliceInfoDef* VariableDef::unsafe_arena_release_save_slice_info_def() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.VariableDef.save_slice_info_def)
  
  ::diplomacy::tensorflow::SaveSliceInfoDef* temp = save_slice_info_def_;
  save_slice_info_def_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::SaveSliceInfoDef* VariableDef::mutable_save_slice_info_def() {
  
  if (save_slice_info_def_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::SaveSliceInfoDef>(GetArenaNoVirtual());
    save_slice_info_def_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.VariableDef.save_slice_info_def)
  return save_slice_info_def_;
}
inline void VariableDef::set_allocated_save_slice_info_def(::diplomacy::tensorflow::SaveSliceInfoDef* save_slice_info_def) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.VariableDef.save_slice_info_def)
}
...
inline bool VariableDef::is_resource() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.VariableDef.is_resource)
  return is_resource_;
}
inline void VariableDef::set_is_resource(bool value) {
  
  is_resource_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.VariableDef.is_resource)
}
...
inline bool VariableDef::trainable() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.VariableDef.trainable)
  return trainable_;
}
inline void VariableDef::set_trainable(bool value) {
  
  trainable_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.VariableDef.trainable)
}
...
inline const ::std::string& SaveSliceInfoDef::full_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.SaveSliceInfoDef.full_name)
...
inline void SaveSliceInfoDef::set_full_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.SaveSliceInfoDef.full_name)
}
#if LANG_CXX11
inline void SaveSliceInfoDef::set_full_name(::std::string&& value) {
  ...
  full_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.SaveSliceInfoDef.full_name)
}
#endif
inline void SaveSliceInfoDef::set_full_name(const char* value) {
  ...
  full_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.SaveSliceInfoDef.full_name)
}
inline void SaveSliceInfoDef::set_full_name(const char* value,
    size_t size) {
  ...
  full_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.SaveSliceInfoDef.full_name)
}
inline ::std::string* SaveSliceInfoDef::mutable_full_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.SaveSliceInfoDef.full_name)
...
inline ::std::string* SaveSliceInfoDef::release_full_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.SaveSliceInfoDef.full_name)
...
inline void SaveSliceInfoDef::set_allocated_full_name(::std::string* full_name) {
  ...
  full_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), full_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.SaveSliceInfoDef.full_name)
}
inline ::std::string* SaveSliceInfoDef::unsafe_arena_release_full_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.SaveSliceInfoDef.full_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void SaveSliceInfoDef::unsafe_arena_set_allocated_full_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.SaveSliceInfoDef.full_name)
}
...
inline ::google::protobuf::int64 SaveSliceInfoDef::full_shape(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.SaveSliceInfoDef.full_shape)
...
inline void SaveSliceInfoDef::set_full_shape(int index, ::google::protobuf::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.SaveSliceInfoDef.full_shape)
}
inline void SaveSliceInfoDef::add_full_shape(::google::protobuf::int64 value) {
  full_shape_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.SaveSliceInfoDef.full_shape)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
SaveSliceInfoDef::full_shape() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.SaveSliceInfoDef.full_shape)
  return full_shape_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
SaveSliceInfoDef::mutable_full_shape() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.SaveSliceInfoDef.full_shape)
  return &full_shape_;
}
...
inline ::google::protobuf::int64 SaveSliceInfoDef::var_offset(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.SaveSliceInfoDef.var_offset)
...
inline void SaveSliceInfoDef::set_var_offset(int index, ::google::protobuf::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.SaveSliceInfoDef.var_offset)
}
inline void SaveSliceInfoDef::add_var_offset(::google::protobuf::int64 value) {
  var_offset_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.SaveSliceInfoDef.var_offset)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
SaveSliceInfoDef::var_offset() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.SaveSliceInfoDef.var_offset)
  return var_offset_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
SaveSliceInfoDef::mutable_var_offset() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.SaveSliceInfoDef.var_offset)
  return &var_offset_;
}
...
inline ::google::protobuf::int64 SaveSliceInfoDef::var_shape(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.SaveSliceInfoDef.var_shape)
...
inline void SaveSliceInfoDef::set_var_shape(int index, ::google::protobuf::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.SaveSliceInfoDef.var_shape)
}
inline void SaveSliceInfoDef::add_var_shape(::google::protobuf::int64 value) {
  var_shape_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.SaveSliceInfoDef.var_shape)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
SaveSliceInfoDef::var_shape() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.SaveSliceInfoDef.var_shape)
  return var_shape_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
SaveSliceInfoDef::mutable_var_shape() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.SaveSliceInfoDef.var_shape)
  return &var_shape_;
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2fvariable_2eproto
