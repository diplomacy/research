...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2ftransport_5foptions_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2ftransport_5foptions_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2ftransport_5foptions_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::RecvBufRespExtra* Arena::CreateMaybeMessage<::diplomacy::tensorflow::RecvBufRespExtra>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class RecvBufRespExtra : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.RecvBufRespExtra) */ {
 public:
  RecvBufRespExtra();
 ...
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2ftransport_5foptions_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::std::string& RecvBufRespExtra::tensor_content(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RecvBufRespExtra.tensor_content)
  return tensor_content_.Get(index);
}
inline ::std::string* RecvBufRespExtra::mutable_tensor_content(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.RecvBufRespExtra.tensor_content)
  return tensor_content_.Mutable(index);
}
inline void RecvBufRespExtra::set_tensor_content(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RecvBufRespExtra.tensor_content)
...
inline void RecvBufRespExtra::set_tensor_content(int index, const char* value) {
  ...
  tensor_content_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.RecvBufRespExtra.tensor_content)
}
inline void RecvBufRespExtra::set_tensor_content(int index, const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.RecvBufRespExtra.tensor_content)
}
inline ::std::string* RecvBufRespExtra::add_tensor_content() {
  // @@protoc_insertion_point(field_add_mutable:diplomacy.tensorflow.RecvBufRespExtra.tensor_content)
...
inline void RecvBufRespExtra::add_tensor_content(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.RecvBufRespExtra.tensor_content)
}
#if LANG_CXX11
...
inline void RecvBufRespExtra::add_tensor_content(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  tensor_content_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:diplomacy.tensorflow.RecvBufRespExtra.tensor_content)
}
inline void RecvBufRespExtra::add_tensor_content(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:diplomacy.tensorflow.RecvBufRespExtra.tensor_content)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
RecvBufRespExtra::tensor_content() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.RecvBufRespExtra.tensor_content)
  return tensor_content_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
RecvBufRespExtra::mutable_tensor_content() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.RecvBufRespExtra.tensor_content)
  return &tensor_content_;
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2ftransport_5foptions_2eproto
