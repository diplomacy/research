...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/contrib/tensorboard/plugins/projector/projector_config.proto',
...
_SPRITEMETADATA = _descriptor.Descriptor(
  name='SpriteMetadata',
  full_name='diplomacy.tensorflow.SpriteMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='image_path', full_name='diplomacy.tensorflow.SpriteMetadata.image_path', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='single_image_dim', full_name='diplomacy.tensorflow.SpriteMetadata.single_image_dim', index=1,
...
_EMBEDDINGINFO = _descriptor.Descriptor(
  name='EmbeddingInfo',
  full_name='diplomacy.tensorflow.EmbeddingInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tensor_name', full_name='diplomacy.tensorflow.EmbeddingInfo.tensor_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata_path', full_name='diplomacy.tensorflow.EmbeddingInfo.metadata_path', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bookmarks_path', full_name='diplomacy.tensorflow.EmbeddingInfo.bookmarks_path', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tensor_shape', full_name='diplomacy.tensorflow.EmbeddingInfo.tensor_shape', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sprite', full_name='diplomacy.tensorflow.EmbeddingInfo.sprite', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tensor_path', full_name='diplomacy.tensorflow.EmbeddingInfo.tensor_path', index=5,
...
_PROJECTORCONFIG = _descriptor.Descriptor(
  ...
  full_name='diplomacy.tensorflow.ProjectorConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='model_checkpoint_path', full_name='diplomacy.tensorflow.ProjectorConfig.model_checkpoint_path', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='embeddings', full_name='diplomacy.tensorflow.ProjectorConfig.embeddings', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='model_checkpoint_dir', full_name='diplomacy.tensorflow.ProjectorConfig.model_checkpoint_dir', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
SpriteMetadata = _reflection.GeneratedProtocolMessageType('SpriteMetadata', (_message.Message,), dict(
  ...
  __module__ = 'diplomacy_tensorflow.contrib.tensorboard.plugins.projector.projector_config_pb2'
