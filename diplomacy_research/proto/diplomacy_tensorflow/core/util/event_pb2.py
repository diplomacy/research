...
from diplomacy_tensorflow.core.framework import summary_pb2 as diplomacy__tensorflow_dot_core_dot_framework_dot_summary__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/core/util/event.proto',
  package='diplomacy.tensorflow',
  syntax='proto3',
  serialized_options=_b('\n\023org.tensorflow.utilB\013EventProtosP\001\370\001\001'),
  serialized_pb=_b('\n*diplomacy_tensorflow/core/util/event.proto\x12\x14\x64iplomacy.tensorflow\x1a\x31\x64iplomacy_tensorflow/core/framework/summary.proto\"\xe3\x02\n\x05\x45vent\x12\x11\n\twall_time\x18\x01 \x01(\x01\x12\x0c\n\x04step\x18\x02 \x01(\x03\x12\x16\n\x0c\x66ile_version\x18\x03 \x01(\tH\x00\x12\x13\n\tgraph_def\x18\x04 \x01(\x0cH\x00\x12\x30\n\x07summary\x18\x05 \x01(\x0b\x32\x1d.diplomacy.tensorflow.SummaryH\x00\x12\x37\n\x0blog_message\x18\x06 \x01(\x0b\x32 .diplomacy.tensorflow.LogMessageH\x00\x12\x37\n\x0bsession_log\x18\x07 \x01(\x0b\x32 .diplomacy.tensorflow.SessionLogH\x00\x12\x46\n\x13tagged_run_metadata\x18\x08 \x01(\x0b\x32\'.diplomacy.tensorflow.TaggedRunMetadataH\x00\x12\x18\n\x0emeta_graph_def\x18\t \x01(\x0cH\x00\x42\x06\n\x04what\"\xa3\x01\n\nLogMessage\x12\x35\n\x05level\x18\x01 \x01(\x0e\x32&.diplomacy.tensorflow.LogMessage.Level\x12\x0f\n\x07message\x18\x02 \x01(\t\"M\n\x05Level\x12\x0b\n\x07UNKNOWN\x10\x00\x12\r\n\tDEBUGGING\x10\n\x12\x08\n\x04INFO\x10\x14\x12\x08\n\x04WARN\x10\x1e\x12\t\n\x05\x45RROR\x10(\x12\t\n\x05\x46\x41TAL\x10\x32\"\xc0\x01\n\nSessionLog\x12>\n\x06status\x18\x01 \x01(\x0e\x32..diplomacy.tensorflow.SessionLog.SessionStatus\x12\x17\n\x0f\x63heckpoint_path\x18\x02 \x01(\t\x12\x0b\n\x03msg\x18\x03 \x01(\t\"L\n\rSessionStatus\x12\x16\n\x12STATUS_UNSPECIFIED\x10\x00\x12\t\n\x05START\x10\x01\x12\x08\n\x04STOP\x10\x02\x12\x0e\n\nCHECKPOINT\x10\x03\"6\n\x11TaggedRunMetadata\x12\x0b\n\x03tag\x18\x01 \x01(\t\x12\x14\n\x0crun_metadata\x18\x02 \x01(\x0c\"$\n\x0eWatchdogConfig\x12\x12\n\ntimeout_ms\x18\x01 \x01(\x03\"\x98\x01\n\x16WorkerHeartbeatRequest\x12?\n\rshutdown_mode\x18\x01 \x01(\x0e\x32(.diplomacy.tensorflow.WorkerShutdownMode\x12=\n\x0fwatchdog_config\x18\x02 \x01(\x0b\x32$.diplomacy.tensorflow.WatchdogConfig\"\x97\x01\n\x17WorkerHeartbeatResponse\x12\x39\n\rhealth_status\x18\x01 \x01(\x0e\x32\".diplomacy.tensorflow.WorkerHealth\x12/\n\nworker_log\x18\x02 \x03(\x0b\x32\x1b.diplomacy.tensorflow.Event\x12\x10\n\x08hostname\x18\x03 \x01(\t*H\n\x0cWorkerHealth\x12\x06\n\x02OK\x10\x00\x12\x1c\n\x18RECEIVED_SHUTDOWN_SIGNAL\x10\x01\x12\x12\n\x0eINTERNAL_ERROR\x10\x02*U\n\x12WorkerShutdownMode\x12\x0b\n\x07\x44\x45\x46\x41ULT\x10\x00\x12\x18\n\x14SHUTDOWN_IMMEDIATELY\x10\x01\x12\x18\n\x14WAIT_FOR_COORDINATOR\x10\x02\x42\'\n\x13org.tensorflow.utilB\x0b\x45ventProtosP\x01\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[diplomacy__tensorflow_dot_core_dot_framework_dot_summary__pb2.DESCRIPTOR,])

_WORKERHEALTH = _descriptor.EnumDescriptor(
  name='WorkerHealth',
  full_name='diplomacy.tensorflow.WorkerHealth',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_WORKERSHUTDOWNMODE = _descriptor.EnumDescriptor(
  ...
  full_name='diplomacy.tensorflow.WorkerShutdownMode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_LOGMESSAGE_LEVEL = _descriptor.EnumDescriptor(
  name='Level',
  full_name='diplomacy.tensorflow.LogMessage.Level',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_SESSIONLOG_SESSIONSTATUS = _descriptor.EnumDescriptor(
  name='SessionStatus',
  full_name='diplomacy.tensorflow.SessionLog.SessionStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_EVENT = _descriptor.Descriptor(
  name='Event',
  full_name='diplomacy.tensorflow.Event',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='wall_time', full_name='diplomacy.tensorflow.Event.wall_time', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='step', full_name='diplomacy.tensorflow.Event.step', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='file_version', full_name='diplomacy.tensorflow.Event.file_version', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='graph_def', full_name='diplomacy.tensorflow.Event.graph_def', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='summary', full_name='diplomacy.tensorflow.Event.summary', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='log_message', full_name='diplomacy.tensorflow.Event.log_message', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='session_log', full_name='diplomacy.tensorflow.Event.session_log', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tagged_run_metadata', full_name='diplomacy.tensorflow.Event.tagged_run_metadata', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='meta_graph_def', full_name='diplomacy.tensorflow.Event.meta_graph_def', index=8,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='what', full_name='diplomacy.tensorflow.Event.what',
...
_LOGMESSAGE = _descriptor.Descriptor(
  name='LogMessage',
  full_name='diplomacy.tensorflow.LogMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='level', full_name='diplomacy.tensorflow.LogMessage.level', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='message', full_name='diplomacy.tensorflow.LogMessage.message', index=1,
...
_SESSIONLOG = _descriptor.Descriptor(
  name='SessionLog',
  full_name='diplomacy.tensorflow.SessionLog',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='diplomacy.tensorflow.SessionLog.status', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='checkpoint_path', full_name='diplomacy.tensorflow.SessionLog.checkpoint_path', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='msg', full_name='diplomacy.tensorflow.SessionLog.msg', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TAGGEDRUNMETADATA = _descriptor.Descriptor(
  ...
  full_name='diplomacy.tensorflow.TaggedRunMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tag', full_name='diplomacy.tensorflow.TaggedRunMetadata.tag', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='run_metadata', full_name='diplomacy.tensorflow.TaggedRunMetadata.run_metadata', index=1,
...
_WATCHDOGCONFIG = _descriptor.Descriptor(
  name='WatchdogConfig',
  full_name='diplomacy.tensorflow.WatchdogConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='timeout_ms', full_name='diplomacy.tensorflow.WatchdogConfig.timeout_ms', index=0,
...
_WORKERHEARTBEATREQUEST = _descriptor.Descriptor(
  ...
  full_name='diplomacy.tensorflow.WorkerHeartbeatRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='shutdown_mode', full_name='diplomacy.tensorflow.WorkerHeartbeatRequest.shutdown_mode', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='watchdog_config', full_name='diplomacy.tensorflow.WorkerHeartbeatRequest.watchdog_config', index=1,
...
_WORKERHEARTBEATRESPONSE = _descriptor.Descriptor(
  ...
  full_name='diplomacy.tensorflow.WorkerHeartbeatResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='health_status', full_name='diplomacy.tensorflow.WorkerHeartbeatResponse.health_status', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='worker_log', full_name='diplomacy.tensorflow.WorkerHeartbeatResponse.worker_log', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hostname', full_name='diplomacy.tensorflow.WorkerHeartbeatResponse.hostname', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EVENT.fields_by_name['summary'].message_type = diplomacy__tensorflow_dot_core_dot_framework_dot_summary__pb2._SUMMARY
...
Event = _reflection.GeneratedProtocolMessageType('Event', (_message.Message,), dict(
  DESCRIPTOR = _EVENT,
  __module__ = 'diplomacy_tensorflow.core.util.event_pb2'
