...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/core/framework/resource_handle.proto',
...
_RESOURCEHANDLEPROTO = _descriptor.Descriptor(
  ...
  full_name='diplomacy.tensorflow.ResourceHandleProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='device', full_name='diplomacy.tensorflow.ResourceHandleProto.device', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='container', full_name='diplomacy.tensorflow.ResourceHandleProto.container', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='diplomacy.tensorflow.ResourceHandleProto.name', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hash_code', full_name='diplomacy.tensorflow.ResourceHandleProto.hash_code', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='maybe_type_name', full_name='diplomacy.tensorflow.ResourceHandleProto.maybe_type_name', index=4,
...
ResourceHandleProto = _reflection.GeneratedProtocolMessageType('ResourceHandleProto', (_message.Message,), dict(
  ...
  __module__ = 'diplomacy_tensorflow.core.framework.resource_handle_pb2'
