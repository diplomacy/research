...
from diplomacy_tensorflow.core.example import example_pb2 as diplomacy__tensorflow_dot_core_dot_example_dot_example__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n#tensorflow_serving/apis/input.proto\x12\x12tensorflow.serving\x1a/diplomacy_tensorflow/core/example/example.proto\">\n\x0b\x45xampleList\x12/\n\x08\x65xamples\x18\x01 \x03(\x0b\x32\x1d.diplomacy.tensorflow.Example\"y\n\x16\x45xampleListWithContext\x12/\n\x08\x65xamples\x18\x01 \x03(\x0b\x32\x1d.diplomacy.tensorflow.Example\x12.\n\x07\x63ontext\x18\x02 \x01(\x0b\x32\x1d.diplomacy.tensorflow.Example\"\xa1\x01\n\x05Input\x12;\n\x0c\x65xample_list\x18\x01 \x01(\x0b\x32\x1f.tensorflow.serving.ExampleListB\x02(\x01H\x00\x12S\n\x19\x65xample_list_with_context\x18\x02 \x01(\x0b\x32*.tensorflow.serving.ExampleListWithContextB\x02(\x01H\x00\x42\x06\n\x04kindB\x03\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[diplomacy__tensorflow_dot_core_dot_example_dot_example__pb2.DESCRIPTOR,])
...
_EXAMPLELIST.fields_by_name['examples'].message_type = diplomacy__tensorflow_dot_core_dot_example_dot_example__pb2._EXAMPLE
_EXAMPLELISTWITHCONTEXT.fields_by_name['examples'].message_type = diplomacy__tensorflow_dot_core_dot_example_dot_example__pb2._EXAMPLE
_EXAMPLELISTWITHCONTEXT.fields_by_name['context'].message_type = diplomacy__tensorflow_dot_core_dot_example_dot_example__pb2._EXAMPLE
