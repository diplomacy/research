...
class StaticStoragePathSourceConfigDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<StaticStoragePathSourceConfig>
      _instance;
...
static void InitDefaultsStaticStoragePathSourceConfig() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_StaticStoragePathSourceConfig =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsStaticStoragePathSourceConfig}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_StaticStoragePathSourceConfig.base);
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::serving::StaticStoragePathSourceConfig, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::serving::StaticStoragePathSourceConfig, servable_name_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::serving::StaticStoragePathSourceConfig, version_num_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::serving::StaticStoragePathSourceConfig, version_path_),
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::tensorflow::serving::_StaticStoragePathSourceConfig_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "tensorflow_serving/sources/storage_path/static_storage_path_source.proto", schemas, file_default_instances, TableStruct::offsets,
...
StaticStoragePathSourceConfig::StaticStoragePathSourceConfig()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_tensorflow_5fserving_2fsources_2fstorage_5fpath_2fstatic_5fstorage_5fpath_5fsource_2eproto::scc_info_StaticStoragePathSourceConfig.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* StaticStoragePathSourceConfig::descriptor() {
  ...
  return ::protobuf_tensorflow_5fserving_2fsources_2fstorage_5fpath_2fstatic_5fstorage_5fpath_5fsource_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const StaticStoragePathSourceConfig& StaticStoragePathSourceConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_tensorflow_5fserving_2fsources_2fstorage_5fpath_2fstatic_5fstorage_5fpath_5fsource_2eproto::scc_info_StaticStoragePathSourceConfig.base);
...
void StaticStoragePathSourceConfig::InternalSwap(StaticStoragePathSourceConfig* other) {
  ...
  servable_name_.Swap(&other->servable_name_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  version_path_.Swap(&other->version_path_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
::google::protobuf::Metadata StaticStoragePathSourceConfig::GetMetadata() const {
  protobuf_tensorflow_5fserving_2fsources_2fstorage_5fpath_2fstatic_5fstorage_5fpath_5fsource_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_tensorflow_5fserving_2fsources_2fstorage_5fpath_2fstatic_5fstorage_5fpath_5fsource_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::serving::StaticStoragePathSourceConfig* Arena::CreateMaybeMessage< ::tensorflow::serving::StaticStoragePathSourceConfig >(Arena* arena) {
