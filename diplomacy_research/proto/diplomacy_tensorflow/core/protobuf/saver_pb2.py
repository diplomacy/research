...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/core/protobuf/saver.proto',
...
_SAVERDEF_CHECKPOINTFORMATVERSION = _descriptor.EnumDescriptor(
  ...
  full_name='diplomacy.tensorflow.SaverDef.CheckpointFormatVersion',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SAVERDEF = _descriptor.Descriptor(
  name='SaverDef',
  full_name='diplomacy.tensorflow.SaverDef',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='filename_tensor_name', full_name='diplomacy.tensorflow.SaverDef.filename_tensor_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='save_tensor_name', full_name='diplomacy.tensorflow.SaverDef.save_tensor_name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='restore_op_name', full_name='diplomacy.tensorflow.SaverDef.restore_op_name', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_to_keep', full_name='diplomacy.tensorflow.SaverDef.max_to_keep', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sharded', full_name='diplomacy.tensorflow.SaverDef.sharded', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keep_checkpoint_every_n_hours', full_name='diplomacy.tensorflow.SaverDef.keep_checkpoint_every_n_hours', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='version', full_name='diplomacy.tensorflow.SaverDef.version', index=6,
...
SaverDef = _reflection.GeneratedProtocolMessageType('SaverDef', (_message.Message,), dict(
  ...
  __module__ = 'diplomacy_tensorflow.core.protobuf.saver_pb2'
