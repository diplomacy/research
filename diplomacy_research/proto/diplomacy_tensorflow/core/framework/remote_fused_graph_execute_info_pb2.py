...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/core/framework/remote_fused_graph_execute_info.proto',
  ...
  ,
  dependencies=[diplomacy__tensorflow_dot_core_dot_framework_dot_graph__pb2.DESCRIPTOR,diplomacy__tensorflow_dot_core_dot_framework_dot_tensor__shape__pb2.DESCRIPTOR,diplomacy__tensorflow_dot_core_dot_framework_dot_types__pb2.DESCRIPTOR,])
...
_REMOTEFUSEDGRAPHEXECUTEINFO_TENSORSHAPETYPEPROTO = _descriptor.Descriptor(
  ...
  full_name='diplomacy.tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dtype', full_name='diplomacy.tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto.dtype', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='shape', full_name='diplomacy.tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto.shape', index=1,
...
_REMOTEFUSEDGRAPHEXECUTEINFO = _descriptor.Descriptor(
  ...
  full_name='diplomacy.tensorflow.RemoteFusedGraphExecuteInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='remote_graph', full_name='diplomacy.tensorflow.RemoteFusedGraphExecuteInfo.remote_graph', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='graph_input_node_name', full_name='diplomacy.tensorflow.RemoteFusedGraphExecuteInfo.graph_input_node_name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='graph_output_node_name', full_name='diplomacy.tensorflow.RemoteFusedGraphExecuteInfo.graph_output_node_name', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='executor_name', full_name='diplomacy.tensorflow.RemoteFusedGraphExecuteInfo.executor_name', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='serialized_executor_parameters', full_name='diplomacy.tensorflow.RemoteFusedGraphExecuteInfo.serialized_executor_parameters', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_graph_input_tensor_shape', full_name='diplomacy.tensorflow.RemoteFusedGraphExecuteInfo.default_graph_input_tensor_shape', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_graph_output_tensor_shape', full_name='diplomacy.tensorflow.RemoteFusedGraphExecuteInfo.default_graph_output_tensor_shape', index=6,
...
_REMOTEFUSEDGRAPHEXECUTEINFO_TENSORSHAPETYPEPROTO.fields_by_name['dtype'].enum_type = diplomacy__tensorflow_dot_core_dot_framework_dot_types__pb2._DATATYPE
_REMOTEFUSEDGRAPHEXECUTEINFO_TENSORSHAPETYPEPROTO.fields_by_name['shape'].message_type = diplomacy__tensorflow_dot_core_dot_framework_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_REMOTEFUSEDGRAPHEXECUTEINFO_TENSORSHAPETYPEPROTO.containing_type = _REMOTEFUSEDGRAPHEXECUTEINFO
_REMOTEFUSEDGRAPHEXECUTEINFO.fields_by_name['remote_graph'].message_type = diplomacy__tensorflow_dot_core_dot_framework_dot_graph__pb2._GRAPHDEF
...
RemoteFusedGraphExecuteInfo = _reflection.GeneratedProtocolMessageType('RemoteFusedGraphExecuteInfo', (_message.Message,), dict(
  ...
  TensorShapeTypeProto = _reflection.GeneratedProtocolMessageType('TensorShapeTypeProto', (_message.Message,), dict(
    ...
    __module__ = 'diplomacy_tensorflow.core.framework.remote_fused_graph_execute_info_pb2'
