...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/core/framework/api_def.proto',
...
_APIDEF_VISIBILITY = _descriptor.EnumDescriptor(
  name='Visibility',
  full_name='diplomacy.tensorflow.ApiDef.Visibility',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_APIDEF_ENDPOINT = _descriptor.Descriptor(
  name='Endpoint',
  full_name='diplomacy.tensorflow.ApiDef.Endpoint',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='diplomacy.tensorflow.ApiDef.Endpoint.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='deprecated', full_name='diplomacy.tensorflow.ApiDef.Endpoint.deprecated', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='deprecation_version', full_name='diplomacy.tensorflow.ApiDef.Endpoint.deprecation_version', index=2,
...
_APIDEF_ARG = _descriptor.Descriptor(
  name='Arg',
  full_name='diplomacy.tensorflow.ApiDef.Arg',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='diplomacy.tensorflow.ApiDef.Arg.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rename_to', full_name='diplomacy.tensorflow.ApiDef.Arg.rename_to', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description', full_name='diplomacy.tensorflow.ApiDef.Arg.description', index=2,
...
_APIDEF_ATTR = _descriptor.Descriptor(
  name='Attr',
  full_name='diplomacy.tensorflow.ApiDef.Attr',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='diplomacy.tensorflow.ApiDef.Attr.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rename_to', full_name='diplomacy.tensorflow.ApiDef.Attr.rename_to', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_value', full_name='diplomacy.tensorflow.ApiDef.Attr.default_value', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description', full_name='diplomacy.tensorflow.ApiDef.Attr.description', index=3,
...
_APIDEF = _descriptor.Descriptor(
  name='ApiDef',
  full_name='diplomacy.tensorflow.ApiDef',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='graph_op_name', full_name='diplomacy.tensorflow.ApiDef.graph_op_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='deprecation_message', full_name='diplomacy.tensorflow.ApiDef.deprecation_message', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='deprecation_version', full_name='diplomacy.tensorflow.ApiDef.deprecation_version', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='visibility', full_name='diplomacy.tensorflow.ApiDef.visibility', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='endpoint', full_name='diplomacy.tensorflow.ApiDef.endpoint', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='in_arg', full_name='diplomacy.tensorflow.ApiDef.in_arg', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='out_arg', full_name='diplomacy.tensorflow.ApiDef.out_arg', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='arg_order', full_name='diplomacy.tensorflow.ApiDef.arg_order', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attr', full_name='diplomacy.tensorflow.ApiDef.attr', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='summary', full_name='diplomacy.tensorflow.ApiDef.summary', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description', full_name='diplomacy.tensorflow.ApiDef.description', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description_prefix', full_name='diplomacy.tensorflow.ApiDef.description_prefix', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description_suffix', full_name='diplomacy.tensorflow.ApiDef.description_suffix', index=12,
...
_APIDEFS = _descriptor.Descriptor(
  name='ApiDefs',
  full_name='diplomacy.tensorflow.ApiDefs',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='op', full_name='diplomacy.tensorflow.ApiDefs.op', index=0,
...
_APIDEF_ATTR.fields_by_name['default_value'].message_type = diplomacy__tensorflow_dot_core_dot_framework_dot_attr__value__pb2._ATTRVALUE
...
ApiDef = _reflection.GeneratedProtocolMessageType('ApiDef', (_message.Message,), dict(
  ...
  Endpoint = _reflection.GeneratedProtocolMessageType('Endpoint', (_message.Message,), dict(
    ...
    __module__ = 'diplomacy_tensorflow.core.framework.api_def_pb2'
