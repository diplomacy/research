...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2frewriter_5fconfig_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2frewriter_5fconfig_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2frewriter_5fconfig_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::AutoParallelOptions* Arena::CreateMaybeMessage<::diplomacy::tensorflow::AutoParallelOptions>(Arena*);
template<> ::diplomacy::tensorflow::RewriterConfig* Arena::CreateMaybeMessage<::diplomacy::tensorflow::RewriterConfig>(Arena*);
template<> ::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer* Arena::CreateMaybeMessage<::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer>(Arena*);
template<> ::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer_ParameterMapEntry_DoNotUse* Arena::CreateMaybeMessage<::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer_ParameterMapEntry_DoNotUse>(Arena*);
template<> ::diplomacy::tensorflow::ScopedAllocatorOptions* Arena::CreateMaybeMessage<::diplomacy::tensorflow::ScopedAllocatorOptions>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class AutoParallelOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.AutoParallelOptions) */ {
 public:
  AutoParallelOptions();
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.AutoParallelOptions)
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2frewriter_5fconfig_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class ScopedAllocatorOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.ScopedAllocatorOptions) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.ScopedAllocatorOptions)
 private:
...
class RewriterConfig_CustomGraphOptimizer : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.RewriterConfig.CustomGraphOptimizer) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.RewriterConfig.CustomGraphOptimizer)
 private:
...
class RewriterConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.RewriterConfig) */ {
 public:
  RewriterConfig();
  ...
  ::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer* mutable_custom_optimizers(int index);
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer >*
      mutable_custom_optimizers();
  const ::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer& custom_optimizers(int index) const;
  ::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer* add_custom_optimizers();
  const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer >&
  ...
  private:
  const ::diplomacy::tensorflow::AutoParallelOptions& _internal_auto_parallel() const;
  public:
  const ::diplomacy::tensorflow::AutoParallelOptions& auto_parallel() const;
  ::diplomacy::tensorflow::AutoParallelOptions* release_auto_parallel();
  ::diplomacy::tensorflow::AutoParallelOptions* mutable_auto_parallel();
  void set_allocated_auto_parallel(::diplomacy::tensorflow::AutoParallelOptions* auto_parallel);
  void unsafe_arena_set_allocated_auto_parallel(
      ::diplomacy::tensorflow::AutoParallelOptions* auto_parallel);
  ::diplomacy::tensorflow::AutoParallelOptions* unsafe_arena_release_auto_parallel();
  ...
  private:
  const ::diplomacy::tensorflow::ScopedAllocatorOptions& _internal_scoped_allocator_opts() const;
  public:
  const ::diplomacy::tensorflow::ScopedAllocatorOptions& scoped_allocator_opts() const;
  ::diplomacy::tensorflow::ScopedAllocatorOptions* release_scoped_allocator_opts();
  ::diplomacy::tensorflow::ScopedAllocatorOptions* mutable_scoped_allocator_opts();
  void set_allocated_scoped_allocator_opts(::diplomacy::tensorflow::ScopedAllocatorOptions* scoped_allocator_opts);
  void unsafe_arena_set_allocated_scoped_allocator_opts(
      ::diplomacy::tensorflow::ScopedAllocatorOptions* scoped_allocator_opts);
  ::diplomacy::tensorflow::ScopedAllocatorOptions* unsafe_arena_release_scoped_allocator_opts();
  ...
  ::diplomacy::tensorflow::RewriterConfig_Toggle layout_optimizer() const;
  void set_layout_optimizer(::diplomacy::tensorflow::RewriterConfig_Toggle value);
  ...
  ::diplomacy::tensorflow::RewriterConfig_Toggle constant_folding() const;
  void set_constant_folding(::diplomacy::tensorflow::RewriterConfig_Toggle value);
  ...
  ::diplomacy::tensorflow::RewriterConfig_MemOptType memory_optimization() const;
  void set_memory_optimization(::diplomacy::tensorflow::RewriterConfig_MemOptType value);
  ...
  ::diplomacy::tensorflow::RewriterConfig_Toggle arithmetic_optimization() const;
  void set_arithmetic_optimization(::diplomacy::tensorflow::RewriterConfig_Toggle value);
  ...
  ::diplomacy::tensorflow::RewriterConfig_Toggle dependency_optimization() const;
  void set_dependency_optimization(::diplomacy::tensorflow::RewriterConfig_Toggle value);
  ...
  ::diplomacy::tensorflow::RewriterConfig_Toggle loop_optimization() const;
  void set_loop_optimization(::diplomacy::tensorflow::RewriterConfig_Toggle value);
  ...
  ::diplomacy::tensorflow::RewriterConfig_Toggle function_optimization() const;
  void set_function_optimization(::diplomacy::tensorflow::RewriterConfig_Toggle value);
  ...
  ::diplomacy::tensorflow::RewriterConfig_Toggle debug_stripper() const;
  void set_debug_stripper(::diplomacy::tensorflow::RewriterConfig_Toggle value);
  ...
  ::diplomacy::tensorflow::RewriterConfig_NumIterationsType meta_optimizer_iterations() const;
  void set_meta_optimizer_iterations(::diplomacy::tensorflow::RewriterConfig_NumIterationsType value);
  ...
  ::diplomacy::tensorflow::RewriterConfig_Toggle shape_optimization() const;
  void set_shape_optimization(::diplomacy::tensorflow::RewriterConfig_Toggle value);

  // .diplomacy.tensorflow.RewriterConfig.Toggle remapping = 14;
  void clear_remapping();
  static const int kRemappingFieldNumber = 14;
  ::diplomacy::tensorflow::RewriterConfig_Toggle remapping() const;
  void set_remapping(::diplomacy::tensorflow::RewriterConfig_Toggle value);
  ...
  ::diplomacy::tensorflow::RewriterConfig_Toggle scoped_allocator_optimization() const;
  void set_scoped_allocator_optimization(::diplomacy::tensorflow::RewriterConfig_Toggle value);
  ...
  ::diplomacy::tensorflow::RewriterConfig_Toggle pin_to_host_optimization() const;
  void set_pin_to_host_optimization(::diplomacy::tensorflow::RewriterConfig_Toggle value);

  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.RewriterConfig)
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer > custom_optimizers_;
  ::google::protobuf::internal::ArenaStringPtr memory_optimizer_target_node_name_scope_;
  ::diplomacy::tensorflow::AutoParallelOptions* auto_parallel_;
  ::diplomacy::tensorflow::ScopedAllocatorOptions* scoped_allocator_opts_;
...
inline bool AutoParallelOptions::enable() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.AutoParallelOptions.enable)
  return enable_;
}
inline void AutoParallelOptions::set_enable(bool value) {
  
  enable_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.AutoParallelOptions.enable)
}
...
inline ::google::protobuf::int32 AutoParallelOptions::num_replicas() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.AutoParallelOptions.num_replicas)
  return num_replicas_;
}
inline void AutoParallelOptions::set_num_replicas(::google::protobuf::int32 value) {
  
  num_replicas_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.AutoParallelOptions.num_replicas)
}
...
inline const ::std::string& ScopedAllocatorOptions::enable_op(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.ScopedAllocatorOptions.enable_op)
  return enable_op_.Get(index);
}
inline ::std::string* ScopedAllocatorOptions::mutable_enable_op(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.ScopedAllocatorOptions.enable_op)
  return enable_op_.Mutable(index);
}
inline void ScopedAllocatorOptions::set_enable_op(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.ScopedAllocatorOptions.enable_op)
...
inline void ScopedAllocatorOptions::set_enable_op(int index, const char* value) {
  ...
  enable_op_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.ScopedAllocatorOptions.enable_op)
}
inline void ScopedAllocatorOptions::set_enable_op(int index, const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.ScopedAllocatorOptions.enable_op)
}
inline ::std::string* ScopedAllocatorOptions::add_enable_op() {
  // @@protoc_insertion_point(field_add_mutable:diplomacy.tensorflow.ScopedAllocatorOptions.enable_op)
  return enable_op_.Add();
}
inline void ScopedAllocatorOptions::add_enable_op(const ::std::string& value) {
  enable_op_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.ScopedAllocatorOptions.enable_op)
}
#if LANG_CXX11
...
inline void ScopedAllocatorOptions::add_enable_op(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  enable_op_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:diplomacy.tensorflow.ScopedAllocatorOptions.enable_op)
}
inline void ScopedAllocatorOptions::add_enable_op(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:diplomacy.tensorflow.ScopedAllocatorOptions.enable_op)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
ScopedAllocatorOptions::enable_op() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.ScopedAllocatorOptions.enable_op)
  return enable_op_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
ScopedAllocatorOptions::mutable_enable_op() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.ScopedAllocatorOptions.enable_op)
  return &enable_op_;
}
...
inline const ::std::string& RewriterConfig_CustomGraphOptimizer::name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.CustomGraphOptimizer.name)
  return name_.Get();
}
inline void RewriterConfig_CustomGraphOptimizer::set_name(const ::std::string& value) {
  
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.CustomGraphOptimizer.name)
}
#if LANG_CXX11
inline void RewriterConfig_CustomGraphOptimizer::set_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.RewriterConfig.CustomGraphOptimizer.name)
}
#endif
inline void RewriterConfig_CustomGraphOptimizer::set_name(const char* value) {
  ...
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.RewriterConfig.CustomGraphOptimizer.name)
}
inline void RewriterConfig_CustomGraphOptimizer::set_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.RewriterConfig.CustomGraphOptimizer.name)
}
inline ::std::string* RewriterConfig_CustomGraphOptimizer::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.RewriterConfig.CustomGraphOptimizer.name)
  return name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* RewriterConfig_CustomGraphOptimizer::release_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.RewriterConfig.CustomGraphOptimizer.name)
...
inline void RewriterConfig_CustomGraphOptimizer::set_allocated_name(::std::string* name) {
  ...
  name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.RewriterConfig.CustomGraphOptimizer.name)
}
inline ::std::string* RewriterConfig_CustomGraphOptimizer::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.RewriterConfig.CustomGraphOptimizer.name)
...
inline void RewriterConfig_CustomGraphOptimizer::unsafe_arena_set_allocated_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.RewriterConfig.CustomGraphOptimizer.name)
}
...
RewriterConfig_CustomGraphOptimizer::parameter_map() const {
  // @@protoc_insertion_point(field_map:diplomacy.tensorflow.RewriterConfig.CustomGraphOptimizer.parameter_map)
...
RewriterConfig_CustomGraphOptimizer::mutable_parameter_map() {
  // @@protoc_insertion_point(field_mutable_map:diplomacy.tensorflow.RewriterConfig.CustomGraphOptimizer.parameter_map)
...
inline ::diplomacy::tensorflow::RewriterConfig_Toggle RewriterConfig::layout_optimizer() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.layout_optimizer)
  return static_cast< ::diplomacy::tensorflow::RewriterConfig_Toggle >(layout_optimizer_);
}
inline void RewriterConfig::set_layout_optimizer(::diplomacy::tensorflow::RewriterConfig_Toggle value) {
  
  layout_optimizer_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.layout_optimizer)
}
...
inline ::diplomacy::tensorflow::RewriterConfig_Toggle RewriterConfig::constant_folding() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.constant_folding)
  return static_cast< ::diplomacy::tensorflow::RewriterConfig_Toggle >(constant_folding_);
}
inline void RewriterConfig::set_constant_folding(::diplomacy::tensorflow::RewriterConfig_Toggle value) {
  
  constant_folding_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.constant_folding)
}
...
inline ::diplomacy::tensorflow::RewriterConfig_Toggle RewriterConfig::shape_optimization() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.shape_optimization)
  return static_cast< ::diplomacy::tensorflow::RewriterConfig_Toggle >(shape_optimization_);
}
inline void RewriterConfig::set_shape_optimization(::diplomacy::tensorflow::RewriterConfig_Toggle value) {
  
  shape_optimization_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.shape_optimization)
}
...
inline ::diplomacy::tensorflow::RewriterConfig_Toggle RewriterConfig::remapping() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.remapping)
  return static_cast< ::diplomacy::tensorflow::RewriterConfig_Toggle >(remapping_);
}
inline void RewriterConfig::set_remapping(::diplomacy::tensorflow::RewriterConfig_Toggle value) {
  
  remapping_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.remapping)
}
...
inline ::diplomacy::tensorflow::RewriterConfig_Toggle RewriterConfig::arithmetic_optimization() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.arithmetic_optimization)
  return static_cast< ::diplomacy::tensorflow::RewriterConfig_Toggle >(arithmetic_optimization_);
}
inline void RewriterConfig::set_arithmetic_optimization(::diplomacy::tensorflow::RewriterConfig_Toggle value) {
  
  arithmetic_optimization_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.arithmetic_optimization)
}
...
inline ::diplomacy::tensorflow::RewriterConfig_Toggle RewriterConfig::dependency_optimization() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.dependency_optimization)
  return static_cast< ::diplomacy::tensorflow::RewriterConfig_Toggle >(dependency_optimization_);
}
inline void RewriterConfig::set_dependency_optimization(::diplomacy::tensorflow::RewriterConfig_Toggle value) {
  
  dependency_optimization_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.dependency_optimization)
}
...
inline ::diplomacy::tensorflow::RewriterConfig_Toggle RewriterConfig::loop_optimization() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.loop_optimization)
  return static_cast< ::diplomacy::tensorflow::RewriterConfig_Toggle >(loop_optimization_);
}
inline void RewriterConfig::set_loop_optimization(::diplomacy::tensorflow::RewriterConfig_Toggle value) {
  
  loop_optimization_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.loop_optimization)
}
...
inline ::diplomacy::tensorflow::RewriterConfig_Toggle RewriterConfig::function_optimization() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.function_optimization)
  return static_cast< ::diplomacy::tensorflow::RewriterConfig_Toggle >(function_optimization_);
}
inline void RewriterConfig::set_function_optimization(::diplomacy::tensorflow::RewriterConfig_Toggle value) {
  
  function_optimization_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.function_optimization)
}
...
inline ::diplomacy::tensorflow::RewriterConfig_Toggle RewriterConfig::debug_stripper() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.debug_stripper)
  return static_cast< ::diplomacy::tensorflow::RewriterConfig_Toggle >(debug_stripper_);
}
inline void RewriterConfig::set_debug_stripper(::diplomacy::tensorflow::RewriterConfig_Toggle value) {
  
  debug_stripper_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.debug_stripper)
}
...
inline bool RewriterConfig::disable_model_pruning() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.disable_model_pruning)
  return disable_model_pruning_;
}
inline void RewriterConfig::set_disable_model_pruning(bool value) {
  
  disable_model_pruning_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.disable_model_pruning)
}
...
inline ::diplomacy::tensorflow::RewriterConfig_Toggle RewriterConfig::scoped_allocator_optimization() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.scoped_allocator_optimization)
  return static_cast< ::diplomacy::tensorflow::RewriterConfig_Toggle >(scoped_allocator_optimization_);
}
inline void RewriterConfig::set_scoped_allocator_optimization(::diplomacy::tensorflow::RewriterConfig_Toggle value) {
  
  scoped_allocator_optimization_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.scoped_allocator_optimization)
}
...
inline ::diplomacy::tensorflow::RewriterConfig_Toggle RewriterConfig::pin_to_host_optimization() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.pin_to_host_optimization)
  return static_cast< ::diplomacy::tensorflow::RewriterConfig_Toggle >(pin_to_host_optimization_);
}
inline void RewriterConfig::set_pin_to_host_optimization(::diplomacy::tensorflow::RewriterConfig_Toggle value) {
  
  pin_to_host_optimization_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.pin_to_host_optimization)
}
...
inline bool RewriterConfig::disable_meta_optimizer() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.disable_meta_optimizer)
...
inline void RewriterConfig::set_disable_meta_optimizer(bool value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.disable_meta_optimizer)
}
...
inline ::diplomacy::tensorflow::RewriterConfig_NumIterationsType RewriterConfig::meta_optimizer_iterations() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.meta_optimizer_iterations)
  return static_cast< ::diplomacy::tensorflow::RewriterConfig_NumIterationsType >(meta_optimizer_iterations_);
}
inline void RewriterConfig::set_meta_optimizer_iterations(::diplomacy::tensorflow::RewriterConfig_NumIterationsType value) {
  
  meta_optimizer_iterations_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.meta_optimizer_iterations)
}
...
inline ::google::protobuf::int32 RewriterConfig::min_graph_nodes() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.min_graph_nodes)
  return min_graph_nodes_;
}
inline void RewriterConfig::set_min_graph_nodes(::google::protobuf::int32 value) {
  
  min_graph_nodes_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.min_graph_nodes)
}
...
inline ::diplomacy::tensorflow::RewriterConfig_MemOptType RewriterConfig::memory_optimization() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.memory_optimization)
  return static_cast< ::diplomacy::tensorflow::RewriterConfig_MemOptType >(memory_optimization_);
}
inline void RewriterConfig::set_memory_optimization(::diplomacy::tensorflow::RewriterConfig_MemOptType value) {
  
  memory_optimization_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.memory_optimization)
}
...
inline const ::std::string& RewriterConfig::memory_optimizer_target_node_name_scope() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.memory_optimizer_target_node_name_scope)
...
inline void RewriterConfig::set_memory_optimizer_target_node_name_scope(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.memory_optimizer_target_node_name_scope)
}
#if LANG_CXX11
inline void RewriterConfig::set_memory_optimizer_target_node_name_scope(::std::string&& value) {
  ...
  memory_optimizer_target_node_name_scope_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.RewriterConfig.memory_optimizer_target_node_name_scope)
}
#endif
inline void RewriterConfig::set_memory_optimizer_target_node_name_scope(const char* value) {
  ...
  memory_optimizer_target_node_name_scope_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.RewriterConfig.memory_optimizer_target_node_name_scope)
}
inline void RewriterConfig::set_memory_optimizer_target_node_name_scope(const char* value,
    size_t size) {
  ...
  memory_optimizer_target_node_name_scope_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.RewriterConfig.memory_optimizer_target_node_name_scope)
}
inline ::std::string* RewriterConfig::mutable_memory_optimizer_target_node_name_scope() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.RewriterConfig.memory_optimizer_target_node_name_scope)
...
inline ::std::string* RewriterConfig::release_memory_optimizer_target_node_name_scope() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.RewriterConfig.memory_optimizer_target_node_name_scope)
...
inline void RewriterConfig::set_allocated_memory_optimizer_target_node_name_scope(::std::string* memory_optimizer_target_node_name_scope) {
  ...
  memory_optimizer_target_node_name_scope_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), memory_optimizer_target_node_name_scope,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.RewriterConfig.memory_optimizer_target_node_name_scope)
}
inline ::std::string* RewriterConfig::unsafe_arena_release_memory_optimizer_target_node_name_scope() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.RewriterConfig.memory_optimizer_target_node_name_scope)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void RewriterConfig::unsafe_arena_set_allocated_memory_optimizer_target_node_name_scope(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.RewriterConfig.memory_optimizer_target_node_name_scope)
}
...
inline ::google::protobuf::int64 RewriterConfig::meta_optimizer_timeout_ms() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.meta_optimizer_timeout_ms)
...
inline void RewriterConfig::set_meta_optimizer_timeout_ms(::google::protobuf::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.meta_optimizer_timeout_ms)
}
...
inline const ::diplomacy::tensorflow::AutoParallelOptions& RewriterConfig::_internal_auto_parallel() const {
  return *auto_parallel_;
}
inline const ::diplomacy::tensorflow::AutoParallelOptions& RewriterConfig::auto_parallel() const {
  const ::diplomacy::tensorflow::AutoParallelOptions* p = auto_parallel_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.auto_parallel)
  return p != NULL ? *p : *reinterpret_cast<const ::diplomacy::tensorflow::AutoParallelOptions*>(
      &::diplomacy::tensorflow::_AutoParallelOptions_default_instance_);
}
inline ::diplomacy::tensorflow::AutoParallelOptions* RewriterConfig::release_auto_parallel() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.RewriterConfig.auto_parallel)
  
  ::diplomacy::tensorflow::AutoParallelOptions* temp = auto_parallel_;
...
inline ::diplomacy::tensorflow::AutoParallelOptions* RewriterConfig::unsafe_arena_release_auto_parallel() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.RewriterConfig.auto_parallel)
  
  ::diplomacy::tensorflow::AutoParallelOptions* temp = auto_parallel_;
  auto_parallel_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::AutoParallelOptions* RewriterConfig::mutable_auto_parallel() {
  
  if (auto_parallel_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::AutoParallelOptions>(GetArenaNoVirtual());
    auto_parallel_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.RewriterConfig.auto_parallel)
  return auto_parallel_;
}
inline void RewriterConfig::set_allocated_auto_parallel(::diplomacy::tensorflow::AutoParallelOptions* auto_parallel) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.RewriterConfig.auto_parallel)
}
...
inline bool RewriterConfig::fail_on_optimizer_errors() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.fail_on_optimizer_errors)
...
inline void RewriterConfig::set_fail_on_optimizer_errors(bool value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.fail_on_optimizer_errors)
}
...
inline const ::diplomacy::tensorflow::ScopedAllocatorOptions& RewriterConfig::_internal_scoped_allocator_opts() const {
  return *scoped_allocator_opts_;
}
inline const ::diplomacy::tensorflow::ScopedAllocatorOptions& RewriterConfig::scoped_allocator_opts() const {
  const ::diplomacy::tensorflow::ScopedAllocatorOptions* p = scoped_allocator_opts_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.scoped_allocator_opts)
  return p != NULL ? *p : *reinterpret_cast<const ::diplomacy::tensorflow::ScopedAllocatorOptions*>(
      &::diplomacy::tensorflow::_ScopedAllocatorOptions_default_instance_);
}
inline ::diplomacy::tensorflow::ScopedAllocatorOptions* RewriterConfig::release_scoped_allocator_opts() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.RewriterConfig.scoped_allocator_opts)
  
  ::diplomacy::tensorflow::ScopedAllocatorOptions* temp = scoped_allocator_opts_;
  if (GetArenaNoVirtual() != NULL) {
    temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
  }
  scoped_allocator_opts_ = NULL;
...
inline ::diplomacy::tensorflow::ScopedAllocatorOptions* RewriterConfig::unsafe_arena_release_scoped_allocator_opts() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.RewriterConfig.scoped_allocator_opts)
  
  ::diplomacy::tensorflow::ScopedAllocatorOptions* temp = scoped_allocator_opts_;
  scoped_allocator_opts_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::ScopedAllocatorOptions* RewriterConfig::mutable_scoped_allocator_opts() {
  
  if (scoped_allocator_opts_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::ScopedAllocatorOptions>(GetArenaNoVirtual());
    scoped_allocator_opts_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.RewriterConfig.scoped_allocator_opts)
  return scoped_allocator_opts_;
}
inline void RewriterConfig::set_allocated_scoped_allocator_opts(::diplomacy::tensorflow::ScopedAllocatorOptions* scoped_allocator_opts) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete scoped_allocator_opts_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.RewriterConfig.scoped_allocator_opts)
}
...
inline const ::std::string& RewriterConfig::optimizers(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.optimizers)
  return optimizers_.Get(index);
}
inline ::std::string* RewriterConfig::mutable_optimizers(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.RewriterConfig.optimizers)
  return optimizers_.Mutable(index);
}
inline void RewriterConfig::set_optimizers(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RewriterConfig.optimizers)
...
inline void RewriterConfig::set_optimizers(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  optimizers_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.RewriterConfig.optimizers)
}
inline void RewriterConfig::set_optimizers(int index, const char* value, size_t size) {
  optimizers_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.RewriterConfig.optimizers)
}
inline ::std::string* RewriterConfig::add_optimizers() {
  // @@protoc_insertion_point(field_add_mutable:diplomacy.tensorflow.RewriterConfig.optimizers)
  return optimizers_.Add();
}
inline void RewriterConfig::add_optimizers(const ::std::string& value) {
  optimizers_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.RewriterConfig.optimizers)
}
#if LANG_CXX11
...
inline void RewriterConfig::add_optimizers(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  optimizers_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:diplomacy.tensorflow.RewriterConfig.optimizers)
}
inline void RewriterConfig::add_optimizers(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:diplomacy.tensorflow.RewriterConfig.optimizers)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
RewriterConfig::optimizers() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.RewriterConfig.optimizers)
  return optimizers_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
RewriterConfig::mutable_optimizers() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.RewriterConfig.optimizers)
  return &optimizers_;
}
...
inline ::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer* RewriterConfig::mutable_custom_optimizers(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.RewriterConfig.custom_optimizers)
  return custom_optimizers_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer >*
RewriterConfig::mutable_custom_optimizers() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.RewriterConfig.custom_optimizers)
  return &custom_optimizers_;
}
inline const ::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer& RewriterConfig::custom_optimizers(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RewriterConfig.custom_optimizers)
  return custom_optimizers_.Get(index);
}
inline ::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer* RewriterConfig::add_custom_optimizers() {
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.RewriterConfig.custom_optimizers)
  return custom_optimizers_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::RewriterConfig_CustomGraphOptimizer >&
RewriterConfig::custom_optimizers() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.RewriterConfig.custom_optimizers)
  return custom_optimizers_;
}
...
template <> struct is_proto_enum< ::diplomacy::tensorflow::RewriterConfig_Toggle> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::diplomacy::tensorflow::RewriterConfig_Toggle>() {
  return ::diplomacy::tensorflow::RewriterConfig_Toggle_descriptor();
}
template <> struct is_proto_enum< ::diplomacy::tensorflow::RewriterConfig_NumIterationsType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::diplomacy::tensorflow::RewriterConfig_NumIterationsType>() {
  return ::diplomacy::tensorflow::RewriterConfig_NumIterationsType_descriptor();
}
template <> struct is_proto_enum< ::diplomacy::tensorflow::RewriterConfig_MemOptType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::diplomacy::tensorflow::RewriterConfig_MemOptType>() {
  return ::diplomacy::tensorflow::RewriterConfig_MemOptType_descriptor();
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2frewriter_5fconfig_2eproto
