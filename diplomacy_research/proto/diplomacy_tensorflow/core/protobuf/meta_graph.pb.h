...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fmeta_5fgraph_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fmeta_5fgraph_2eproto
...
#include "diplomacy_tensorflow/core/framework/op_def.pb.h"
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fmeta_5fgraph_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::AssetFileDef* Arena::CreateMaybeMessage<::diplomacy::tensorflow::AssetFileDef>(Arena*);
template<> ::diplomacy::tensorflow::CollectionDef* Arena::CreateMaybeMessage<::diplomacy::tensorflow::CollectionDef>(Arena*);
template<> ::diplomacy::tensorflow::CollectionDef_AnyList* Arena::CreateMaybeMessage<::diplomacy::tensorflow::CollectionDef_AnyList>(Arena*);
template<> ::diplomacy::tensorflow::CollectionDef_BytesList* Arena::CreateMaybeMessage<::diplomacy::tensorflow::CollectionDef_BytesList>(Arena*);
template<> ::diplomacy::tensorflow::CollectionDef_FloatList* Arena::CreateMaybeMessage<::diplomacy::tensorflow::CollectionDef_FloatList>(Arena*);
template<> ::diplomacy::tensorflow::CollectionDef_Int64List* Arena::CreateMaybeMessage<::diplomacy::tensorflow::CollectionDef_Int64List>(Arena*);
template<> ::diplomacy::tensorflow::CollectionDef_NodeList* Arena::CreateMaybeMessage<::diplomacy::tensorflow::CollectionDef_NodeList>(Arena*);
template<> ::diplomacy::tensorflow::MetaGraphDef* Arena::CreateMaybeMessage<::diplomacy::tensorflow::MetaGraphDef>(Arena*);
template<> ::diplomacy::tensorflow::MetaGraphDef_CollectionDefEntry_DoNotUse* Arena::CreateMaybeMessage<::diplomacy::tensorflow::MetaGraphDef_CollectionDefEntry_DoNotUse>(Arena*);
template<> ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef* Arena::CreateMaybeMessage<::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef>(Arena*);
template<> ::diplomacy::tensorflow::MetaGraphDef_SignatureDefEntry_DoNotUse* Arena::CreateMaybeMessage<::diplomacy::tensorflow::MetaGraphDef_SignatureDefEntry_DoNotUse>(Arena*);
template<> ::diplomacy::tensorflow::SignatureDef* Arena::CreateMaybeMessage<::diplomacy::tensorflow::SignatureDef>(Arena*);
template<> ::diplomacy::tensorflow::SignatureDef_InputsEntry_DoNotUse* Arena::CreateMaybeMessage<::diplomacy::tensorflow::SignatureDef_InputsEntry_DoNotUse>(Arena*);
template<> ::diplomacy::tensorflow::SignatureDef_OutputsEntry_DoNotUse* Arena::CreateMaybeMessage<::diplomacy::tensorflow::SignatureDef_OutputsEntry_DoNotUse>(Arena*);
template<> ::diplomacy::tensorflow::TensorInfo* Arena::CreateMaybeMessage<::diplomacy::tensorflow::TensorInfo>(Arena*);
template<> ::diplomacy::tensorflow::TensorInfo_CooSparse* Arena::CreateMaybeMessage<::diplomacy::tensorflow::TensorInfo_CooSparse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class MetaGraphDef_MetaInfoDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef) */ {
 public:
  ...
  private:
  const ::diplomacy::tensorflow::OpList& _internal_stripped_op_list() const;
  public:
  const ::diplomacy::tensorflow::OpList& stripped_op_list() const;
  ::diplomacy::tensorflow::OpList* release_stripped_op_list();
  ::diplomacy::tensorflow::OpList* mutable_stripped_op_list();
  void set_allocated_stripped_op_list(::diplomacy::tensorflow::OpList* stripped_op_list);
  void unsafe_arena_set_allocated_stripped_op_list(
      ::diplomacy::tensorflow::OpList* stripped_op_list);
  ::diplomacy::tensorflow::OpList* unsafe_arena_release_stripped_op_list();
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef)
 private:
  ...
  ::diplomacy::tensorflow::OpList* stripped_op_list_;
  ::google::protobuf::Any* any_info_;
  bool stripped_default_attrs_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fmeta_5fgraph_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class MetaGraphDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.MetaGraphDef) */ {
 public:
  MetaGraphDef();
  ...
  const ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::CollectionDef >&
      collection_def() const;
  ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::CollectionDef >*
  ...
  ::diplomacy::tensorflow::AssetFileDef* mutable_asset_file_def(int index);
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::AssetFileDef >*
      mutable_asset_file_def();
  const ::diplomacy::tensorflow::AssetFileDef& asset_file_def(int index) const;
  ::diplomacy::tensorflow::AssetFileDef* add_asset_file_def();
  const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::AssetFileDef >&
  ...
  private:
  const ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef& _internal_meta_info_def() const;
  public:
  const ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef& meta_info_def() const;
  ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef* release_meta_info_def();
  ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef* mutable_meta_info_def();
  void set_allocated_meta_info_def(::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef* meta_info_def);
  void unsafe_arena_set_allocated_meta_info_def(
      ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef* meta_info_def);
  ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef* unsafe_arena_release_meta_info_def();
  ...
  private:
  const ::diplomacy::tensorflow::SaverDef& _internal_saver_def() const;
  public:
  const ::diplomacy::tensorflow::SaverDef& saver_def() const;
  ::diplomacy::tensorflow::SaverDef* release_saver_def();
  ::diplomacy::tensorflow::SaverDef* mutable_saver_def();
  void set_allocated_saver_def(::diplomacy::tensorflow::SaverDef* saver_def);
  void unsafe_arena_set_allocated_saver_def(
      ::diplomacy::tensorflow::SaverDef* saver_def);
  ::diplomacy::tensorflow::SaverDef* unsafe_arena_release_saver_def();

  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.MetaGraphDef)
 private:
  ...
  ::google::protobuf::internal::MapField<
      ...
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > signature_def_;
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::AssetFileDef > asset_file_def_;
  ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef* meta_info_def_;
  ::diplomacy::tensorflow::GraphDef* graph_def_;
  ::diplomacy::tensorflow::SaverDef* saver_def_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fmeta_5fgraph_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class CollectionDef_NodeList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.CollectionDef.NodeList) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.CollectionDef.NodeList)
 private:
...
class CollectionDef_BytesList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.CollectionDef.BytesList) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.CollectionDef.BytesList)
 private:
...
class CollectionDef_Int64List : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.CollectionDef.Int64List) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.CollectionDef.Int64List)
 private:
...
class CollectionDef_FloatList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.CollectionDef.FloatList) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.CollectionDef.FloatList)
 private:
...
class CollectionDef_AnyList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.CollectionDef.AnyList) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.CollectionDef.AnyList)
 private:
...
class CollectionDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.CollectionDef) */ {
 public:
  CollectionDef();
  ...
  private:
  const ::diplomacy::tensorflow::CollectionDef_NodeList& _internal_node_list() const;
  public:
  const ::diplomacy::tensorflow::CollectionDef_NodeList& node_list() const;
  ::diplomacy::tensorflow::CollectionDef_NodeList* release_node_list();
  ::diplomacy::tensorflow::CollectionDef_NodeList* mutable_node_list();
  void set_allocated_node_list(::diplomacy::tensorflow::CollectionDef_NodeList* node_list);
  void unsafe_arena_set_allocated_node_list(
      ::diplomacy::tensorflow::CollectionDef_NodeList* node_list);
  ::diplomacy::tensorflow::CollectionDef_NodeList* unsafe_arena_release_node_list();
  ...
  private:
  const ::diplomacy::tensorflow::CollectionDef_BytesList& _internal_bytes_list() const;
  public:
  const ::diplomacy::tensorflow::CollectionDef_BytesList& bytes_list() const;
  ::diplomacy::tensorflow::CollectionDef_BytesList* release_bytes_list();
  ::diplomacy::tensorflow::CollectionDef_BytesList* mutable_bytes_list();
  void set_allocated_bytes_list(::diplomacy::tensorflow::CollectionDef_BytesList* bytes_list);
  void unsafe_arena_set_allocated_bytes_list(
      ::diplomacy::tensorflow::CollectionDef_BytesList* bytes_list);
  ::diplomacy::tensorflow::CollectionDef_BytesList* unsafe_arena_release_bytes_list();
  ...
  private:
  const ::diplomacy::tensorflow::CollectionDef_Int64List& _internal_int64_list() const;
  public:
  const ::diplomacy::tensorflow::CollectionDef_Int64List& int64_list() const;
  ::diplomacy::tensorflow::CollectionDef_Int64List* release_int64_list();
  ::diplomacy::tensorflow::CollectionDef_Int64List* mutable_int64_list();
  void set_allocated_int64_list(::diplomacy::tensorflow::CollectionDef_Int64List* int64_list);
  void unsafe_arena_set_allocated_int64_list(
      ::diplomacy::tensorflow::CollectionDef_Int64List* int64_list);
  ::diplomacy::tensorflow::CollectionDef_Int64List* unsafe_arena_release_int64_list();
  ...
  private:
  const ::diplomacy::tensorflow::CollectionDef_FloatList& _internal_float_list() const;
  public:
  const ::diplomacy::tensorflow::CollectionDef_FloatList& float_list() const;
  ::diplomacy::tensorflow::CollectionDef_FloatList* release_float_list();
  ::diplomacy::tensorflow::CollectionDef_FloatList* mutable_float_list();
  void set_allocated_float_list(::diplomacy::tensorflow::CollectionDef_FloatList* float_list);
  void unsafe_arena_set_allocated_float_list(
      ::diplomacy::tensorflow::CollectionDef_FloatList* float_list);
  ::diplomacy::tensorflow::CollectionDef_FloatList* unsafe_arena_release_float_list();
  ...
  private:
  const ::diplomacy::tensorflow::CollectionDef_AnyList& _internal_any_list() const;
  public:
  const ::diplomacy::tensorflow::CollectionDef_AnyList& any_list() const;
  ::diplomacy::tensorflow::CollectionDef_AnyList* release_any_list();
  ::diplomacy::tensorflow::CollectionDef_AnyList* mutable_any_list();
  void set_allocated_any_list(::diplomacy::tensorflow::CollectionDef_AnyList* any_list);
  void unsafe_arena_set_allocated_any_list(
      ::diplomacy::tensorflow::CollectionDef_AnyList* any_list);
  ::diplomacy::tensorflow::CollectionDef_AnyList* unsafe_arena_release_any_list();

  void clear_kind();
  KindCase kind_case() const;
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.CollectionDef)
 private:
  ...
  union KindUnion {
    KindUnion() {}
    ::diplomacy::tensorflow::CollectionDef_NodeList* node_list_;
    ::diplomacy::tensorflow::CollectionDef_BytesList* bytes_list_;
    ::diplomacy::tensorflow::CollectionDef_Int64List* int64_list_;
    ::diplomacy::tensorflow::CollectionDef_FloatList* float_list_;
    ::diplomacy::tensorflow::CollectionDef_AnyList* any_list_;
  } kind_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
...
class TensorInfo_CooSparse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.TensorInfo.CooSparse) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.TensorInfo.CooSparse)
 private:
...
class TensorInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.TensorInfo) */ {
 public:
  TensorInfo();
  virtual ~TensorInfo();
  ...
  ::diplomacy::tensorflow::TensorShapeProto* unsafe_arena_release_tensor_shape();
  ...
  private:
  const ::diplomacy::tensorflow::TensorInfo_CooSparse& _internal_coo_sparse() const;
  public:
  const ::diplomacy::tensorflow::TensorInfo_CooSparse& coo_sparse() const;
  ::diplomacy::tensorflow::TensorInfo_CooSparse* release_coo_sparse();
  ::diplomacy::tensorflow::TensorInfo_CooSparse* mutable_coo_sparse();
  void set_allocated_coo_sparse(::diplomacy::tensorflow::TensorInfo_CooSparse* coo_sparse);
  void unsafe_arena_set_allocated_coo_sparse(
      ::diplomacy::tensorflow::TensorInfo_CooSparse* coo_sparse);
  ::diplomacy::tensorflow::TensorInfo_CooSparse* unsafe_arena_release_coo_sparse();

  void clear_encoding();
  EncodingCase encoding_case() const;
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.TensorInfo)
 private:
  void set_has_name();
  ...
  union EncodingUnion {
    ...
    ::diplomacy::tensorflow::TensorInfo_CooSparse* coo_sparse_;
  } encoding_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  ::google::protobuf::uint32 _oneof_case_[1];
...
class SignatureDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.SignatureDef) */ {
 public:
  SignatureDef();
  ...
  const ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::TensorInfo >&
      inputs() const;
  ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::TensorInfo >*
      mutable_inputs();
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.SignatureDef)
 private:
...
class AssetFileDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.AssetFileDef) */ {
 public:
  AssetFileDef();
  ...
  private:
  const ::diplomacy::tensorflow::TensorInfo& _internal_tensor_info() const;
  public:
  const ::diplomacy::tensorflow::TensorInfo& tensor_info() const;
  ::diplomacy::tensorflow::TensorInfo* release_tensor_info();
  ::diplomacy::tensorflow::TensorInfo* mutable_tensor_info();
  void set_allocated_tensor_info(::diplomacy::tensorflow::TensorInfo* tensor_info);
  void unsafe_arena_set_allocated_tensor_info(
      ::diplomacy::tensorflow::TensorInfo* tensor_info);
  ::diplomacy::tensorflow::TensorInfo* unsafe_arena_release_tensor_info();

  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.AssetFileDef)
 private:
  ...
  ::diplomacy::tensorflow::TensorInfo* tensor_info_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fmeta_5fgraph_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::std::string& MetaGraphDef_MetaInfoDef::meta_graph_version() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.meta_graph_version)
...
inline void MetaGraphDef_MetaInfoDef::set_meta_graph_version(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.meta_graph_version)
}
#if LANG_CXX11
inline void MetaGraphDef_MetaInfoDef::set_meta_graph_version(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.meta_graph_version)
}
#endif
inline void MetaGraphDef_MetaInfoDef::set_meta_graph_version(const char* value) {
  ...
  meta_graph_version_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.meta_graph_version)
}
inline void MetaGraphDef_MetaInfoDef::set_meta_graph_version(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.meta_graph_version)
}
inline ::std::string* MetaGraphDef_MetaInfoDef::mutable_meta_graph_version() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.meta_graph_version)
...
inline ::std::string* MetaGraphDef_MetaInfoDef::release_meta_graph_version() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.meta_graph_version)
...
inline void MetaGraphDef_MetaInfoDef::set_allocated_meta_graph_version(::std::string* meta_graph_version) {
  ...
  meta_graph_version_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), meta_graph_version,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.meta_graph_version)
}
inline ::std::string* MetaGraphDef_MetaInfoDef::unsafe_arena_release_meta_graph_version() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.meta_graph_version)
...
inline void MetaGraphDef_MetaInfoDef::unsafe_arena_set_allocated_meta_graph_version(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.meta_graph_version)
}
...
inline const ::diplomacy::tensorflow::OpList& MetaGraphDef_MetaInfoDef::_internal_stripped_op_list() const {
  return *stripped_op_list_;
}
inline const ::diplomacy::tensorflow::OpList& MetaGraphDef_MetaInfoDef::stripped_op_list() const {
  const ::diplomacy::tensorflow::OpList* p = stripped_op_list_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.stripped_op_list)
  return p != NULL ? *p : *reinterpret_cast<const ::diplomacy::tensorflow::OpList*>(
      &::diplomacy::tensorflow::_OpList_default_instance_);
}
inline ::diplomacy::tensorflow::OpList* MetaGraphDef_MetaInfoDef::release_stripped_op_list() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.stripped_op_list)
  
  ::diplomacy::tensorflow::OpList* temp = stripped_op_list_;
...
inline ::diplomacy::tensorflow::OpList* MetaGraphDef_MetaInfoDef::unsafe_arena_release_stripped_op_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.stripped_op_list)
  
  ::diplomacy::tensorflow::OpList* temp = stripped_op_list_;
  stripped_op_list_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::OpList* MetaGraphDef_MetaInfoDef::mutable_stripped_op_list() {
  
  if (stripped_op_list_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::OpList>(GetArenaNoVirtual());
    stripped_op_list_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.stripped_op_list)
  return stripped_op_list_;
}
inline void MetaGraphDef_MetaInfoDef::set_allocated_stripped_op_list(::diplomacy::tensorflow::OpList* stripped_op_list) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.stripped_op_list)
}
...
inline const ::google::protobuf::Any& MetaGraphDef_MetaInfoDef::any_info() const {
  ...
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.any_info)
  return p != NULL ? *p : *reinterpret_cast<const ::google::protobuf::Any*>(
      &::google::protobuf::_Any_default_instance_);
}
inline ::google::protobuf::Any* MetaGraphDef_MetaInfoDef::release_any_info() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.any_info)
...
inline ::google::protobuf::Any* MetaGraphDef_MetaInfoDef::unsafe_arena_release_any_info() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.any_info)
...
inline ::google::protobuf::Any* MetaGraphDef_MetaInfoDef::mutable_any_info() {
  ...
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.any_info)
  return any_info_;
}
inline void MetaGraphDef_MetaInfoDef::set_allocated_any_info(::google::protobuf::Any* any_info) {
  ...
  any_info_ = any_info;
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.any_info)
}
...
inline const ::std::string& MetaGraphDef_MetaInfoDef::tags(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tags)
  return tags_.Get(index);
}
inline ::std::string* MetaGraphDef_MetaInfoDef::mutable_tags(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tags)
  return tags_.Mutable(index);
}
inline void MetaGraphDef_MetaInfoDef::set_tags(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tags)
...
inline void MetaGraphDef_MetaInfoDef::set_tags(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  tags_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tags)
}
inline void MetaGraphDef_MetaInfoDef::set_tags(int index, const char* value, size_t size) {
  tags_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tags)
}
inline ::std::string* MetaGraphDef_MetaInfoDef::add_tags() {
  // @@protoc_insertion_point(field_add_mutable:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tags)
  return tags_.Add();
}
inline void MetaGraphDef_MetaInfoDef::add_tags(const ::std::string& value) {
  tags_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tags)
}
#if LANG_CXX11
...
inline void MetaGraphDef_MetaInfoDef::add_tags(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  tags_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tags)
}
inline void MetaGraphDef_MetaInfoDef::add_tags(const char* value, size_t size) {
  tags_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tags)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
MetaGraphDef_MetaInfoDef::tags() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tags)
  return tags_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
MetaGraphDef_MetaInfoDef::mutable_tags() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tags)
  return &tags_;
}
...
inline const ::std::string& MetaGraphDef_MetaInfoDef::tensorflow_version() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_version)
...
inline void MetaGraphDef_MetaInfoDef::set_tensorflow_version(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_version)
}
#if LANG_CXX11
inline void MetaGraphDef_MetaInfoDef::set_tensorflow_version(::std::string&& value) {
  ...
  tensorflow_version_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_version)
}
#endif
inline void MetaGraphDef_MetaInfoDef::set_tensorflow_version(const char* value) {
  ...
  tensorflow_version_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_version)
}
inline void MetaGraphDef_MetaInfoDef::set_tensorflow_version(const char* value,
    size_t size) {
  ...
  tensorflow_version_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_version)
}
inline ::std::string* MetaGraphDef_MetaInfoDef::mutable_tensorflow_version() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_version)
...
inline ::std::string* MetaGraphDef_MetaInfoDef::release_tensorflow_version() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_version)
...
inline void MetaGraphDef_MetaInfoDef::set_allocated_tensorflow_version(::std::string* tensorflow_version) {
  ...
  tensorflow_version_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), tensorflow_version,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_version)
}
inline ::std::string* MetaGraphDef_MetaInfoDef::unsafe_arena_release_tensorflow_version() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_version)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void MetaGraphDef_MetaInfoDef::unsafe_arena_set_allocated_tensorflow_version(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_version)
}
...
inline const ::std::string& MetaGraphDef_MetaInfoDef::tensorflow_git_version() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_git_version)
...
inline void MetaGraphDef_MetaInfoDef::set_tensorflow_git_version(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_git_version)
}
#if LANG_CXX11
inline void MetaGraphDef_MetaInfoDef::set_tensorflow_git_version(::std::string&& value) {
  ...
  tensorflow_git_version_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_git_version)
}
#endif
inline void MetaGraphDef_MetaInfoDef::set_tensorflow_git_version(const char* value) {
  ...
  tensorflow_git_version_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_git_version)
}
inline void MetaGraphDef_MetaInfoDef::set_tensorflow_git_version(const char* value,
    size_t size) {
  ...
  tensorflow_git_version_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_git_version)
}
inline ::std::string* MetaGraphDef_MetaInfoDef::mutable_tensorflow_git_version() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_git_version)
...
inline ::std::string* MetaGraphDef_MetaInfoDef::release_tensorflow_git_version() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_git_version)
...
inline void MetaGraphDef_MetaInfoDef::set_allocated_tensorflow_git_version(::std::string* tensorflow_git_version) {
  ...
  tensorflow_git_version_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), tensorflow_git_version,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_git_version)
}
inline ::std::string* MetaGraphDef_MetaInfoDef::unsafe_arena_release_tensorflow_git_version() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_git_version)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void MetaGraphDef_MetaInfoDef::unsafe_arena_set_allocated_tensorflow_git_version(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.tensorflow_git_version)
}
...
inline bool MetaGraphDef_MetaInfoDef::stripped_default_attrs() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.stripped_default_attrs)
...
inline void MetaGraphDef_MetaInfoDef::set_stripped_default_attrs(bool value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MetaGraphDef.MetaInfoDef.stripped_default_attrs)
}
...
inline const ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef& MetaGraphDef::_internal_meta_info_def() const {
  return *meta_info_def_;
}
inline const ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef& MetaGraphDef::meta_info_def() const {
  const ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef* p = meta_info_def_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MetaGraphDef.meta_info_def)
  return p != NULL ? *p : *reinterpret_cast<const ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef*>(
      &::diplomacy::tensorflow::_MetaGraphDef_MetaInfoDef_default_instance_);
}
inline ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef* MetaGraphDef::release_meta_info_def() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MetaGraphDef.meta_info_def)
  
  ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef* temp = meta_info_def_;
  if (GetArenaNoVirtual() != NULL) {
    temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
  }
  meta_info_def_ = NULL;
...
inline ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef* MetaGraphDef::unsafe_arena_release_meta_info_def() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MetaGraphDef.meta_info_def)
  
  ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef* temp = meta_info_def_;
  meta_info_def_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef* MetaGraphDef::mutable_meta_info_def() {
  
  if (meta_info_def_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef>(GetArenaNoVirtual());
    meta_info_def_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MetaGraphDef.meta_info_def)
  return meta_info_def_;
}
inline void MetaGraphDef::set_allocated_meta_info_def(::diplomacy::tensorflow::MetaGraphDef_MetaInfoDef* meta_info_def) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete meta_info_def_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MetaGraphDef.meta_info_def)
}
...
inline const ::diplomacy::tensorflow::GraphDef& MetaGraphDef::_internal_graph_def() const {
  return *graph_def_;
}
inline const ::diplomacy::tensorflow::GraphDef& MetaGraphDef::graph_def() const {
  const ::diplomacy::tensorflow::GraphDef* p = graph_def_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MetaGraphDef.graph_def)
  return p != NULL ? *p : *reinterpret_cast<const ::diplomacy::tensorflow::GraphDef*>(
      &::diplomacy::tensorflow::_GraphDef_default_instance_);
}
inline ::diplomacy::tensorflow::GraphDef* MetaGraphDef::release_graph_def() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MetaGraphDef.graph_def)
...
inline ::diplomacy::tensorflow::GraphDef* MetaGraphDef::unsafe_arena_release_graph_def() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MetaGraphDef.graph_def)
  
  ::diplomacy::tensorflow::GraphDef* temp = graph_def_;
  graph_def_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::GraphDef* MetaGraphDef::mutable_graph_def() {
  
  if (graph_def_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::GraphDef>(GetArenaNoVirtual());
    graph_def_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MetaGraphDef.graph_def)
  return graph_def_;
}
inline void MetaGraphDef::set_allocated_graph_def(::diplomacy::tensorflow::GraphDef* graph_def) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MetaGraphDef.graph_def)
}
...
inline const ::diplomacy::tensorflow::SaverDef& MetaGraphDef::_internal_saver_def() const {
  return *saver_def_;
}
inline const ::diplomacy::tensorflow::SaverDef& MetaGraphDef::saver_def() const {
  const ::diplomacy::tensorflow::SaverDef* p = saver_def_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MetaGraphDef.saver_def)
  return p != NULL ? *p : *reinterpret_cast<const ::diplomacy::tensorflow::SaverDef*>(
      &::diplomacy::tensorflow::_SaverDef_default_instance_);
}
inline ::diplomacy::tensorflow::SaverDef* MetaGraphDef::release_saver_def() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MetaGraphDef.saver_def)
  
  ::diplomacy::tensorflow::SaverDef* temp = saver_def_;
  if (GetArenaNoVirtual() != NULL) {
    temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
  }
  saver_def_ = NULL;
...
inline ::diplomacy::tensorflow::SaverDef* MetaGraphDef::unsafe_arena_release_saver_def() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MetaGraphDef.saver_def)
  
  ::diplomacy::tensorflow::SaverDef* temp = saver_def_;
  saver_def_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::SaverDef* MetaGraphDef::mutable_saver_def() {
  
  if (saver_def_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::SaverDef>(GetArenaNoVirtual());
    saver_def_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MetaGraphDef.saver_def)
  return saver_def_;
}
inline void MetaGraphDef::set_allocated_saver_def(::diplomacy::tensorflow::SaverDef* saver_def) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MetaGraphDef.saver_def)
}
...
inline const ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::CollectionDef >&
MetaGraphDef::collection_def() const {
  // @@protoc_insertion_point(field_map:diplomacy.tensorflow.MetaGraphDef.collection_def)
  return collection_def_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::CollectionDef >*
MetaGraphDef::mutable_collection_def() {
  // @@protoc_insertion_point(field_mutable_map:diplomacy.tensorflow.MetaGraphDef.collection_def)
...
MetaGraphDef::signature_def() const {
  // @@protoc_insertion_point(field_map:diplomacy.tensorflow.MetaGraphDef.signature_def)
...
MetaGraphDef::mutable_signature_def() {
  // @@protoc_insertion_point(field_mutable_map:diplomacy.tensorflow.MetaGraphDef.signature_def)
...
inline ::diplomacy::tensorflow::AssetFileDef* MetaGraphDef::mutable_asset_file_def(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MetaGraphDef.asset_file_def)
  return asset_file_def_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::AssetFileDef >*
MetaGraphDef::mutable_asset_file_def() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.MetaGraphDef.asset_file_def)
  return &asset_file_def_;
}
inline const ::diplomacy::tensorflow::AssetFileDef& MetaGraphDef::asset_file_def(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MetaGraphDef.asset_file_def)
  return asset_file_def_.Get(index);
}
inline ::diplomacy::tensorflow::AssetFileDef* MetaGraphDef::add_asset_file_def() {
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.MetaGraphDef.asset_file_def)
  return asset_file_def_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::AssetFileDef >&
MetaGraphDef::asset_file_def() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.MetaGraphDef.asset_file_def)
  return asset_file_def_;
}
...
inline const ::std::string& CollectionDef_NodeList::value(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CollectionDef.NodeList.value)
  return value_.Get(index);
}
inline ::std::string* CollectionDef_NodeList::mutable_value(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.CollectionDef.NodeList.value)
  return value_.Mutable(index);
}
inline void CollectionDef_NodeList::set_value(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.CollectionDef.NodeList.value)
...
inline void CollectionDef_NodeList::set_value(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  value_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.CollectionDef.NodeList.value)
}
inline void CollectionDef_NodeList::set_value(int index, const char* value, size_t size) {
  value_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.CollectionDef.NodeList.value)
}
inline ::std::string* CollectionDef_NodeList::add_value() {
  // @@protoc_insertion_point(field_add_mutable:diplomacy.tensorflow.CollectionDef.NodeList.value)
  return value_.Add();
}
inline void CollectionDef_NodeList::add_value(const ::std::string& value) {
  value_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.CollectionDef.NodeList.value)
}
#if LANG_CXX11
...
inline void CollectionDef_NodeList::add_value(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  value_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:diplomacy.tensorflow.CollectionDef.NodeList.value)
}
inline void CollectionDef_NodeList::add_value(const char* value, size_t size) {
  value_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:diplomacy.tensorflow.CollectionDef.NodeList.value)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
CollectionDef_NodeList::value() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.CollectionDef.NodeList.value)
  return value_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
CollectionDef_NodeList::mutable_value() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.CollectionDef.NodeList.value)
  return &value_;
}
...
inline const ::std::string& CollectionDef_BytesList::value(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CollectionDef.BytesList.value)
  return value_.Get(index);
}
inline ::std::string* CollectionDef_BytesList::mutable_value(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.CollectionDef.BytesList.value)
  return value_.Mutable(index);
}
inline void CollectionDef_BytesList::set_value(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.CollectionDef.BytesList.value)
  value_.Mutable(index)->assign(value);
}
#if LANG_CXX11
...
inline void CollectionDef_BytesList::set_value(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  value_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.CollectionDef.BytesList.value)
}
inline void CollectionDef_BytesList::set_value(int index, const void* value, size_t size) {
  value_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.CollectionDef.BytesList.value)
}
inline ::std::string* CollectionDef_BytesList::add_value() {
  // @@protoc_insertion_point(field_add_mutable:diplomacy.tensorflow.CollectionDef.BytesList.value)
  return value_.Add();
}
inline void CollectionDef_BytesList::add_value(const ::std::string& value) {
  value_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.CollectionDef.BytesList.value)
}
#if LANG_CXX11
...
inline void CollectionDef_BytesList::add_value(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  value_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:diplomacy.tensorflow.CollectionDef.BytesList.value)
}
inline void CollectionDef_BytesList::add_value(const void* value, size_t size) {
  value_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:diplomacy.tensorflow.CollectionDef.BytesList.value)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
CollectionDef_BytesList::value() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.CollectionDef.BytesList.value)
  return value_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
CollectionDef_BytesList::mutable_value() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.CollectionDef.BytesList.value)
  return &value_;
}
...
inline ::google::protobuf::int64 CollectionDef_Int64List::value(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CollectionDef.Int64List.value)
  return value_.Get(index);
}
inline void CollectionDef_Int64List::set_value(int index, ::google::protobuf::int64 value) {
  value_.Set(index, value);
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.CollectionDef.Int64List.value)
}
inline void CollectionDef_Int64List::add_value(::google::protobuf::int64 value) {
  value_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.CollectionDef.Int64List.value)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
CollectionDef_Int64List::value() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.CollectionDef.Int64List.value)
  return value_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
CollectionDef_Int64List::mutable_value() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.CollectionDef.Int64List.value)
  return &value_;
}
...
inline float CollectionDef_FloatList::value(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CollectionDef.FloatList.value)
  return value_.Get(index);
}
inline void CollectionDef_FloatList::set_value(int index, float value) {
  value_.Set(index, value);
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.CollectionDef.FloatList.value)
}
inline void CollectionDef_FloatList::add_value(float value) {
  value_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.CollectionDef.FloatList.value)
}
inline const ::google::protobuf::RepeatedField< float >&
CollectionDef_FloatList::value() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.CollectionDef.FloatList.value)
  return value_;
}
inline ::google::protobuf::RepeatedField< float >*
CollectionDef_FloatList::mutable_value() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.CollectionDef.FloatList.value)
  return &value_;
}
...
inline ::google::protobuf::Any* CollectionDef_AnyList::mutable_value(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.CollectionDef.AnyList.value)
  return value_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::google::protobuf::Any >*
CollectionDef_AnyList::mutable_value() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.CollectionDef.AnyList.value)
  return &value_;
}
inline const ::google::protobuf::Any& CollectionDef_AnyList::value(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CollectionDef.AnyList.value)
  return value_.Get(index);
}
inline ::google::protobuf::Any* CollectionDef_AnyList::add_value() {
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.CollectionDef.AnyList.value)
  return value_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::google::protobuf::Any >&
CollectionDef_AnyList::value() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.CollectionDef.AnyList.value)
  return value_;
}
...
inline const ::diplomacy::tensorflow::CollectionDef_NodeList& CollectionDef::_internal_node_list() const {
  return *kind_.node_list_;
}
inline ::diplomacy::tensorflow::CollectionDef_NodeList* CollectionDef::release_node_list() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.CollectionDef.node_list)
  if (has_node_list()) {
    clear_has_kind();
      ::diplomacy::tensorflow::CollectionDef_NodeList* temp = kind_.node_list_;
    if (GetArenaNoVirtual() != NULL) {
      temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::diplomacy::tensorflow::CollectionDef_NodeList& CollectionDef::node_list() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CollectionDef.node_list)
  return has_node_list()
      ? *kind_.node_list_
      : *reinterpret_cast< ::diplomacy::tensorflow::CollectionDef_NodeList*>(&::diplomacy::tensorflow::_CollectionDef_NodeList_default_instance_);
}
inline ::diplomacy::tensorflow::CollectionDef_NodeList* CollectionDef::unsafe_arena_release_node_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.CollectionDef.node_list)
  if (has_node_list()) {
    clear_has_kind();
    ::diplomacy::tensorflow::CollectionDef_NodeList* temp = kind_.node_list_;
    kind_.node_list_ = NULL;
...
inline void CollectionDef::unsafe_arena_set_allocated_node_list(::diplomacy::tensorflow::CollectionDef_NodeList* node_list) {
  clear_kind();
  if (node_list) {
    set_has_node_list();
    kind_.node_list_ = node_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.CollectionDef.node_list)
}
inline ::diplomacy::tensorflow::CollectionDef_NodeList* CollectionDef::mutable_node_list() {
  if (!has_node_list()) {
    clear_kind();
    set_has_node_list();
    kind_.node_list_ = CreateMaybeMessage< ::diplomacy::tensorflow::CollectionDef_NodeList >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.CollectionDef.node_list)
  return kind_.node_list_;
}
...
inline const ::diplomacy::tensorflow::CollectionDef_BytesList& CollectionDef::_internal_bytes_list() const {
  return *kind_.bytes_list_;
}
inline ::diplomacy::tensorflow::CollectionDef_BytesList* CollectionDef::release_bytes_list() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.CollectionDef.bytes_list)
  if (has_bytes_list()) {
    clear_has_kind();
      ::diplomacy::tensorflow::CollectionDef_BytesList* temp = kind_.bytes_list_;
    if (GetArenaNoVirtual() != NULL) {
      temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::diplomacy::tensorflow::CollectionDef_BytesList& CollectionDef::bytes_list() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CollectionDef.bytes_list)
  return has_bytes_list()
      ? *kind_.bytes_list_
      : *reinterpret_cast< ::diplomacy::tensorflow::CollectionDef_BytesList*>(&::diplomacy::tensorflow::_CollectionDef_BytesList_default_instance_);
}
inline ::diplomacy::tensorflow::CollectionDef_BytesList* CollectionDef::unsafe_arena_release_bytes_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.CollectionDef.bytes_list)
  if (has_bytes_list()) {
    clear_has_kind();
    ::diplomacy::tensorflow::CollectionDef_BytesList* temp = kind_.bytes_list_;
    kind_.bytes_list_ = NULL;
...
inline void CollectionDef::unsafe_arena_set_allocated_bytes_list(::diplomacy::tensorflow::CollectionDef_BytesList* bytes_list) {
  clear_kind();
  if (bytes_list) {
    set_has_bytes_list();
    kind_.bytes_list_ = bytes_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.CollectionDef.bytes_list)
}
inline ::diplomacy::tensorflow::CollectionDef_BytesList* CollectionDef::mutable_bytes_list() {
  if (!has_bytes_list()) {
    clear_kind();
    set_has_bytes_list();
    kind_.bytes_list_ = CreateMaybeMessage< ::diplomacy::tensorflow::CollectionDef_BytesList >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.CollectionDef.bytes_list)
  return kind_.bytes_list_;
}
...
inline const ::diplomacy::tensorflow::CollectionDef_Int64List& CollectionDef::_internal_int64_list() const {
  return *kind_.int64_list_;
}
inline ::diplomacy::tensorflow::CollectionDef_Int64List* CollectionDef::release_int64_list() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.CollectionDef.int64_list)
  if (has_int64_list()) {
    clear_has_kind();
      ::diplomacy::tensorflow::CollectionDef_Int64List* temp = kind_.int64_list_;
    if (GetArenaNoVirtual() != NULL) {
      temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::diplomacy::tensorflow::CollectionDef_Int64List& CollectionDef::int64_list() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CollectionDef.int64_list)
  return has_int64_list()
      ? *kind_.int64_list_
      : *reinterpret_cast< ::diplomacy::tensorflow::CollectionDef_Int64List*>(&::diplomacy::tensorflow::_CollectionDef_Int64List_default_instance_);
}
inline ::diplomacy::tensorflow::CollectionDef_Int64List* CollectionDef::unsafe_arena_release_int64_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.CollectionDef.int64_list)
  if (has_int64_list()) {
    clear_has_kind();
    ::diplomacy::tensorflow::CollectionDef_Int64List* temp = kind_.int64_list_;
    kind_.int64_list_ = NULL;
...
inline void CollectionDef::unsafe_arena_set_allocated_int64_list(::diplomacy::tensorflow::CollectionDef_Int64List* int64_list) {
  clear_kind();
  if (int64_list) {
    set_has_int64_list();
    kind_.int64_list_ = int64_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.CollectionDef.int64_list)
}
inline ::diplomacy::tensorflow::CollectionDef_Int64List* CollectionDef::mutable_int64_list() {
  if (!has_int64_list()) {
    clear_kind();
    set_has_int64_list();
    kind_.int64_list_ = CreateMaybeMessage< ::diplomacy::tensorflow::CollectionDef_Int64List >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.CollectionDef.int64_list)
  return kind_.int64_list_;
}
...
inline const ::diplomacy::tensorflow::CollectionDef_FloatList& CollectionDef::_internal_float_list() const {
  return *kind_.float_list_;
}
inline ::diplomacy::tensorflow::CollectionDef_FloatList* CollectionDef::release_float_list() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.CollectionDef.float_list)
  if (has_float_list()) {
    clear_has_kind();
      ::diplomacy::tensorflow::CollectionDef_FloatList* temp = kind_.float_list_;
    if (GetArenaNoVirtual() != NULL) {
      temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::diplomacy::tensorflow::CollectionDef_FloatList& CollectionDef::float_list() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CollectionDef.float_list)
  return has_float_list()
      ? *kind_.float_list_
      : *reinterpret_cast< ::diplomacy::tensorflow::CollectionDef_FloatList*>(&::diplomacy::tensorflow::_CollectionDef_FloatList_default_instance_);
}
inline ::diplomacy::tensorflow::CollectionDef_FloatList* CollectionDef::unsafe_arena_release_float_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.CollectionDef.float_list)
  if (has_float_list()) {
    clear_has_kind();
    ::diplomacy::tensorflow::CollectionDef_FloatList* temp = kind_.float_list_;
    kind_.float_list_ = NULL;
...
inline void CollectionDef::unsafe_arena_set_allocated_float_list(::diplomacy::tensorflow::CollectionDef_FloatList* float_list) {
  clear_kind();
  if (float_list) {
    set_has_float_list();
    kind_.float_list_ = float_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.CollectionDef.float_list)
}
inline ::diplomacy::tensorflow::CollectionDef_FloatList* CollectionDef::mutable_float_list() {
  if (!has_float_list()) {
    clear_kind();
    set_has_float_list();
    kind_.float_list_ = CreateMaybeMessage< ::diplomacy::tensorflow::CollectionDef_FloatList >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.CollectionDef.float_list)
  return kind_.float_list_;
}
...
inline const ::diplomacy::tensorflow::CollectionDef_AnyList& CollectionDef::_internal_any_list() const {
  return *kind_.any_list_;
}
inline ::diplomacy::tensorflow::CollectionDef_AnyList* CollectionDef::release_any_list() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.CollectionDef.any_list)
  if (has_any_list()) {
    clear_has_kind();
      ::diplomacy::tensorflow::CollectionDef_AnyList* temp = kind_.any_list_;
    if (GetArenaNoVirtual() != NULL) {
      temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::diplomacy::tensorflow::CollectionDef_AnyList& CollectionDef::any_list() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.CollectionDef.any_list)
  return has_any_list()
      ? *kind_.any_list_
      : *reinterpret_cast< ::diplomacy::tensorflow::CollectionDef_AnyList*>(&::diplomacy::tensorflow::_CollectionDef_AnyList_default_instance_);
}
inline ::diplomacy::tensorflow::CollectionDef_AnyList* CollectionDef::unsafe_arena_release_any_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.CollectionDef.any_list)
  if (has_any_list()) {
    clear_has_kind();
    ::diplomacy::tensorflow::CollectionDef_AnyList* temp = kind_.any_list_;
    kind_.any_list_ = NULL;
...
inline void CollectionDef::unsafe_arena_set_allocated_any_list(::diplomacy::tensorflow::CollectionDef_AnyList* any_list) {
  clear_kind();
  if (any_list) {
    set_has_any_list();
    kind_.any_list_ = any_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.CollectionDef.any_list)
}
inline ::diplomacy::tensorflow::CollectionDef_AnyList* CollectionDef::mutable_any_list() {
  if (!has_any_list()) {
    clear_kind();
    set_has_any_list();
    kind_.any_list_ = CreateMaybeMessage< ::diplomacy::tensorflow::CollectionDef_AnyList >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.CollectionDef.any_list)
  return kind_.any_list_;
}
...
inline const ::std::string& TensorInfo_CooSparse::values_tensor_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorInfo.CooSparse.values_tensor_name)
...
inline void TensorInfo_CooSparse::set_values_tensor_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorInfo.CooSparse.values_tensor_name)
}
#if LANG_CXX11
inline void TensorInfo_CooSparse::set_values_tensor_name(::std::string&& value) {
  ...
  values_tensor_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.TensorInfo.CooSparse.values_tensor_name)
}
#endif
inline void TensorInfo_CooSparse::set_values_tensor_name(const char* value) {
  ...
  values_tensor_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.TensorInfo.CooSparse.values_tensor_name)
}
inline void TensorInfo_CooSparse::set_values_tensor_name(const char* value,
    size_t size) {
  ...
  values_tensor_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.TensorInfo.CooSparse.values_tensor_name)
}
inline ::std::string* TensorInfo_CooSparse::mutable_values_tensor_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.TensorInfo.CooSparse.values_tensor_name)
...
inline ::std::string* TensorInfo_CooSparse::release_values_tensor_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.TensorInfo.CooSparse.values_tensor_name)
...
inline void TensorInfo_CooSparse::set_allocated_values_tensor_name(::std::string* values_tensor_name) {
  ...
  values_tensor_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), values_tensor_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.TensorInfo.CooSparse.values_tensor_name)
}
inline ::std::string* TensorInfo_CooSparse::unsafe_arena_release_values_tensor_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.TensorInfo.CooSparse.values_tensor_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void TensorInfo_CooSparse::unsafe_arena_set_allocated_values_tensor_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.TensorInfo.CooSparse.values_tensor_name)
}
...
inline const ::std::string& TensorInfo_CooSparse::indices_tensor_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorInfo.CooSparse.indices_tensor_name)
...
inline void TensorInfo_CooSparse::set_indices_tensor_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorInfo.CooSparse.indices_tensor_name)
}
#if LANG_CXX11
inline void TensorInfo_CooSparse::set_indices_tensor_name(::std::string&& value) {
  ...
  indices_tensor_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.TensorInfo.CooSparse.indices_tensor_name)
}
#endif
inline void TensorInfo_CooSparse::set_indices_tensor_name(const char* value) {
  ...
  indices_tensor_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.TensorInfo.CooSparse.indices_tensor_name)
}
inline void TensorInfo_CooSparse::set_indices_tensor_name(const char* value,
    size_t size) {
  ...
  indices_tensor_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.TensorInfo.CooSparse.indices_tensor_name)
}
inline ::std::string* TensorInfo_CooSparse::mutable_indices_tensor_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.TensorInfo.CooSparse.indices_tensor_name)
...
inline ::std::string* TensorInfo_CooSparse::release_indices_tensor_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.TensorInfo.CooSparse.indices_tensor_name)
...
inline void TensorInfo_CooSparse::set_allocated_indices_tensor_name(::std::string* indices_tensor_name) {
  ...
  indices_tensor_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), indices_tensor_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.TensorInfo.CooSparse.indices_tensor_name)
}
inline ::std::string* TensorInfo_CooSparse::unsafe_arena_release_indices_tensor_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.TensorInfo.CooSparse.indices_tensor_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void TensorInfo_CooSparse::unsafe_arena_set_allocated_indices_tensor_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.TensorInfo.CooSparse.indices_tensor_name)
}
...
inline const ::std::string& TensorInfo_CooSparse::dense_shape_tensor_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorInfo.CooSparse.dense_shape_tensor_name)
...
inline void TensorInfo_CooSparse::set_dense_shape_tensor_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorInfo.CooSparse.dense_shape_tensor_name)
}
#if LANG_CXX11
inline void TensorInfo_CooSparse::set_dense_shape_tensor_name(::std::string&& value) {
  ...
  dense_shape_tensor_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.TensorInfo.CooSparse.dense_shape_tensor_name)
}
#endif
inline void TensorInfo_CooSparse::set_dense_shape_tensor_name(const char* value) {
  ...
  dense_shape_tensor_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.TensorInfo.CooSparse.dense_shape_tensor_name)
}
inline void TensorInfo_CooSparse::set_dense_shape_tensor_name(const char* value,
    size_t size) {
  ...
  dense_shape_tensor_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.TensorInfo.CooSparse.dense_shape_tensor_name)
}
inline ::std::string* TensorInfo_CooSparse::mutable_dense_shape_tensor_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.TensorInfo.CooSparse.dense_shape_tensor_name)
...
inline ::std::string* TensorInfo_CooSparse::release_dense_shape_tensor_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.TensorInfo.CooSparse.dense_shape_tensor_name)
...
inline void TensorInfo_CooSparse::set_allocated_dense_shape_tensor_name(::std::string* dense_shape_tensor_name) {
  ...
  dense_shape_tensor_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), dense_shape_tensor_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.TensorInfo.CooSparse.dense_shape_tensor_name)
}
inline ::std::string* TensorInfo_CooSparse::unsafe_arena_release_dense_shape_tensor_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.TensorInfo.CooSparse.dense_shape_tensor_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void TensorInfo_CooSparse::unsafe_arena_set_allocated_dense_shape_tensor_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.TensorInfo.CooSparse.dense_shape_tensor_name)
}
...
inline const ::std::string& TensorInfo::name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorInfo.name)
  if (has_name()) {
...
inline void TensorInfo::set_name(const ::std::string& value) {
  ...
  encoding_.name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorInfo.name)
}
#if LANG_CXX11
inline void TensorInfo::set_name(::std::string&& value) {
  ...
  encoding_.name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.TensorInfo.name)
}
#endif
inline void TensorInfo::set_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.TensorInfo.name)
}
inline void TensorInfo::set_name(const char* value,
                             size_t size) {
  if (!has_name()) {
  ...
  encoding_.name_.Set(
      ...
      reinterpret_cast<const char*>(value), size),
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.TensorInfo.name)
}
inline ::std::string* TensorInfo::mutable_name() {
  ...
  return encoding_.name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.TensorInfo.name)
}
inline ::std::string* TensorInfo::release_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.TensorInfo.name)
  if (has_name()) {
    clear_has_encoding();
...
inline void TensorInfo::set_allocated_name(::std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.TensorInfo.name)
}
inline ::std::string* TensorInfo::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.TensorInfo.name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
  if (has_name()) {
    clear_has_encoding();
...
inline void TensorInfo::unsafe_arena_set_allocated_name(::std::string* name) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.TensorInfo.name)
}
...
inline const ::diplomacy::tensorflow::TensorInfo_CooSparse& TensorInfo::_internal_coo_sparse() const {
  return *encoding_.coo_sparse_;
}
inline ::diplomacy::tensorflow::TensorInfo_CooSparse* TensorInfo::release_coo_sparse() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.TensorInfo.coo_sparse)
  if (has_coo_sparse()) {
    clear_has_encoding();
      ::diplomacy::tensorflow::TensorInfo_CooSparse* temp = encoding_.coo_sparse_;
    if (GetArenaNoVirtual() != NULL) {
      temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::diplomacy::tensorflow::TensorInfo_CooSparse& TensorInfo::coo_sparse() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorInfo.coo_sparse)
  return has_coo_sparse()
      ? *encoding_.coo_sparse_
      : *reinterpret_cast< ::diplomacy::tensorflow::TensorInfo_CooSparse*>(&::diplomacy::tensorflow::_TensorInfo_CooSparse_default_instance_);
}
inline ::diplomacy::tensorflow::TensorInfo_CooSparse* TensorInfo::unsafe_arena_release_coo_sparse() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.TensorInfo.coo_sparse)
  if (has_coo_sparse()) {
    clear_has_encoding();
    ::diplomacy::tensorflow::TensorInfo_CooSparse* temp = encoding_.coo_sparse_;
    encoding_.coo_sparse_ = NULL;
...
inline void TensorInfo::unsafe_arena_set_allocated_coo_sparse(::diplomacy::tensorflow::TensorInfo_CooSparse* coo_sparse) {
  clear_encoding();
  if (coo_sparse) {
    set_has_coo_sparse();
    encoding_.coo_sparse_ = coo_sparse;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.TensorInfo.coo_sparse)
}
inline ::diplomacy::tensorflow::TensorInfo_CooSparse* TensorInfo::mutable_coo_sparse() {
  if (!has_coo_sparse()) {
    clear_encoding();
    set_has_coo_sparse();
    encoding_.coo_sparse_ = CreateMaybeMessage< ::diplomacy::tensorflow::TensorInfo_CooSparse >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.TensorInfo.coo_sparse)
  return encoding_.coo_sparse_;
}
...
inline ::diplomacy::tensorflow::DataType TensorInfo::dtype() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorInfo.dtype)
  return static_cast< ::diplomacy::tensorflow::DataType >(dtype_);
}
inline void TensorInfo::set_dtype(::diplomacy::tensorflow::DataType value) {
  
  dtype_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorInfo.dtype)
}
...
inline const ::diplomacy::tensorflow::TensorShapeProto& TensorInfo::_internal_tensor_shape() const {
  return *tensor_shape_;
}
inline const ::diplomacy::tensorflow::TensorShapeProto& TensorInfo::tensor_shape() const {
  const ::diplomacy::tensorflow::TensorShapeProto* p = tensor_shape_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorInfo.tensor_shape)
...
inline ::diplomacy::tensorflow::TensorShapeProto* TensorInfo::release_tensor_shape() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.TensorInfo.tensor_shape)
...
inline ::diplomacy::tensorflow::TensorShapeProto* TensorInfo::unsafe_arena_release_tensor_shape() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.TensorInfo.tensor_shape)
  
  ::diplomacy::tensorflow::TensorShapeProto* temp = tensor_shape_;
  tensor_shape_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::TensorShapeProto* TensorInfo::mutable_tensor_shape() {
  
  if (tensor_shape_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::TensorShapeProto>(GetArenaNoVirtual());
    tensor_shape_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.TensorInfo.tensor_shape)
  return tensor_shape_;
}
inline void TensorInfo::set_allocated_tensor_shape(::diplomacy::tensorflow::TensorShapeProto* tensor_shape) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.TensorInfo.tensor_shape)
}
...
inline const ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::TensorInfo >&
SignatureDef::inputs() const {
  // @@protoc_insertion_point(field_map:diplomacy.tensorflow.SignatureDef.inputs)
  return inputs_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::TensorInfo >*
SignatureDef::mutable_inputs() {
  // @@protoc_insertion_point(field_mutable_map:diplomacy.tensorflow.SignatureDef.inputs)
...
SignatureDef::outputs() const {
  // @@protoc_insertion_point(field_map:diplomacy.tensorflow.SignatureDef.outputs)
  return outputs_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::TensorInfo >*
SignatureDef::mutable_outputs() {
  // @@protoc_insertion_point(field_mutable_map:diplomacy.tensorflow.SignatureDef.outputs)
...
inline const ::std::string& SignatureDef::method_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.SignatureDef.method_name)
...
inline void SignatureDef::set_method_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.SignatureDef.method_name)
}
#if LANG_CXX11
inline void SignatureDef::set_method_name(::std::string&& value) {
  ...
  method_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.SignatureDef.method_name)
}
#endif
inline void SignatureDef::set_method_name(const char* value) {
  ...
  method_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.SignatureDef.method_name)
}
inline void SignatureDef::set_method_name(const char* value,
    size_t size) {
  ...
  method_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.SignatureDef.method_name)
}
inline ::std::string* SignatureDef::mutable_method_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.SignatureDef.method_name)
...
inline ::std::string* SignatureDef::release_method_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.SignatureDef.method_name)
...
inline void SignatureDef::set_allocated_method_name(::std::string* method_name) {
  ...
  method_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), method_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.SignatureDef.method_name)
}
inline ::std::string* SignatureDef::unsafe_arena_release_method_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.SignatureDef.method_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void SignatureDef::unsafe_arena_set_allocated_method_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.SignatureDef.method_name)
}
...
inline const ::diplomacy::tensorflow::TensorInfo& AssetFileDef::_internal_tensor_info() const {
  return *tensor_info_;
}
inline const ::diplomacy::tensorflow::TensorInfo& AssetFileDef::tensor_info() const {
  const ::diplomacy::tensorflow::TensorInfo* p = tensor_info_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.AssetFileDef.tensor_info)
  return p != NULL ? *p : *reinterpret_cast<const ::diplomacy::tensorflow::TensorInfo*>(
      &::diplomacy::tensorflow::_TensorInfo_default_instance_);
}
inline ::diplomacy::tensorflow::TensorInfo* AssetFileDef::release_tensor_info() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.AssetFileDef.tensor_info)
  
  ::diplomacy::tensorflow::TensorInfo* temp = tensor_info_;
  if (GetArenaNoVirtual() != NULL) {
    temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
  }
  tensor_info_ = NULL;
...
inline ::diplomacy::tensorflow::TensorInfo* AssetFileDef::unsafe_arena_release_tensor_info() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.AssetFileDef.tensor_info)
  
  ::diplomacy::tensorflow::TensorInfo* temp = tensor_info_;
  tensor_info_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::TensorInfo* AssetFileDef::mutable_tensor_info() {
  
  if (tensor_info_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::TensorInfo>(GetArenaNoVirtual());
    tensor_info_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.AssetFileDef.tensor_info)
  return tensor_info_;
}
inline void AssetFileDef::set_allocated_tensor_info(::diplomacy::tensorflow::TensorInfo* tensor_info) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete tensor_info_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.AssetFileDef.tensor_info)
}
...
inline const ::std::string& AssetFileDef::filename() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.AssetFileDef.filename)
...
inline void AssetFileDef::set_filename(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.AssetFileDef.filename)
}
#if LANG_CXX11
inline void AssetFileDef::set_filename(::std::string&& value) {
  ...
  filename_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.AssetFileDef.filename)
}
#endif
inline void AssetFileDef::set_filename(const char* value) {
  ...
  filename_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.AssetFileDef.filename)
}
inline void AssetFileDef::set_filename(const char* value,
    size_t size) {
  ...
  filename_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.AssetFileDef.filename)
}
inline ::std::string* AssetFileDef::mutable_filename() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.AssetFileDef.filename)
...
inline ::std::string* AssetFileDef::release_filename() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.AssetFileDef.filename)
...
inline void AssetFileDef::set_allocated_filename(::std::string* filename) {
  ...
  filename_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), filename,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.AssetFileDef.filename)
}
inline ::std::string* AssetFileDef::unsafe_arena_release_filename() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.AssetFileDef.filename)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void AssetFileDef::unsafe_arena_set_allocated_filename(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.AssetFileDef.filename)
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fmeta_5fgraph_2eproto
