...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/core/framework/reader_base.proto',
...
_READERBASESTATE = _descriptor.Descriptor(
  ...
  full_name='diplomacy.tensorflow.ReaderBaseState',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='work_started', full_name='diplomacy.tensorflow.ReaderBaseState.work_started', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='work_finished', full_name='diplomacy.tensorflow.ReaderBaseState.work_finished', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_records_produced', full_name='diplomacy.tensorflow.ReaderBaseState.num_records_produced', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='current_work', full_name='diplomacy.tensorflow.ReaderBaseState.current_work', index=3,
...
ReaderBaseState = _reflection.GeneratedProtocolMessageType('ReaderBaseState', (_message.Message,), dict(
  ...
  __module__ = 'diplomacy_tensorflow.core.framework.reader_base_pb2'
