...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/core/lib/core/error_codes.proto',
  package='diplomacy.tensorflow.error',
  syntax='proto3',
