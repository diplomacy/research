...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcontrib_2fgdr_2fgdr_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcontrib_2fgdr_2fgdr_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcontrib_2fgdr_2fgdr_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::RemoteMemoryRegion* Arena::CreateMaybeMessage<::diplomacy::tensorflow::RemoteMemoryRegion>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class RemoteMemoryRegion : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.RemoteMemoryRegion) */ {
 public:
  RemoteMemoryRegion();
 ...
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcontrib_2fgdr_2fgdr_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::std::string& RemoteMemoryRegion::host() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RemoteMemoryRegion.host)
  return host_.Get();
}
inline void RemoteMemoryRegion::set_host(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RemoteMemoryRegion.host)
}
#if LANG_CXX11
inline void RemoteMemoryRegion::set_host(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.RemoteMemoryRegion.host)
}
#endif
inline void RemoteMemoryRegion::set_host(const char* value) {
  ...
  host_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.RemoteMemoryRegion.host)
}
inline void RemoteMemoryRegion::set_host(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.RemoteMemoryRegion.host)
}
inline ::std::string* RemoteMemoryRegion::mutable_host() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.RemoteMemoryRegion.host)
...
inline ::std::string* RemoteMemoryRegion::release_host() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.RemoteMemoryRegion.host)
...
inline void RemoteMemoryRegion::set_allocated_host(::std::string* host) {
  ...
  host_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), host,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.RemoteMemoryRegion.host)
}
inline ::std::string* RemoteMemoryRegion::unsafe_arena_release_host() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.RemoteMemoryRegion.host)
...
inline void RemoteMemoryRegion::unsafe_arena_set_allocated_host(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.RemoteMemoryRegion.host)
}
...
inline const ::std::string& RemoteMemoryRegion::port() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RemoteMemoryRegion.port)
  return port_.Get();
}
...
inline void RemoteMemoryRegion::set_port(::std::string&& value) {
  ...
  port_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.RemoteMemoryRegion.port)
}
#endif
...
inline void RemoteMemoryRegion::set_port(const char* value,
  ...
  port_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.RemoteMemoryRegion.port)
}
inline ::std::string* RemoteMemoryRegion::mutable_port() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.RemoteMemoryRegion.port)
...
inline ::std::string* RemoteMemoryRegion::release_port() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.RemoteMemoryRegion.port)
...
inline void RemoteMemoryRegion::set_allocated_port(::std::string* port) {
  ...
  port_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), port,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.RemoteMemoryRegion.port)
}
inline ::std::string* RemoteMemoryRegion::unsafe_arena_release_port() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.RemoteMemoryRegion.port)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void RemoteMemoryRegion::unsafe_arena_set_allocated_port(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.RemoteMemoryRegion.port)
}
...
inline ::google::protobuf::uint64 RemoteMemoryRegion::addr() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RemoteMemoryRegion.addr)
  return addr_;
}
inline void RemoteMemoryRegion::set_addr(::google::protobuf::uint64 value) {
  
  addr_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RemoteMemoryRegion.addr)
}
...
inline ::google::protobuf::uint32 RemoteMemoryRegion::rkey() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RemoteMemoryRegion.rkey)
  return rkey_;
}
inline void RemoteMemoryRegion::set_rkey(::google::protobuf::uint32 value) {
  
  rkey_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RemoteMemoryRegion.rkey)
}
...
inline ::google::protobuf::uint32 RemoteMemoryRegion::tensor_key() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.RemoteMemoryRegion.tensor_key)
  return tensor_key_;
}
inline void RemoteMemoryRegion::set_tensor_key(::google::protobuf::uint32 value) {
  
  tensor_key_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.RemoteMemoryRegion.tensor_key)
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcontrib_2fgdr_2fgdr_2eproto
