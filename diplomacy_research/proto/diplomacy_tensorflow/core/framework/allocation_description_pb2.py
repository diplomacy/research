...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/core/framework/allocation_description.proto',
...
_ALLOCATIONDESCRIPTION = _descriptor.Descriptor(
  ...
  full_name='diplomacy.tensorflow.AllocationDescription',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='requested_bytes', full_name='diplomacy.tensorflow.AllocationDescription.requested_bytes', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='allocated_bytes', full_name='diplomacy.tensorflow.AllocationDescription.allocated_bytes', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='allocator_name', full_name='diplomacy.tensorflow.AllocationDescription.allocator_name', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='allocation_id', full_name='diplomacy.tensorflow.AllocationDescription.allocation_id', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='has_single_reference', full_name='diplomacy.tensorflow.AllocationDescription.has_single_reference', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ptr', full_name='diplomacy.tensorflow.AllocationDescription.ptr', index=5,
...
AllocationDescription = _reflection.GeneratedProtocolMessageType('AllocationDescription', (_message.Message,), dict(
  ...
  __module__ = 'diplomacy_tensorflow.core.framework.allocation_description_pb2'
