...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcontrib_2fcloud_2fkernels_2fbigquery_5ftable_5fpartition_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcontrib_2fcloud_2fkernels_2fbigquery_5ftable_5fpartition_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::BigQueryTablePartition* Arena::CreateMaybeMessage<::diplomacy::tensorflow::BigQueryTablePartition>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class BigQueryTablePartition : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.BigQueryTablePartition) */ {
 public:
 ...
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcontrib_2fcloud_2fkernels_2fbigquery_5ftable_5fpartition_2eproto::TableStruct;
};
// ===================================================================
...
inline ::google::protobuf::int64 BigQueryTablePartition::start_index() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.BigQueryTablePartition.start_index)
  return start_index_;
}
inline void BigQueryTablePartition::set_start_index(::google::protobuf::int64 value) {
  
  start_index_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.BigQueryTablePartition.start_index)
}
...
inline ::google::protobuf::int64 BigQueryTablePartition::end_index() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.BigQueryTablePartition.end_index)
  return end_index_;
}
inline void BigQueryTablePartition::set_end_index(::google::protobuf::int64 value) {
  
  end_index_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.BigQueryTablePartition.end_index)
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcontrib_2fcloud_2fkernels_2fbigquery_5ftable_5fpartition_2eproto
