...
_TOCOFLAGS.fields_by_name['inference_input_type'].enum_type = diplomacy__tensorflow_dot_lite_dot_toco_dot_types__pb2._IODATATYPE
_TOCOFLAGS.fields_by_name['inference_type'].enum_type = diplomacy__tensorflow_dot_lite_dot_toco_dot_types__pb2._IODATATYPE
...
TocoFlags = _reflection.GeneratedProtocolMessageType('TocoFlags', (_message.Message,), dict(
  ...
  __module__ = 'diplomacy_tensorflow.lite.toco.toco_flags_pb2'
