...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2freader_5fbase_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2freader_5fbase_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::ReaderBaseState* Arena::CreateMaybeMessage<::diplomacy::tensorflow::ReaderBaseState>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class ReaderBaseState : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.ReaderBaseState) */ {
 public:
  ReaderBaseState();
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.ReaderBaseState)
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2freader_5fbase_2eproto::TableStruct;
};
// ===================================================================
...
inline ::google::protobuf::int64 ReaderBaseState::work_started() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.ReaderBaseState.work_started)
  return work_started_;
}
inline void ReaderBaseState::set_work_started(::google::protobuf::int64 value) {
  
  work_started_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.ReaderBaseState.work_started)
}
...
inline ::google::protobuf::int64 ReaderBaseState::work_finished() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.ReaderBaseState.work_finished)
  return work_finished_;
}
inline void ReaderBaseState::set_work_finished(::google::protobuf::int64 value) {
  
  work_finished_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.ReaderBaseState.work_finished)
}
...
inline ::google::protobuf::int64 ReaderBaseState::num_records_produced() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.ReaderBaseState.num_records_produced)
...
inline void ReaderBaseState::set_num_records_produced(::google::protobuf::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.ReaderBaseState.num_records_produced)
}
...
inline const ::std::string& ReaderBaseState::current_work() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.ReaderBaseState.current_work)
...
inline void ReaderBaseState::set_current_work(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.ReaderBaseState.current_work)
}
#if LANG_CXX11
inline void ReaderBaseState::set_current_work(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.ReaderBaseState.current_work)
}
#endif
inline void ReaderBaseState::set_current_work(const char* value) {
  ...
  current_work_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.ReaderBaseState.current_work)
}
inline void ReaderBaseState::set_current_work(const void* value,
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.ReaderBaseState.current_work)
}
inline ::std::string* ReaderBaseState::mutable_current_work() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.ReaderBaseState.current_work)
...
inline ::std::string* ReaderBaseState::release_current_work() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.ReaderBaseState.current_work)
...
inline void ReaderBaseState::set_allocated_current_work(::std::string* current_work) {
  ...
  current_work_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), current_work,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.ReaderBaseState.current_work)
}
inline ::std::string* ReaderBaseState::unsafe_arena_release_current_work() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.ReaderBaseState.current_work)
...
inline void ReaderBaseState::unsafe_arena_set_allocated_current_work(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.ReaderBaseState.current_work)
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2freader_5fbase_2eproto
