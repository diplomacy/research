...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2flog_5fmemory_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2flog_5fmemory_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2flog_5fmemory_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::MemoryLogRawAllocation* Arena::CreateMaybeMessage<::diplomacy::tensorflow::MemoryLogRawAllocation>(Arena*);
template<> ::diplomacy::tensorflow::MemoryLogRawDeallocation* Arena::CreateMaybeMessage<::diplomacy::tensorflow::MemoryLogRawDeallocation>(Arena*);
template<> ::diplomacy::tensorflow::MemoryLogStep* Arena::CreateMaybeMessage<::diplomacy::tensorflow::MemoryLogStep>(Arena*);
template<> ::diplomacy::tensorflow::MemoryLogTensorAllocation* Arena::CreateMaybeMessage<::diplomacy::tensorflow::MemoryLogTensorAllocation>(Arena*);
template<> ::diplomacy::tensorflow::MemoryLogTensorDeallocation* Arena::CreateMaybeMessage<::diplomacy::tensorflow::MemoryLogTensorDeallocation>(Arena*);
template<> ::diplomacy::tensorflow::MemoryLogTensorOutput* Arena::CreateMaybeMessage<::diplomacy::tensorflow::MemoryLogTensorOutput>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class MemoryLogStep : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.MemoryLogStep) */ {
 public:
  MemoryLogStep();
 ...
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2flog_5fmemory_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class MemoryLogTensorAllocation : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.MemoryLogTensorAllocation) */ {
 public:
  ...
  private:
  const ::diplomacy::tensorflow::TensorDescription& _internal_tensor() const;
  public:
  const ::diplomacy::tensorflow::TensorDescription& tensor() const;
  ::diplomacy::tensorflow::TensorDescription* release_tensor();
  ::diplomacy::tensorflow::TensorDescription* mutable_tensor();
  void set_allocated_tensor(::diplomacy::tensorflow::TensorDescription* tensor);
  void unsafe_arena_set_allocated_tensor(
      ::diplomacy::tensorflow::TensorDescription* tensor);
  ::diplomacy::tensorflow::TensorDescription* unsafe_arena_release_tensor();
 ...
 private:
  ...
  ::diplomacy::tensorflow::TensorDescription* tensor_;
  ::google::protobuf::int64 step_id_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2flog_5fmemory_2eproto::TableStruct;
};
...
class MemoryLogTensorDeallocation : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.MemoryLogTensorDeallocation) */ {
 public:
...
class MemoryLogTensorOutput : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.MemoryLogTensorOutput) */ {
 public:
...
class MemoryLogRawAllocation : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.MemoryLogRawAllocation) */ {
 public:
...
class MemoryLogRawDeallocation : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.MemoryLogRawDeallocation) */ {
 public:
...
inline ::google::protobuf::int64 MemoryLogStep::step_id() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogStep.step_id)
  return step_id_;
}
inline void MemoryLogStep::set_step_id(::google::protobuf::int64 value) {
  
  step_id_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogStep.step_id)
}
...
inline const ::std::string& MemoryLogStep::handle() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogStep.handle)
  return handle_.Get();
}
inline void MemoryLogStep::set_handle(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogStep.handle)
}
#if LANG_CXX11
inline void MemoryLogStep::set_handle(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.MemoryLogStep.handle)
}
#endif
inline void MemoryLogStep::set_handle(const char* value) {
  ...
  handle_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.MemoryLogStep.handle)
}
inline void MemoryLogStep::set_handle(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.MemoryLogStep.handle)
}
inline ::std::string* MemoryLogStep::mutable_handle() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MemoryLogStep.handle)
...
inline ::std::string* MemoryLogStep::release_handle() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MemoryLogStep.handle)
...
inline void MemoryLogStep::set_allocated_handle(::std::string* handle) {
  ...
  handle_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), handle,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MemoryLogStep.handle)
}
inline ::std::string* MemoryLogStep::unsafe_arena_release_handle() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MemoryLogStep.handle)
...
inline void MemoryLogStep::unsafe_arena_set_allocated_handle(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.MemoryLogStep.handle)
}
...
inline ::google::protobuf::int64 MemoryLogTensorAllocation::step_id() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogTensorAllocation.step_id)
  return step_id_;
}
inline void MemoryLogTensorAllocation::set_step_id(::google::protobuf::int64 value) {
  
  step_id_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogTensorAllocation.step_id)
}
...
inline const ::std::string& MemoryLogTensorAllocation::kernel_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogTensorAllocation.kernel_name)
...
inline void MemoryLogTensorAllocation::set_kernel_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogTensorAllocation.kernel_name)
}
#if LANG_CXX11
inline void MemoryLogTensorAllocation::set_kernel_name(::std::string&& value) {
  ...
  kernel_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.MemoryLogTensorAllocation.kernel_name)
}
#endif
inline void MemoryLogTensorAllocation::set_kernel_name(const char* value) {
  ...
  kernel_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.MemoryLogTensorAllocation.kernel_name)
}
inline void MemoryLogTensorAllocation::set_kernel_name(const char* value,
    size_t size) {
  ...
  kernel_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.MemoryLogTensorAllocation.kernel_name)
}
inline ::std::string* MemoryLogTensorAllocation::mutable_kernel_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MemoryLogTensorAllocation.kernel_name)
...
inline ::std::string* MemoryLogTensorAllocation::release_kernel_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MemoryLogTensorAllocation.kernel_name)
...
inline void MemoryLogTensorAllocation::set_allocated_kernel_name(::std::string* kernel_name) {
  ...
  kernel_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), kernel_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MemoryLogTensorAllocation.kernel_name)
}
inline ::std::string* MemoryLogTensorAllocation::unsafe_arena_release_kernel_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MemoryLogTensorAllocation.kernel_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void MemoryLogTensorAllocation::unsafe_arena_set_allocated_kernel_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.MemoryLogTensorAllocation.kernel_name)
}
...
inline const ::diplomacy::tensorflow::TensorDescription& MemoryLogTensorAllocation::_internal_tensor() const {
  return *tensor_;
}
inline const ::diplomacy::tensorflow::TensorDescription& MemoryLogTensorAllocation::tensor() const {
  const ::diplomacy::tensorflow::TensorDescription* p = tensor_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogTensorAllocation.tensor)
...
inline ::diplomacy::tensorflow::TensorDescription* MemoryLogTensorAllocation::release_tensor() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MemoryLogTensorAllocation.tensor)
  
  ::diplomacy::tensorflow::TensorDescription* temp = tensor_;
...
inline ::diplomacy::tensorflow::TensorDescription* MemoryLogTensorAllocation::unsafe_arena_release_tensor() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MemoryLogTensorAllocation.tensor)
  
  ::diplomacy::tensorflow::TensorDescription* temp = tensor_;
  tensor_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::TensorDescription* MemoryLogTensorAllocation::mutable_tensor() {
  
  if (tensor_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::TensorDescription>(GetArenaNoVirtual());
    tensor_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MemoryLogTensorAllocation.tensor)
  return tensor_;
}
inline void MemoryLogTensorAllocation::set_allocated_tensor(::diplomacy::tensorflow::TensorDescription* tensor) {
  ...
  tensor_ = tensor;
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MemoryLogTensorAllocation.tensor)
}
...
inline ::google::protobuf::int64 MemoryLogTensorDeallocation::allocation_id() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogTensorDeallocation.allocation_id)
...
inline void MemoryLogTensorDeallocation::set_allocation_id(::google::protobuf::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogTensorDeallocation.allocation_id)
}
...
inline const ::std::string& MemoryLogTensorDeallocation::allocator_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogTensorDeallocation.allocator_name)
...
inline void MemoryLogTensorDeallocation::set_allocator_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogTensorDeallocation.allocator_name)
}
#if LANG_CXX11
inline void MemoryLogTensorDeallocation::set_allocator_name(::std::string&& value) {
  ...
  allocator_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.MemoryLogTensorDeallocation.allocator_name)
}
#endif
inline void MemoryLogTensorDeallocation::set_allocator_name(const char* value) {
  ...
  allocator_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.MemoryLogTensorDeallocation.allocator_name)
}
inline void MemoryLogTensorDeallocation::set_allocator_name(const char* value,
    size_t size) {
  ...
  allocator_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.MemoryLogTensorDeallocation.allocator_name)
}
inline ::std::string* MemoryLogTensorDeallocation::mutable_allocator_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MemoryLogTensorDeallocation.allocator_name)
...
inline ::std::string* MemoryLogTensorDeallocation::release_allocator_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MemoryLogTensorDeallocation.allocator_name)
...
inline void MemoryLogTensorDeallocation::set_allocated_allocator_name(::std::string* allocator_name) {
  ...
  allocator_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), allocator_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MemoryLogTensorDeallocation.allocator_name)
}
inline ::std::string* MemoryLogTensorDeallocation::unsafe_arena_release_allocator_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MemoryLogTensorDeallocation.allocator_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void MemoryLogTensorDeallocation::unsafe_arena_set_allocated_allocator_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.MemoryLogTensorDeallocation.allocator_name)
}
...
inline ::google::protobuf::int64 MemoryLogTensorOutput::step_id() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogTensorOutput.step_id)
  return step_id_;
}
inline void MemoryLogTensorOutput::set_step_id(::google::protobuf::int64 value) {
  
  step_id_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogTensorOutput.step_id)
}
...
inline const ::std::string& MemoryLogTensorOutput::kernel_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogTensorOutput.kernel_name)
  return kernel_name_.Get();
}
...
inline void MemoryLogTensorOutput::set_kernel_name(::std::string&& value) {
  ...
  kernel_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.MemoryLogTensorOutput.kernel_name)
}
#endif
...
inline void MemoryLogTensorOutput::set_kernel_name(const char* value,
  ...
  kernel_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.MemoryLogTensorOutput.kernel_name)
}
inline ::std::string* MemoryLogTensorOutput::mutable_kernel_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MemoryLogTensorOutput.kernel_name)
  return kernel_name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* MemoryLogTensorOutput::release_kernel_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MemoryLogTensorOutput.kernel_name)
...
inline void MemoryLogTensorOutput::set_allocated_kernel_name(::std::string* kernel_name) {
  ...
  kernel_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), kernel_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MemoryLogTensorOutput.kernel_name)
}
inline ::std::string* MemoryLogTensorOutput::unsafe_arena_release_kernel_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MemoryLogTensorOutput.kernel_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void MemoryLogTensorOutput::unsafe_arena_set_allocated_kernel_name(
  ...
  kernel_name_.UnsafeArenaSetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      kernel_name, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.MemoryLogTensorOutput.kernel_name)
}
...
inline ::google::protobuf::int32 MemoryLogTensorOutput::index() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogTensorOutput.index)
  return index_;
}
inline void MemoryLogTensorOutput::set_index(::google::protobuf::int32 value) {
  
  index_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogTensorOutput.index)
}
...
inline const ::diplomacy::tensorflow::TensorDescription& MemoryLogTensorOutput::_internal_tensor() const {
  return *tensor_;
}
inline const ::diplomacy::tensorflow::TensorDescription& MemoryLogTensorOutput::tensor() const {
  const ::diplomacy::tensorflow::TensorDescription* p = tensor_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogTensorOutput.tensor)
  return p != NULL ? *p : *reinterpret_cast<const ::diplomacy::tensorflow::TensorDescription*>(
      &::diplomacy::tensorflow::_TensorDescription_default_instance_);
}
inline ::diplomacy::tensorflow::TensorDescription* MemoryLogTensorOutput::release_tensor() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MemoryLogTensorOutput.tensor)
...
inline ::diplomacy::tensorflow::TensorDescription* MemoryLogTensorOutput::unsafe_arena_release_tensor() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MemoryLogTensorOutput.tensor)
  
  ::diplomacy::tensorflow::TensorDescription* temp = tensor_;
  tensor_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::TensorDescription* MemoryLogTensorOutput::mutable_tensor() {
  
  if (tensor_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::TensorDescription>(GetArenaNoVirtual());
    tensor_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MemoryLogTensorOutput.tensor)
  return tensor_;
}
inline void MemoryLogTensorOutput::set_allocated_tensor(::diplomacy::tensorflow::TensorDescription* tensor) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(tensor_);
  }
  ...
  tensor_ = tensor;
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MemoryLogTensorOutput.tensor)
}
...
inline ::google::protobuf::int64 MemoryLogRawAllocation::step_id() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogRawAllocation.step_id)
  return step_id_;
}
inline void MemoryLogRawAllocation::set_step_id(::google::protobuf::int64 value) {
  
  step_id_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogRawAllocation.step_id)
}
...
inline const ::std::string& MemoryLogRawAllocation::operation() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogRawAllocation.operation)
...
inline void MemoryLogRawAllocation::set_operation(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogRawAllocation.operation)
}
#if LANG_CXX11
inline void MemoryLogRawAllocation::set_operation(::std::string&& value) {
  ...
  operation_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.MemoryLogRawAllocation.operation)
}
#endif
inline void MemoryLogRawAllocation::set_operation(const char* value) {
  ...
  operation_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.MemoryLogRawAllocation.operation)
}
inline void MemoryLogRawAllocation::set_operation(const char* value,
    size_t size) {
  ...
  operation_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.MemoryLogRawAllocation.operation)
}
inline ::std::string* MemoryLogRawAllocation::mutable_operation() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MemoryLogRawAllocation.operation)
...
inline ::std::string* MemoryLogRawAllocation::release_operation() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MemoryLogRawAllocation.operation)
...
inline void MemoryLogRawAllocation::set_allocated_operation(::std::string* operation) {
  ...
  operation_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), operation,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MemoryLogRawAllocation.operation)
}
inline ::std::string* MemoryLogRawAllocation::unsafe_arena_release_operation() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MemoryLogRawAllocation.operation)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void MemoryLogRawAllocation::unsafe_arena_set_allocated_operation(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.MemoryLogRawAllocation.operation)
}
...
inline ::google::protobuf::int64 MemoryLogRawAllocation::num_bytes() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogRawAllocation.num_bytes)
  return num_bytes_;
}
inline void MemoryLogRawAllocation::set_num_bytes(::google::protobuf::int64 value) {
  
  num_bytes_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogRawAllocation.num_bytes)
}
...
inline ::google::protobuf::uint64 MemoryLogRawAllocation::ptr() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogRawAllocation.ptr)
  return ptr_;
}
inline void MemoryLogRawAllocation::set_ptr(::google::protobuf::uint64 value) {
  
  ptr_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogRawAllocation.ptr)
}
...
inline ::google::protobuf::int64 MemoryLogRawAllocation::allocation_id() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogRawAllocation.allocation_id)
  return allocation_id_;
}
inline void MemoryLogRawAllocation::set_allocation_id(::google::protobuf::int64 value) {
  
  allocation_id_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogRawAllocation.allocation_id)
}
...
inline const ::std::string& MemoryLogRawAllocation::allocator_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogRawAllocation.allocator_name)
  return allocator_name_.Get();
}
inline void MemoryLogRawAllocation::set_allocator_name(const ::std::string& value) {
  
  allocator_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogRawAllocation.allocator_name)
}
#if LANG_CXX11
inline void MemoryLogRawAllocation::set_allocator_name(::std::string&& value) {
  ...
  allocator_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.MemoryLogRawAllocation.allocator_name)
}
#endif
inline void MemoryLogRawAllocation::set_allocator_name(const char* value) {
  ...
  allocator_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.MemoryLogRawAllocation.allocator_name)
}
inline void MemoryLogRawAllocation::set_allocator_name(const char* value,
    size_t size) {
  ...
  allocator_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.MemoryLogRawAllocation.allocator_name)
}
inline ::std::string* MemoryLogRawAllocation::mutable_allocator_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MemoryLogRawAllocation.allocator_name)
  return allocator_name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* MemoryLogRawAllocation::release_allocator_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MemoryLogRawAllocation.allocator_name)
...
inline void MemoryLogRawAllocation::set_allocated_allocator_name(::std::string* allocator_name) {
  ...
  allocator_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), allocator_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MemoryLogRawAllocation.allocator_name)
}
inline ::std::string* MemoryLogRawAllocation::unsafe_arena_release_allocator_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MemoryLogRawAllocation.allocator_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void MemoryLogRawAllocation::unsafe_arena_set_allocated_allocator_name(
  ...
  allocator_name_.UnsafeArenaSetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      allocator_name, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.MemoryLogRawAllocation.allocator_name)
}
...
inline ::google::protobuf::int64 MemoryLogRawDeallocation::step_id() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogRawDeallocation.step_id)
  return step_id_;
}
inline void MemoryLogRawDeallocation::set_step_id(::google::protobuf::int64 value) {
  
  step_id_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogRawDeallocation.step_id)
}
...
inline const ::std::string& MemoryLogRawDeallocation::operation() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogRawDeallocation.operation)
  return operation_.Get();
}
inline void MemoryLogRawDeallocation::set_operation(const ::std::string& value) {
  
  operation_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogRawDeallocation.operation)
}
#if LANG_CXX11
inline void MemoryLogRawDeallocation::set_operation(::std::string&& value) {
  ...
  operation_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.MemoryLogRawDeallocation.operation)
}
#endif
inline void MemoryLogRawDeallocation::set_operation(const char* value) {
  ...
  operation_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.MemoryLogRawDeallocation.operation)
}
inline void MemoryLogRawDeallocation::set_operation(const char* value,
    size_t size) {
  ...
  operation_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.MemoryLogRawDeallocation.operation)
}
inline ::std::string* MemoryLogRawDeallocation::mutable_operation() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MemoryLogRawDeallocation.operation)
  return operation_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* MemoryLogRawDeallocation::release_operation() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MemoryLogRawDeallocation.operation)
...
inline void MemoryLogRawDeallocation::set_allocated_operation(::std::string* operation) {
  ...
  operation_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), operation,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MemoryLogRawDeallocation.operation)
}
inline ::std::string* MemoryLogRawDeallocation::unsafe_arena_release_operation() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MemoryLogRawDeallocation.operation)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void MemoryLogRawDeallocation::unsafe_arena_set_allocated_operation(
  ...
  operation_.UnsafeArenaSetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      operation, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.MemoryLogRawDeallocation.operation)
}
...
inline ::google::protobuf::int64 MemoryLogRawDeallocation::allocation_id() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogRawDeallocation.allocation_id)
  return allocation_id_;
}
inline void MemoryLogRawDeallocation::set_allocation_id(::google::protobuf::int64 value) {
  
  allocation_id_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogRawDeallocation.allocation_id)
}
...
inline const ::std::string& MemoryLogRawDeallocation::allocator_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogRawDeallocation.allocator_name)
  return allocator_name_.Get();
}
inline void MemoryLogRawDeallocation::set_allocator_name(const ::std::string& value) {
  
  allocator_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogRawDeallocation.allocator_name)
}
#if LANG_CXX11
inline void MemoryLogRawDeallocation::set_allocator_name(::std::string&& value) {
  ...
  allocator_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.MemoryLogRawDeallocation.allocator_name)
}
#endif
inline void MemoryLogRawDeallocation::set_allocator_name(const char* value) {
  ...
  allocator_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.MemoryLogRawDeallocation.allocator_name)
}
inline void MemoryLogRawDeallocation::set_allocator_name(const char* value,
    size_t size) {
  ...
  allocator_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.MemoryLogRawDeallocation.allocator_name)
}
inline ::std::string* MemoryLogRawDeallocation::mutable_allocator_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.MemoryLogRawDeallocation.allocator_name)
  return allocator_name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* MemoryLogRawDeallocation::release_allocator_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.MemoryLogRawDeallocation.allocator_name)
...
inline void MemoryLogRawDeallocation::set_allocated_allocator_name(::std::string* allocator_name) {
  ...
  allocator_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), allocator_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.MemoryLogRawDeallocation.allocator_name)
}
inline ::std::string* MemoryLogRawDeallocation::unsafe_arena_release_allocator_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.MemoryLogRawDeallocation.allocator_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void MemoryLogRawDeallocation::unsafe_arena_set_allocated_allocator_name(
  ...
  allocator_name_.UnsafeArenaSetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      allocator_name, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.MemoryLogRawDeallocation.allocator_name)
}
...
inline bool MemoryLogRawDeallocation::deferred() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.MemoryLogRawDeallocation.deferred)
  return deferred_;
}
inline void MemoryLogRawDeallocation::set_deferred(bool value) {
  
  deferred_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.MemoryLogRawDeallocation.deferred)
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2flog_5fmemory_2eproto
