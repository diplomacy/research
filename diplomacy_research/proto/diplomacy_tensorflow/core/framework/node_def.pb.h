...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2fnode_5fdef_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2fnode_5fdef_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2fnode_5fdef_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::NodeDef* Arena::CreateMaybeMessage<::diplomacy::tensorflow::NodeDef>(Arena*);
template<> ::diplomacy::tensorflow::NodeDef_AttrEntry_DoNotUse* Arena::CreateMaybeMessage<::diplomacy::tensorflow::NodeDef_AttrEntry_DoNotUse>(Arena*);
template<> ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo* Arena::CreateMaybeMessage<::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class NodeDef_ExperimentalDebugInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo)
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2fnode_5fdef_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class NodeDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.NodeDef) */ {
 public:
  NodeDef();
  virtual ~NodeDef();
  ...
  private:
  const ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo& _internal_experimental_debug_info() const;
  public:
  const ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo& experimental_debug_info() const;
  ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo* release_experimental_debug_info();
  ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo* mutable_experimental_debug_info();
  void set_allocated_experimental_debug_info(::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo* experimental_debug_info);
  ...
  ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo* unsafe_arena_release_experimental_debug_info();

  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.NodeDef)
 private:
  ...
  ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo* experimental_debug_info_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2fnode_5fdef_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::std::string& NodeDef_ExperimentalDebugInfo::original_node_names(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo.original_node_names)
...
inline ::std::string* NodeDef_ExperimentalDebugInfo::mutable_original_node_names(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo.original_node_names)
...
inline void NodeDef_ExperimentalDebugInfo::set_original_node_names(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo.original_node_names)
...
inline void NodeDef_ExperimentalDebugInfo::set_original_node_names(int index, const char* value) {
  ...
  original_node_names_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo.original_node_names)
}
inline void NodeDef_ExperimentalDebugInfo::set_original_node_names(int index, const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo.original_node_names)
}
inline ::std::string* NodeDef_ExperimentalDebugInfo::add_original_node_names() {
  // @@protoc_insertion_point(field_add_mutable:diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo.original_node_names)
...
inline void NodeDef_ExperimentalDebugInfo::add_original_node_names(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo.original_node_names)
}
#if LANG_CXX11
...
inline void NodeDef_ExperimentalDebugInfo::add_original_node_names(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  original_node_names_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo.original_node_names)
}
inline void NodeDef_ExperimentalDebugInfo::add_original_node_names(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo.original_node_names)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
NodeDef_ExperimentalDebugInfo::original_node_names() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo.original_node_names)
  return original_node_names_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
NodeDef_ExperimentalDebugInfo::mutable_original_node_names() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.NodeDef.ExperimentalDebugInfo.original_node_names)
  return &original_node_names_;
}
...
inline const ::std::string& NodeDef::name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.NodeDef.name)
  return name_.Get();
}
inline void NodeDef::set_name(const ::std::string& value) {
  
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.NodeDef.name)
}
#if LANG_CXX11
inline void NodeDef::set_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.NodeDef.name)
}
#endif
inline void NodeDef::set_name(const char* value) {
  ...
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.NodeDef.name)
}
inline void NodeDef::set_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.NodeDef.name)
}
inline ::std::string* NodeDef::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.NodeDef.name)
  return name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* NodeDef::release_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.NodeDef.name)
...
inline void NodeDef::set_allocated_name(::std::string* name) {
  ...
  name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.NodeDef.name)
}
inline ::std::string* NodeDef::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.NodeDef.name)
...
inline void NodeDef::unsafe_arena_set_allocated_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.NodeDef.name)
}
...
inline const ::std::string& NodeDef::op() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.NodeDef.op)
  return op_.Get();
}
inline void NodeDef::set_op(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.NodeDef.op)
}
#if LANG_CXX11
inline void NodeDef::set_op(::std::string&& value) {
  ...
  op_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.NodeDef.op)
}
#endif
inline void NodeDef::set_op(const char* value) {
  ...
  op_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.NodeDef.op)
}
inline void NodeDef::set_op(const char* value,
    size_t size) {
  ...
  op_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.NodeDef.op)
}
inline ::std::string* NodeDef::mutable_op() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.NodeDef.op)
...
inline ::std::string* NodeDef::release_op() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.NodeDef.op)
...
inline void NodeDef::set_allocated_op(::std::string* op) {
  ...
  op_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), op,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.NodeDef.op)
}
inline ::std::string* NodeDef::unsafe_arena_release_op() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.NodeDef.op)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void NodeDef::unsafe_arena_set_allocated_op(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.NodeDef.op)
}
...
inline const ::std::string& NodeDef::input(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.NodeDef.input)
  return input_.Get(index);
}
inline ::std::string* NodeDef::mutable_input(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.NodeDef.input)
  return input_.Mutable(index);
}
inline void NodeDef::set_input(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.NodeDef.input)
...
inline void NodeDef::set_input(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  input_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.NodeDef.input)
}
inline void NodeDef::set_input(int index, const char* value, size_t size) {
  input_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.NodeDef.input)
}
inline ::std::string* NodeDef::add_input() {
  // @@protoc_insertion_point(field_add_mutable:diplomacy.tensorflow.NodeDef.input)
  return input_.Add();
}
inline void NodeDef::add_input(const ::std::string& value) {
  input_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.NodeDef.input)
}
#if LANG_CXX11
...
inline void NodeDef::add_input(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  input_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:diplomacy.tensorflow.NodeDef.input)
}
inline void NodeDef::add_input(const char* value, size_t size) {
  input_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:diplomacy.tensorflow.NodeDef.input)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
NodeDef::input() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.NodeDef.input)
  return input_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
NodeDef::mutable_input() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.NodeDef.input)
  return &input_;
}
...
inline const ::std::string& NodeDef::device() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.NodeDef.device)
  return device_.Get();
}
inline void NodeDef::set_device(const ::std::string& value) {
  
  device_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.NodeDef.device)
}
#if LANG_CXX11
inline void NodeDef::set_device(::std::string&& value) {
  ...
  device_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.NodeDef.device)
}
#endif
inline void NodeDef::set_device(const char* value) {
  ...
  device_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.NodeDef.device)
}
inline void NodeDef::set_device(const char* value,
    size_t size) {
  ...
  device_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.NodeDef.device)
}
inline ::std::string* NodeDef::mutable_device() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.NodeDef.device)
...
inline ::std::string* NodeDef::release_device() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.NodeDef.device)
...
inline void NodeDef::set_allocated_device(::std::string* device) {
  ...
  device_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), device,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.NodeDef.device)
}
inline ::std::string* NodeDef::unsafe_arena_release_device() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.NodeDef.device)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void NodeDef::unsafe_arena_set_allocated_device(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.NodeDef.device)
}
...
NodeDef::attr() const {
  // @@protoc_insertion_point(field_map:diplomacy.tensorflow.NodeDef.attr)
  return attr_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::AttrValue >*
NodeDef::mutable_attr() {
  // @@protoc_insertion_point(field_mutable_map:diplomacy.tensorflow.NodeDef.attr)
...
inline const ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo& NodeDef::_internal_experimental_debug_info() const {
  return *experimental_debug_info_;
}
inline const ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo& NodeDef::experimental_debug_info() const {
  const ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo* p = experimental_debug_info_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.NodeDef.experimental_debug_info)
  return p != NULL ? *p : *reinterpret_cast<const ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo*>(
      &::diplomacy::tensorflow::_NodeDef_ExperimentalDebugInfo_default_instance_);
}
inline ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo* NodeDef::release_experimental_debug_info() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.NodeDef.experimental_debug_info)
  
  ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo* temp = experimental_debug_info_;
...
inline ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo* NodeDef::unsafe_arena_release_experimental_debug_info() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.NodeDef.experimental_debug_info)
  
  ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo* temp = experimental_debug_info_;
  experimental_debug_info_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo* NodeDef::mutable_experimental_debug_info() {
  
  if (experimental_debug_info_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo>(GetArenaNoVirtual());
    experimental_debug_info_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.NodeDef.experimental_debug_info)
  return experimental_debug_info_;
}
inline void NodeDef::set_allocated_experimental_debug_info(::diplomacy::tensorflow::NodeDef_ExperimentalDebugInfo* experimental_debug_info) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.NodeDef.experimental_debug_info)
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2fnode_5fdef_2eproto
