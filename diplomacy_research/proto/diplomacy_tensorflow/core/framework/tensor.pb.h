...
// source: diplomacy_tensorflow/core/framework/tensor.proto

#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2ftensor_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2ftensor_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2ftensor_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::TensorProto* Arena::CreateMaybeMessage<::diplomacy::tensorflow::TensorProto>(Arena*);
template<> ::diplomacy::tensorflow::VariantTensorDataProto* Arena::CreateMaybeMessage<::diplomacy::tensorflow::VariantTensorDataProto>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class TensorProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.TensorProto) */ {
 public:
  TensorProto();
  virtual ~TensorProto();
  ...
  // repeated .diplomacy.tensorflow.ResourceHandleProto resource_handle_val = 14;
  int resource_handle_val_size() const;
  void clear_resource_handle_val();
  static const int kResourceHandleValFieldNumber = 14;
  ::diplomacy::tensorflow::ResourceHandleProto* mutable_resource_handle_val(int index);
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::ResourceHandleProto >*
      mutable_resource_handle_val();
  const ::diplomacy::tensorflow::ResourceHandleProto& resource_handle_val(int index) const;
  ::diplomacy::tensorflow::ResourceHandleProto* add_resource_handle_val();
  const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::ResourceHandleProto >&
      resource_handle_val() const;

  // repeated .diplomacy.tensorflow.VariantTensorDataProto variant_val = 15;
  int variant_val_size() const;
  void clear_variant_val();
  static const int kVariantValFieldNumber = 15;
  ::diplomacy::tensorflow::VariantTensorDataProto* mutable_variant_val(int index);
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::VariantTensorDataProto >*
      mutable_variant_val();
  const ::diplomacy::tensorflow::VariantTensorDataProto& variant_val(int index) const;
  ::diplomacy::tensorflow::VariantTensorDataProto* add_variant_val();
  const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::VariantTensorDataProto >&
      variant_val() const;
  ...
  // .diplomacy.tensorflow.TensorShapeProto tensor_shape = 2;
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.TensorProto)
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::ResourceHandleProto > resource_handle_val_;
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::VariantTensorDataProto > variant_val_;
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2ftensor_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class VariantTensorDataProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.VariantTensorDataProto) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.VariantTensorDataProto)
 private:
...
inline ::diplomacy::tensorflow::DataType TensorProto::dtype() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.dtype)
  return static_cast< ::diplomacy::tensorflow::DataType >(dtype_);
}
inline void TensorProto::set_dtype(::diplomacy::tensorflow::DataType value) {
  
  dtype_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorProto.dtype)
}
...
inline const ::diplomacy::tensorflow::TensorShapeProto& TensorProto::_internal_tensor_shape() const {
  return *tensor_shape_;
}
inline const ::diplomacy::tensorflow::TensorShapeProto& TensorProto::tensor_shape() const {
  const ::diplomacy::tensorflow::TensorShapeProto* p = tensor_shape_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.tensor_shape)
...
inline ::diplomacy::tensorflow::TensorShapeProto* TensorProto::release_tensor_shape() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.TensorProto.tensor_shape)
...
inline ::diplomacy::tensorflow::TensorShapeProto* TensorProto::unsafe_arena_release_tensor_shape() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.TensorProto.tensor_shape)
  
  ::diplomacy::tensorflow::TensorShapeProto* temp = tensor_shape_;
  tensor_shape_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::TensorShapeProto* TensorProto::mutable_tensor_shape() {
  
  if (tensor_shape_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::TensorShapeProto>(GetArenaNoVirtual());
    tensor_shape_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.TensorProto.tensor_shape)
  return tensor_shape_;
}
inline void TensorProto::set_allocated_tensor_shape(::diplomacy::tensorflow::TensorShapeProto* tensor_shape) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.TensorProto.tensor_shape)
}
...
inline ::google::protobuf::int32 TensorProto::version_number() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.version_number)
  return version_number_;
}
inline void TensorProto::set_version_number(::google::protobuf::int32 value) {
  
  version_number_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorProto.version_number)
}
...
inline const ::std::string& TensorProto::tensor_content() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.tensor_content)
...
inline void TensorProto::set_tensor_content(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorProto.tensor_content)
}
#if LANG_CXX11
inline void TensorProto::set_tensor_content(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.TensorProto.tensor_content)
}
#endif
inline void TensorProto::set_tensor_content(const char* value) {
  ...
  tensor_content_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.TensorProto.tensor_content)
}
inline void TensorProto::set_tensor_content(const void* value,
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.TensorProto.tensor_content)
}
inline ::std::string* TensorProto::mutable_tensor_content() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.TensorProto.tensor_content)
...
inline ::std::string* TensorProto::release_tensor_content() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.TensorProto.tensor_content)
...
inline void TensorProto::set_allocated_tensor_content(::std::string* tensor_content) {
  ...
  tensor_content_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), tensor_content,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.TensorProto.tensor_content)
}
inline ::std::string* TensorProto::unsafe_arena_release_tensor_content() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.TensorProto.tensor_content)
...
inline void TensorProto::unsafe_arena_set_allocated_tensor_content(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.TensorProto.tensor_content)
}
...
inline ::google::protobuf::int32 TensorProto::half_val(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.half_val)
...
inline void TensorProto::set_half_val(int index, ::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorProto.half_val)
}
inline void TensorProto::add_half_val(::google::protobuf::int32 value) {
  half_val_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.TensorProto.half_val)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
TensorProto::half_val() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.TensorProto.half_val)
  return half_val_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
TensorProto::mutable_half_val() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.TensorProto.half_val)
  return &half_val_;
}
...
inline float TensorProto::float_val(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.float_val)
  return float_val_.Get(index);
}
inline void TensorProto::set_float_val(int index, float value) {
  float_val_.Set(index, value);
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorProto.float_val)
}
inline void TensorProto::add_float_val(float value) {
  float_val_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.TensorProto.float_val)
}
inline const ::google::protobuf::RepeatedField< float >&
TensorProto::float_val() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.TensorProto.float_val)
  return float_val_;
}
inline ::google::protobuf::RepeatedField< float >*
TensorProto::mutable_float_val() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.TensorProto.float_val)
  return &float_val_;
}
...
inline double TensorProto::double_val(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.double_val)
  return double_val_.Get(index);
}
inline void TensorProto::set_double_val(int index, double value) {
  double_val_.Set(index, value);
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorProto.double_val)
}
inline void TensorProto::add_double_val(double value) {
  double_val_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.TensorProto.double_val)
}
inline const ::google::protobuf::RepeatedField< double >&
TensorProto::double_val() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.TensorProto.double_val)
  return double_val_;
}
inline ::google::protobuf::RepeatedField< double >*
TensorProto::mutable_double_val() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.TensorProto.double_val)
  return &double_val_;
}
...
inline ::google::protobuf::int32 TensorProto::int_val(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.int_val)
...
inline void TensorProto::set_int_val(int index, ::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorProto.int_val)
}
inline void TensorProto::add_int_val(::google::protobuf::int32 value) {
  int_val_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.TensorProto.int_val)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
TensorProto::int_val() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.TensorProto.int_val)
  return int_val_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
TensorProto::mutable_int_val() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.TensorProto.int_val)
  return &int_val_;
}
...
inline const ::std::string& TensorProto::string_val(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.string_val)
  return string_val_.Get(index);
}
inline ::std::string* TensorProto::mutable_string_val(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.TensorProto.string_val)
  return string_val_.Mutable(index);
}
inline void TensorProto::set_string_val(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorProto.string_val)
...
inline void TensorProto::set_string_val(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  string_val_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.TensorProto.string_val)
}
inline void TensorProto::set_string_val(int index, const void* value, size_t size) {
  string_val_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.TensorProto.string_val)
}
inline ::std::string* TensorProto::add_string_val() {
  // @@protoc_insertion_point(field_add_mutable:diplomacy.tensorflow.TensorProto.string_val)
  return string_val_.Add();
}
inline void TensorProto::add_string_val(const ::std::string& value) {
  string_val_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.TensorProto.string_val)
}
#if LANG_CXX11
...
inline void TensorProto::add_string_val(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  string_val_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:diplomacy.tensorflow.TensorProto.string_val)
}
inline void TensorProto::add_string_val(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:diplomacy.tensorflow.TensorProto.string_val)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
TensorProto::string_val() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.TensorProto.string_val)
  return string_val_;
}
...
inline float TensorProto::scomplex_val(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.scomplex_val)
...
inline void TensorProto::set_scomplex_val(int index, float value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorProto.scomplex_val)
}
inline void TensorProto::add_scomplex_val(float value) {
  scomplex_val_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.TensorProto.scomplex_val)
}
inline const ::google::protobuf::RepeatedField< float >&
TensorProto::scomplex_val() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.TensorProto.scomplex_val)
  return scomplex_val_;
}
inline ::google::protobuf::RepeatedField< float >*
TensorProto::mutable_scomplex_val() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.TensorProto.scomplex_val)
  return &scomplex_val_;
}
...
inline ::google::protobuf::int64 TensorProto::int64_val(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.int64_val)
...
inline void TensorProto::set_int64_val(int index, ::google::protobuf::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorProto.int64_val)
}
inline void TensorProto::add_int64_val(::google::protobuf::int64 value) {
  int64_val_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.TensorProto.int64_val)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
TensorProto::int64_val() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.TensorProto.int64_val)
  return int64_val_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
TensorProto::mutable_int64_val() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.TensorProto.int64_val)
  return &int64_val_;
}
...
inline bool TensorProto::bool_val(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.bool_val)
  return bool_val_.Get(index);
}
inline void TensorProto::set_bool_val(int index, bool value) {
  bool_val_.Set(index, value);
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorProto.bool_val)
}
inline void TensorProto::add_bool_val(bool value) {
  bool_val_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.TensorProto.bool_val)
}
inline const ::google::protobuf::RepeatedField< bool >&
TensorProto::bool_val() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.TensorProto.bool_val)
  return bool_val_;
}
inline ::google::protobuf::RepeatedField< bool >*
TensorProto::mutable_bool_val() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.TensorProto.bool_val)
  return &bool_val_;
}
...
inline double TensorProto::dcomplex_val(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.dcomplex_val)
...
inline void TensorProto::set_dcomplex_val(int index, double value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorProto.dcomplex_val)
}
inline void TensorProto::add_dcomplex_val(double value) {
  dcomplex_val_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.TensorProto.dcomplex_val)
}
inline const ::google::protobuf::RepeatedField< double >&
TensorProto::dcomplex_val() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.TensorProto.dcomplex_val)
  return dcomplex_val_;
}
inline ::google::protobuf::RepeatedField< double >*
TensorProto::mutable_dcomplex_val() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.TensorProto.dcomplex_val)
  return &dcomplex_val_;
}
...
inline ::diplomacy::tensorflow::ResourceHandleProto* TensorProto::mutable_resource_handle_val(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.TensorProto.resource_handle_val)
  return resource_handle_val_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::ResourceHandleProto >*
TensorProto::mutable_resource_handle_val() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.TensorProto.resource_handle_val)
  return &resource_handle_val_;
}
inline const ::diplomacy::tensorflow::ResourceHandleProto& TensorProto::resource_handle_val(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.resource_handle_val)
  return resource_handle_val_.Get(index);
}
inline ::diplomacy::tensorflow::ResourceHandleProto* TensorProto::add_resource_handle_val() {
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.TensorProto.resource_handle_val)
  return resource_handle_val_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::ResourceHandleProto >&
TensorProto::resource_handle_val() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.TensorProto.resource_handle_val)
  return resource_handle_val_;
}
...
inline ::diplomacy::tensorflow::VariantTensorDataProto* TensorProto::mutable_variant_val(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.TensorProto.variant_val)
  return variant_val_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::VariantTensorDataProto >*
TensorProto::mutable_variant_val() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.TensorProto.variant_val)
  return &variant_val_;
}
inline const ::diplomacy::tensorflow::VariantTensorDataProto& TensorProto::variant_val(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.variant_val)
  return variant_val_.Get(index);
}
inline ::diplomacy::tensorflow::VariantTensorDataProto* TensorProto::add_variant_val() {
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.TensorProto.variant_val)
  return variant_val_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::VariantTensorDataProto >&
TensorProto::variant_val() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.TensorProto.variant_val)
  return variant_val_;
}
...
inline ::google::protobuf::uint32 TensorProto::uint32_val(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.uint32_val)
...
inline void TensorProto::set_uint32_val(int index, ::google::protobuf::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorProto.uint32_val)
}
inline void TensorProto::add_uint32_val(::google::protobuf::uint32 value) {
  uint32_val_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.TensorProto.uint32_val)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
TensorProto::uint32_val() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.TensorProto.uint32_val)
  return uint32_val_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
TensorProto::mutable_uint32_val() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.TensorProto.uint32_val)
  return &uint32_val_;
}
...
inline ::google::protobuf::uint64 TensorProto::uint64_val(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.TensorProto.uint64_val)
...
inline void TensorProto::set_uint64_val(int index, ::google::protobuf::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.TensorProto.uint64_val)
}
inline void TensorProto::add_uint64_val(::google::protobuf::uint64 value) {
  uint64_val_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.TensorProto.uint64_val)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >&
TensorProto::uint64_val() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.TensorProto.uint64_val)
  return uint64_val_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >*
TensorProto::mutable_uint64_val() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.TensorProto.uint64_val)
  return &uint64_val_;
}
...
inline const ::std::string& VariantTensorDataProto::type_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.VariantTensorDataProto.type_name)
...
inline void VariantTensorDataProto::set_type_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.VariantTensorDataProto.type_name)
}
#if LANG_CXX11
inline void VariantTensorDataProto::set_type_name(::std::string&& value) {
  ...
  type_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.VariantTensorDataProto.type_name)
}
#endif
inline void VariantTensorDataProto::set_type_name(const char* value) {
  ...
  type_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.VariantTensorDataProto.type_name)
}
inline void VariantTensorDataProto::set_type_name(const char* value,
    size_t size) {
  ...
  type_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.VariantTensorDataProto.type_name)
}
inline ::std::string* VariantTensorDataProto::mutable_type_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.VariantTensorDataProto.type_name)
...
inline ::std::string* VariantTensorDataProto::release_type_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.VariantTensorDataProto.type_name)
...
inline void VariantTensorDataProto::set_allocated_type_name(::std::string* type_name) {
  ...
  type_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), type_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.VariantTensorDataProto.type_name)
}
inline ::std::string* VariantTensorDataProto::unsafe_arena_release_type_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.VariantTensorDataProto.type_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void VariantTensorDataProto::unsafe_arena_set_allocated_type_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.VariantTensorDataProto.type_name)
}
...
inline const ::std::string& VariantTensorDataProto::metadata() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.VariantTensorDataProto.metadata)
...
inline void VariantTensorDataProto::set_metadata(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.VariantTensorDataProto.metadata)
}
#if LANG_CXX11
inline void VariantTensorDataProto::set_metadata(::std::string&& value) {
  ...
  metadata_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.VariantTensorDataProto.metadata)
}
#endif
inline void VariantTensorDataProto::set_metadata(const char* value) {
  ...
  metadata_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.VariantTensorDataProto.metadata)
}
inline void VariantTensorDataProto::set_metadata(const void* value,
  ...
  metadata_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.VariantTensorDataProto.metadata)
}
inline ::std::string* VariantTensorDataProto::mutable_metadata() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.VariantTensorDataProto.metadata)
...
inline ::std::string* VariantTensorDataProto::release_metadata() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.VariantTensorDataProto.metadata)
...
inline void VariantTensorDataProto::set_allocated_metadata(::std::string* metadata) {
  ...
  metadata_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), metadata,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.VariantTensorDataProto.metadata)
}
inline ::std::string* VariantTensorDataProto::unsafe_arena_release_metadata() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.VariantTensorDataProto.metadata)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void VariantTensorDataProto::unsafe_arena_set_allocated_metadata(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.VariantTensorDataProto.metadata)
}
...
inline ::diplomacy::tensorflow::TensorProto* VariantTensorDataProto::mutable_tensors(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.VariantTensorDataProto.tensors)
...
VariantTensorDataProto::mutable_tensors() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.VariantTensorDataProto.tensors)
  return &tensors_;
}
inline const ::diplomacy::tensorflow::TensorProto& VariantTensorDataProto::tensors(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.VariantTensorDataProto.tensors)
  return tensors_.Get(index);
}
inline ::diplomacy::tensorflow::TensorProto* VariantTensorDataProto::add_tensors() {
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.VariantTensorDataProto.tensors)
  return tensors_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::TensorProto >&
VariantTensorDataProto::tensors() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.VariantTensorDataProto.tensors)
  return tensors_;
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fframework_2ftensor_2eproto
