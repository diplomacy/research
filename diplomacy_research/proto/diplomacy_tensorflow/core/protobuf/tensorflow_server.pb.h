...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2ftensorflow_5fserver_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2ftensorflow_5fserver_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2ftensorflow_5fserver_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::ServerDef* Arena::CreateMaybeMessage<::diplomacy::tensorflow::ServerDef>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class ServerDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.ServerDef) */ {
 public:
  ServerDef();
  virtual ~ServerDef();
  ...
  private:
  const ::diplomacy::tensorflow::ClusterDef& _internal_cluster() const;
  public:
  const ::diplomacy::tensorflow::ClusterDef& cluster() const;
  ::diplomacy::tensorflow::ClusterDef* release_cluster();
  ::diplomacy::tensorflow::ClusterDef* mutable_cluster();
  void set_allocated_cluster(::diplomacy::tensorflow::ClusterDef* cluster);
  void unsafe_arena_set_allocated_cluster(
      ::diplomacy::tensorflow::ClusterDef* cluster);
  ::diplomacy::tensorflow::ClusterDef* unsafe_arena_release_cluster();
  ...
  private:
  const ::diplomacy::tensorflow::ConfigProto& _internal_default_session_config() const;
  public:
  const ::diplomacy::tensorflow::ConfigProto& default_session_config() const;
  ::diplomacy::tensorflow::ConfigProto* release_default_session_config();
  ::diplomacy::tensorflow::ConfigProto* mutable_default_session_config();
  void set_allocated_default_session_config(::diplomacy::tensorflow::ConfigProto* default_session_config);
  void unsafe_arena_set_allocated_default_session_config(
      ::diplomacy::tensorflow::ConfigProto* default_session_config);
  ::diplomacy::tensorflow::ConfigProto* unsafe_arena_release_default_session_config();
 ...
 private:
  ...
  ::diplomacy::tensorflow::ClusterDef* cluster_;
  ::diplomacy::tensorflow::ConfigProto* default_session_config_;
  ::google::protobuf::int32 task_index_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2ftensorflow_5fserver_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::diplomacy::tensorflow::ClusterDef& ServerDef::_internal_cluster() const {
  return *cluster_;
}
inline const ::diplomacy::tensorflow::ClusterDef& ServerDef::cluster() const {
  const ::diplomacy::tensorflow::ClusterDef* p = cluster_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.ServerDef.cluster)
  return p != NULL ? *p : *reinterpret_cast<const ::diplomacy::tensorflow::ClusterDef*>(
      &::diplomacy::tensorflow::_ClusterDef_default_instance_);
}
inline ::diplomacy::tensorflow::ClusterDef* ServerDef::release_cluster() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.ServerDef.cluster)
  
  ::diplomacy::tensorflow::ClusterDef* temp = cluster_;
...
inline ::diplomacy::tensorflow::ClusterDef* ServerDef::unsafe_arena_release_cluster() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.ServerDef.cluster)
  
  ::diplomacy::tensorflow::ClusterDef* temp = cluster_;
  cluster_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::ClusterDef* ServerDef::mutable_cluster() {
  
  if (cluster_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::ClusterDef>(GetArenaNoVirtual());
    cluster_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.ServerDef.cluster)
  return cluster_;
}
inline void ServerDef::set_allocated_cluster(::diplomacy::tensorflow::ClusterDef* cluster) {
  ...
  cluster_ = cluster;
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.ServerDef.cluster)
}
...
inline const ::std::string& ServerDef::job_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.ServerDef.job_name)
...
inline void ServerDef::set_job_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.ServerDef.job_name)
}
#if LANG_CXX11
inline void ServerDef::set_job_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.ServerDef.job_name)
}
#endif
inline void ServerDef::set_job_name(const char* value) {
  ...
  job_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.ServerDef.job_name)
}
inline void ServerDef::set_job_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.ServerDef.job_name)
}
inline ::std::string* ServerDef::mutable_job_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.ServerDef.job_name)
...
inline ::std::string* ServerDef::release_job_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.ServerDef.job_name)
...
inline void ServerDef::set_allocated_job_name(::std::string* job_name) {
  ...
  job_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), job_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.ServerDef.job_name)
}
inline ::std::string* ServerDef::unsafe_arena_release_job_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.ServerDef.job_name)
...
inline void ServerDef::unsafe_arena_set_allocated_job_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.ServerDef.job_name)
}
...
inline ::google::protobuf::int32 ServerDef::task_index() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.ServerDef.task_index)
  return task_index_;
}
inline void ServerDef::set_task_index(::google::protobuf::int32 value) {
  
  task_index_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.ServerDef.task_index)
}
...
inline const ::diplomacy::tensorflow::ConfigProto& ServerDef::_internal_default_session_config() const {
  return *default_session_config_;
}
inline const ::diplomacy::tensorflow::ConfigProto& ServerDef::default_session_config() const {
  const ::diplomacy::tensorflow::ConfigProto* p = default_session_config_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.ServerDef.default_session_config)
...
inline ::diplomacy::tensorflow::ConfigProto* ServerDef::release_default_session_config() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.ServerDef.default_session_config)
  
  ::diplomacy::tensorflow::ConfigProto* temp = default_session_config_;
  if (GetArenaNoVirtual() != NULL) {
    temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
  }
...
inline ::diplomacy::tensorflow::ConfigProto* ServerDef::unsafe_arena_release_default_session_config() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.ServerDef.default_session_config)
  
  ::diplomacy::tensorflow::ConfigProto* temp = default_session_config_;
  default_session_config_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::ConfigProto* ServerDef::mutable_default_session_config() {
  ...
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.ServerDef.default_session_config)
  return default_session_config_;
}
inline void ServerDef::set_allocated_default_session_config(::diplomacy::tensorflow::ConfigProto* default_session_config) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.ServerDef.default_session_config)
}
...
inline const ::std::string& ServerDef::protocol() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.ServerDef.protocol)
...
inline void ServerDef::set_protocol(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.ServerDef.protocol)
}
#if LANG_CXX11
inline void ServerDef::set_protocol(::std::string&& value) {
  ...
  protocol_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.ServerDef.protocol)
}
#endif
inline void ServerDef::set_protocol(const char* value) {
  ...
  protocol_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.ServerDef.protocol)
}
inline void ServerDef::set_protocol(const char* value,
    size_t size) {
  ...
  protocol_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.ServerDef.protocol)
}
inline ::std::string* ServerDef::mutable_protocol() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.ServerDef.protocol)
...
inline ::std::string* ServerDef::release_protocol() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.ServerDef.protocol)
...
inline void ServerDef::set_allocated_protocol(::std::string* protocol) {
  ...
  protocol_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), protocol,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.ServerDef.protocol)
}
inline ::std::string* ServerDef::unsafe_arena_release_protocol() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.ServerDef.protocol)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void ServerDef::unsafe_arena_set_allocated_protocol(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.ServerDef.protocol)
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2ftensorflow_5fserver_2eproto
