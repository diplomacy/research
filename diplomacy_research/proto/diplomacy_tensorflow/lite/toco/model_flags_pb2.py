...
_INPUTARRAY.fields_by_name['data_type'].enum_type = diplomacy__tensorflow_dot_lite_dot_toco_dot_types__pb2._IODATATYPE
_ARRAYSEXTRAINFO_ENTRY.fields_by_name['data_type'].enum_type = diplomacy__tensorflow_dot_lite_dot_toco_dot_types__pb2._IODATATYPE
...
InputArrayShape = _reflection.GeneratedProtocolMessageType('InputArrayShape', (_message.Message,), dict(
  ...
  __module__ = 'diplomacy_tensorflow.lite.toco.model_flags_pb2'
