...
// source: diplomacy_tensorflow/core/framework/versions.proto
...
static void InitDefaultsVersionDef() {
  ...
  {
    void* ptr = &::diplomacy::tensorflow::_VersionDef_default_instance_;
    new (ptr) ::diplomacy::tensorflow::VersionDef();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::diplomacy::tensorflow::VersionDef::InitAsDefaultInstance();
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::diplomacy::tensorflow::VersionDef, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::diplomacy::tensorflow::VersionDef, producer_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::diplomacy::tensorflow::VersionDef, min_consumer_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::diplomacy::tensorflow::VersionDef, bad_consumers_),
};
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::diplomacy::tensorflow::VersionDef)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::diplomacy::tensorflow::_VersionDef_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "diplomacy_tensorflow/core/framework/versions.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n2diplomacy_tensorflow/core/framework/ve"
      "rsions.proto\022\024diplomacy.tensorflow\"K\n\nVe"
      "rsionDef\022\020\n\010producer\030\001 \001(\005\022\024\n\014min_consum"
      "er\030\002 \001(\005\022\025\n\rbad_consumers\030\003 \003(\005Bn\n\030org.t"
      "ensorflow.frameworkB\016VersionsProtosP\001Z=g"
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "diplomacy_tensorflow/core/framework/versions.proto", &protobuf_RegisterTypes);
}
...
VersionDef::VersionDef()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:diplomacy.tensorflow.VersionDef)
}
VersionDef::VersionDef(::google::protobuf::Arena* arena)
  : ::google::protobuf::Message(),
  _internal_metadata_(arena),
  bad_consumers_(arena) {
  ::google::protobuf::internal::InitSCC(&protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2fversions_2eproto::scc_info_VersionDef.base);
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:diplomacy.tensorflow.VersionDef)
}
VersionDef::VersionDef(const VersionDef& from)
  ...
  // @@protoc_insertion_point(copy_constructor:diplomacy.tensorflow.VersionDef)
}
...
VersionDef::~VersionDef() {
  // @@protoc_insertion_point(destructor:diplomacy.tensorflow.VersionDef)
  SharedDtor();
}
...
const ::google::protobuf::Descriptor* VersionDef::descriptor() {
  ::protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2fversions_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2fversions_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
// @@protoc_insertion_point(message_clear_start:diplomacy.tensorflow.VersionDef)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:diplomacy.tensorflow.VersionDef)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:diplomacy.tensorflow.VersionDef)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:diplomacy.tensorflow.VersionDef)
  return false;
#undef DO_
}
...
void VersionDef::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:diplomacy.tensorflow.VersionDef)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:diplomacy.tensorflow.VersionDef)
}

::google::protobuf::uint8* VersionDef::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:diplomacy.tensorflow.VersionDef)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(message_byte_size_start:diplomacy.tensorflow.VersionDef)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:diplomacy.tensorflow.VersionDef)
  GOOGLE_DCHECK_NE(&from, this);
  const VersionDef* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const VersionDef>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:diplomacy.tensorflow.VersionDef)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:diplomacy.tensorflow.VersionDef)
    MergeFrom(*source);
  }
}

void VersionDef::MergeFrom(const VersionDef& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:diplomacy.tensorflow.VersionDef)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:diplomacy.tensorflow.VersionDef)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:diplomacy.tensorflow.VersionDef)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata VersionDef::GetMetadata() const {
  protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2fversions_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_diplomacy_5ftensorflow_2fcore_2fframework_2fversions_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::diplomacy::tensorflow::VersionDef* Arena::CreateMaybeMessage< ::diplomacy::tensorflow::VersionDef >(Arena* arena) {
  return Arena::CreateMessageInternal< ::diplomacy::tensorflow::VersionDef >(arena);
}
}  // namespace protobuf
}  // namespace google
