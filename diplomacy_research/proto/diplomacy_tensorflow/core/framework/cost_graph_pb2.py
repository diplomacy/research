...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/core/framework/cost_graph.proto',
...
_COSTGRAPHDEF_NODE_INPUTINFO = _descriptor.Descriptor(
  name='InputInfo',
  full_name='diplomacy.tensorflow.CostGraphDef.Node.InputInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='preceding_node', full_name='diplomacy.tensorflow.CostGraphDef.Node.InputInfo.preceding_node', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='preceding_port', full_name='diplomacy.tensorflow.CostGraphDef.Node.InputInfo.preceding_port', index=1,
...
_COSTGRAPHDEF_NODE_OUTPUTINFO = _descriptor.Descriptor(
  name='OutputInfo',
  full_name='diplomacy.tensorflow.CostGraphDef.Node.OutputInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='size', full_name='diplomacy.tensorflow.CostGraphDef.Node.OutputInfo.size', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='alias_input_port', full_name='diplomacy.tensorflow.CostGraphDef.Node.OutputInfo.alias_input_port', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='shape', full_name='diplomacy.tensorflow.CostGraphDef.Node.OutputInfo.shape', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dtype', full_name='diplomacy.tensorflow.CostGraphDef.Node.OutputInfo.dtype', index=3,
...
_COSTGRAPHDEF_NODE = _descriptor.Descriptor(
  name='Node',
  full_name='diplomacy.tensorflow.CostGraphDef.Node',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='diplomacy.tensorflow.CostGraphDef.Node.name', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='device', full_name='diplomacy.tensorflow.CostGraphDef.Node.device', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='id', full_name='diplomacy.tensorflow.CostGraphDef.Node.id', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='input_info', full_name='diplomacy.tensorflow.CostGraphDef.Node.input_info', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_info', full_name='diplomacy.tensorflow.CostGraphDef.Node.output_info', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='temporary_memory_size', full_name='diplomacy.tensorflow.CostGraphDef.Node.temporary_memory_size', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='persistent_memory_size', full_name='diplomacy.tensorflow.CostGraphDef.Node.persistent_memory_size', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='host_temp_memory_size', full_name='diplomacy.tensorflow.CostGraphDef.Node.host_temp_memory_size', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='device_temp_memory_size', full_name='diplomacy.tensorflow.CostGraphDef.Node.device_temp_memory_size', index=8,
      ...
      serialized_options=_b('\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='device_persistent_memory_size', full_name='diplomacy.tensorflow.CostGraphDef.Node.device_persistent_memory_size', index=9,
      ...
      serialized_options=_b('\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='compute_cost', full_name='diplomacy.tensorflow.CostGraphDef.Node.compute_cost', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='compute_time', full_name='diplomacy.tensorflow.CostGraphDef.Node.compute_time', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='memory_time', full_name='diplomacy.tensorflow.CostGraphDef.Node.memory_time', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_final', full_name='diplomacy.tensorflow.CostGraphDef.Node.is_final', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='control_input', full_name='diplomacy.tensorflow.CostGraphDef.Node.control_input', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='inaccurate', full_name='diplomacy.tensorflow.CostGraphDef.Node.inaccurate', index=15,
...
_COSTGRAPHDEF = _descriptor.Descriptor(
  name='CostGraphDef',
  full_name='diplomacy.tensorflow.CostGraphDef',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='node', full_name='diplomacy.tensorflow.CostGraphDef.node', index=0,
...
_COSTGRAPHDEF_NODE_OUTPUTINFO.fields_by_name['shape'].message_type = diplomacy__tensorflow_dot_core_dot_framework_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_COSTGRAPHDEF_NODE_OUTPUTINFO.fields_by_name['dtype'].enum_type = diplomacy__tensorflow_dot_core_dot_framework_dot_types__pb2._DATATYPE
...
CostGraphDef = _reflection.GeneratedProtocolMessageType('CostGraphDef', (_message.Message,), dict(
  ...
  Node = _reflection.GeneratedProtocolMessageType('Node', (_message.Message,), dict(
    ...
    InputInfo = _reflection.GeneratedProtocolMessageType('InputInfo', (_message.Message,), dict(
      ...
      __module__ = 'diplomacy_tensorflow.core.framework.cost_graph_pb2'
