...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fdevice_5fproperties_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fdevice_5fproperties_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fdevice_5fproperties_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::DeviceProperties* Arena::CreateMaybeMessage<::diplomacy::tensorflow::DeviceProperties>(Arena*);
template<> ::diplomacy::tensorflow::DeviceProperties_EnvironmentEntry_DoNotUse* Arena::CreateMaybeMessage<::diplomacy::tensorflow::DeviceProperties_EnvironmentEntry_DoNotUse>(Arena*);
template<> ::diplomacy::tensorflow::NamedDevice* Arena::CreateMaybeMessage<::diplomacy::tensorflow::NamedDevice>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class DeviceProperties : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.DeviceProperties) */ {
 public:
  DeviceProperties();
  ...
  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.DeviceProperties)
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fdevice_5fproperties_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class NamedDevice : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.NamedDevice) */ {
 public:
  NamedDevice();
  virtual ~NamedDevice();
  ...
  private:
  const ::diplomacy::tensorflow::DeviceProperties& _internal_properties() const;
  public:
  const ::diplomacy::tensorflow::DeviceProperties& properties() const;
  ::diplomacy::tensorflow::DeviceProperties* release_properties();
  ::diplomacy::tensorflow::DeviceProperties* mutable_properties();
  void set_allocated_properties(::diplomacy::tensorflow::DeviceProperties* properties);
  void unsafe_arena_set_allocated_properties(
      ::diplomacy::tensorflow::DeviceProperties* properties);
  ::diplomacy::tensorflow::DeviceProperties* unsafe_arena_release_properties();

  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.NamedDevice)
 private:
  ...
  ::diplomacy::tensorflow::DeviceProperties* properties_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fdevice_5fproperties_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::std::string& DeviceProperties::type() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DeviceProperties.type)
  return type_.Get();
}
inline void DeviceProperties::set_type(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DeviceProperties.type)
}
#if LANG_CXX11
inline void DeviceProperties::set_type(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.DeviceProperties.type)
}
#endif
inline void DeviceProperties::set_type(const char* value) {
  ...
  type_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.DeviceProperties.type)
}
inline void DeviceProperties::set_type(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.DeviceProperties.type)
}
inline ::std::string* DeviceProperties::mutable_type() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.DeviceProperties.type)
...
inline ::std::string* DeviceProperties::release_type() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.DeviceProperties.type)
...
inline void DeviceProperties::set_allocated_type(::std::string* type) {
  ...
  type_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), type,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.DeviceProperties.type)
}
inline ::std::string* DeviceProperties::unsafe_arena_release_type() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.DeviceProperties.type)
...
inline void DeviceProperties::unsafe_arena_set_allocated_type(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.DeviceProperties.type)
}
...
inline const ::std::string& DeviceProperties::vendor() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DeviceProperties.vendor)
  return vendor_.Get();
}
inline void DeviceProperties::set_vendor(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DeviceProperties.vendor)
}
#if LANG_CXX11
inline void DeviceProperties::set_vendor(::std::string&& value) {
  ...
  vendor_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.DeviceProperties.vendor)
}
#endif
inline void DeviceProperties::set_vendor(const char* value) {
  ...
  vendor_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.DeviceProperties.vendor)
}
inline void DeviceProperties::set_vendor(const char* value,
    size_t size) {
  ...
  vendor_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.DeviceProperties.vendor)
}
inline ::std::string* DeviceProperties::mutable_vendor() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.DeviceProperties.vendor)
...
inline ::std::string* DeviceProperties::release_vendor() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.DeviceProperties.vendor)
...
inline void DeviceProperties::set_allocated_vendor(::std::string* vendor) {
  ...
  vendor_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), vendor,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.DeviceProperties.vendor)
}
inline ::std::string* DeviceProperties::unsafe_arena_release_vendor() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.DeviceProperties.vendor)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void DeviceProperties::unsafe_arena_set_allocated_vendor(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.DeviceProperties.vendor)
}
...
inline const ::std::string& DeviceProperties::model() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DeviceProperties.model)
  return model_.Get();
}
inline void DeviceProperties::set_model(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DeviceProperties.model)
}
#if LANG_CXX11
inline void DeviceProperties::set_model(::std::string&& value) {
  ...
  model_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.DeviceProperties.model)
}
#endif
inline void DeviceProperties::set_model(const char* value) {
  ...
  model_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.DeviceProperties.model)
}
inline void DeviceProperties::set_model(const char* value,
    size_t size) {
  ...
  model_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.DeviceProperties.model)
}
inline ::std::string* DeviceProperties::mutable_model() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.DeviceProperties.model)
...
inline ::std::string* DeviceProperties::release_model() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.DeviceProperties.model)
...
inline void DeviceProperties::set_allocated_model(::std::string* model) {
  ...
  model_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), model,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.DeviceProperties.model)
}
inline ::std::string* DeviceProperties::unsafe_arena_release_model() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.DeviceProperties.model)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void DeviceProperties::unsafe_arena_set_allocated_model(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.DeviceProperties.model)
}
...
inline ::google::protobuf::int64 DeviceProperties::frequency() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DeviceProperties.frequency)
  return frequency_;
}
inline void DeviceProperties::set_frequency(::google::protobuf::int64 value) {
  
  frequency_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DeviceProperties.frequency)
}
...
inline ::google::protobuf::int64 DeviceProperties::num_cores() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DeviceProperties.num_cores)
  return num_cores_;
}
inline void DeviceProperties::set_num_cores(::google::protobuf::int64 value) {
  
  num_cores_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DeviceProperties.num_cores)
}
...
DeviceProperties::environment() const {
  // @@protoc_insertion_point(field_map:diplomacy.tensorflow.DeviceProperties.environment)
  return environment_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::std::string >*
DeviceProperties::mutable_environment() {
  // @@protoc_insertion_point(field_mutable_map:diplomacy.tensorflow.DeviceProperties.environment)
...
inline ::google::protobuf::int64 DeviceProperties::num_registers() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DeviceProperties.num_registers)
  return num_registers_;
}
inline void DeviceProperties::set_num_registers(::google::protobuf::int64 value) {
  
  num_registers_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DeviceProperties.num_registers)
}
...
inline ::google::protobuf::int64 DeviceProperties::l1_cache_size() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DeviceProperties.l1_cache_size)
  return l1_cache_size_;
}
inline void DeviceProperties::set_l1_cache_size(::google::protobuf::int64 value) {
  
  l1_cache_size_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DeviceProperties.l1_cache_size)
}
...
inline ::google::protobuf::int64 DeviceProperties::l2_cache_size() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DeviceProperties.l2_cache_size)
  return l2_cache_size_;
}
inline void DeviceProperties::set_l2_cache_size(::google::protobuf::int64 value) {
  
  l2_cache_size_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DeviceProperties.l2_cache_size)
}
...
inline ::google::protobuf::int64 DeviceProperties::l3_cache_size() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DeviceProperties.l3_cache_size)
  return l3_cache_size_;
}
inline void DeviceProperties::set_l3_cache_size(::google::protobuf::int64 value) {
  
  l3_cache_size_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DeviceProperties.l3_cache_size)
}
...
inline ::google::protobuf::int64 DeviceProperties::shared_memory_size_per_multiprocessor() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DeviceProperties.shared_memory_size_per_multiprocessor)
...
inline void DeviceProperties::set_shared_memory_size_per_multiprocessor(::google::protobuf::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DeviceProperties.shared_memory_size_per_multiprocessor)
}
...
inline ::google::protobuf::int64 DeviceProperties::memory_size() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DeviceProperties.memory_size)
  return memory_size_;
}
inline void DeviceProperties::set_memory_size(::google::protobuf::int64 value) {
  
  memory_size_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DeviceProperties.memory_size)
}
...
inline ::google::protobuf::int64 DeviceProperties::bandwidth() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.DeviceProperties.bandwidth)
  return bandwidth_;
}
inline void DeviceProperties::set_bandwidth(::google::protobuf::int64 value) {
  
  bandwidth_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.DeviceProperties.bandwidth)
}
...
inline const ::std::string& NamedDevice::name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.NamedDevice.name)
  return name_.Get();
}
inline void NamedDevice::set_name(const ::std::string& value) {
  
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.NamedDevice.name)
}
#if LANG_CXX11
inline void NamedDevice::set_name(::std::string&& value) {
  ...
  name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.NamedDevice.name)
}
#endif
inline void NamedDevice::set_name(const char* value) {
  ...
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.NamedDevice.name)
}
inline void NamedDevice::set_name(const char* value,
    size_t size) {
  ...
  name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.NamedDevice.name)
}
inline ::std::string* NamedDevice::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.NamedDevice.name)
  return name_.Mutable(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline ::std::string* NamedDevice::release_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.NamedDevice.name)
...
inline void NamedDevice::set_allocated_name(::std::string* name) {
  ...
  name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.NamedDevice.name)
}
inline ::std::string* NamedDevice::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.NamedDevice.name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void NamedDevice::unsafe_arena_set_allocated_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.NamedDevice.name)
}
...
inline const ::diplomacy::tensorflow::DeviceProperties& NamedDevice::_internal_properties() const {
  return *properties_;
}
inline const ::diplomacy::tensorflow::DeviceProperties& NamedDevice::properties() const {
  const ::diplomacy::tensorflow::DeviceProperties* p = properties_;
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.NamedDevice.properties)
...
inline ::diplomacy::tensorflow::DeviceProperties* NamedDevice::release_properties() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.NamedDevice.properties)
  
  ::diplomacy::tensorflow::DeviceProperties* temp = properties_;
...
inline ::diplomacy::tensorflow::DeviceProperties* NamedDevice::unsafe_arena_release_properties() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.NamedDevice.properties)
  
  ::diplomacy::tensorflow::DeviceProperties* temp = properties_;
  properties_ = NULL;
  return temp;
}
inline ::diplomacy::tensorflow::DeviceProperties* NamedDevice::mutable_properties() {
  
  if (properties_ == NULL) {
    auto* p = CreateMaybeMessage<::diplomacy::tensorflow::DeviceProperties>(GetArenaNoVirtual());
    properties_ = p;
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.NamedDevice.properties)
  return properties_;
}
inline void NamedDevice::set_allocated_properties(::diplomacy::tensorflow::DeviceProperties* properties) {
  ...
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.NamedDevice.properties)
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fdevice_5fproperties_2eproto
