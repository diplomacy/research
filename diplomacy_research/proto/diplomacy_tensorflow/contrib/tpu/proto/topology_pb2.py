...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='diplomacy_tensorflow/contrib/tpu/proto/topology.proto',
...
_TOPOLOGYPROTO = _descriptor.Descriptor(
  name='TopologyProto',
  full_name='diplomacy.tensorflow.tpu.TopologyProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='mesh_shape', full_name='diplomacy.tensorflow.tpu.TopologyProto.mesh_shape', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='num_tasks', full_name='diplomacy.tensorflow.tpu.TopologyProto.num_tasks', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_tpu_devices_per_task', full_name='diplomacy.tensorflow.tpu.TopologyProto.num_tpu_devices_per_task', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='device_coordinates', full_name='diplomacy.tensorflow.tpu.TopologyProto.device_coordinates', index=3,
...
TopologyProto = _reflection.GeneratedProtocolMessageType('TopologyProto', (_message.Message,), dict(
  ...
  __module__ = 'diplomacy_tensorflow.contrib.tpu.proto.topology_pb2'
