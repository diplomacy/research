...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fsaver_2eproto
#define PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fsaver_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fsaver_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::SaverDef* Arena::CreateMaybeMessage<::diplomacy::tensorflow::SaverDef>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class SaverDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.SaverDef) */ {
 public:
  SaverDef();
  virtual ~SaverDef();
  ...
  ::diplomacy::tensorflow::SaverDef_CheckpointFormatVersion version() const;
  void set_version(::diplomacy::tensorflow::SaverDef_CheckpointFormatVersion value);

  // @@protoc_insertion_point(class_scope:diplomacy.tensorflow.SaverDef)
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fsaver_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::std::string& SaverDef::filename_tensor_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.SaverDef.filename_tensor_name)
...
inline void SaverDef::set_filename_tensor_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.SaverDef.filename_tensor_name)
}
#if LANG_CXX11
inline void SaverDef::set_filename_tensor_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.SaverDef.filename_tensor_name)
}
#endif
inline void SaverDef::set_filename_tensor_name(const char* value) {
  ...
  filename_tensor_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.SaverDef.filename_tensor_name)
}
inline void SaverDef::set_filename_tensor_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.SaverDef.filename_tensor_name)
}
inline ::std::string* SaverDef::mutable_filename_tensor_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.SaverDef.filename_tensor_name)
...
inline ::std::string* SaverDef::release_filename_tensor_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.SaverDef.filename_tensor_name)
...
inline void SaverDef::set_allocated_filename_tensor_name(::std::string* filename_tensor_name) {
  ...
  filename_tensor_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), filename_tensor_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.SaverDef.filename_tensor_name)
}
inline ::std::string* SaverDef::unsafe_arena_release_filename_tensor_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.SaverDef.filename_tensor_name)
...
inline void SaverDef::unsafe_arena_set_allocated_filename_tensor_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.SaverDef.filename_tensor_name)
}
...
inline const ::std::string& SaverDef::save_tensor_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.SaverDef.save_tensor_name)
...
inline void SaverDef::set_save_tensor_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.SaverDef.save_tensor_name)
}
#if LANG_CXX11
inline void SaverDef::set_save_tensor_name(::std::string&& value) {
  ...
  save_tensor_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.SaverDef.save_tensor_name)
}
#endif
inline void SaverDef::set_save_tensor_name(const char* value) {
  ...
  save_tensor_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.SaverDef.save_tensor_name)
}
inline void SaverDef::set_save_tensor_name(const char* value,
    size_t size) {
  ...
  save_tensor_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.SaverDef.save_tensor_name)
}
inline ::std::string* SaverDef::mutable_save_tensor_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.SaverDef.save_tensor_name)
...
inline ::std::string* SaverDef::release_save_tensor_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.SaverDef.save_tensor_name)
...
inline void SaverDef::set_allocated_save_tensor_name(::std::string* save_tensor_name) {
  ...
  save_tensor_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), save_tensor_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.SaverDef.save_tensor_name)
}
inline ::std::string* SaverDef::unsafe_arena_release_save_tensor_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.SaverDef.save_tensor_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void SaverDef::unsafe_arena_set_allocated_save_tensor_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.SaverDef.save_tensor_name)
}
...
inline const ::std::string& SaverDef::restore_op_name() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.SaverDef.restore_op_name)
...
inline void SaverDef::set_restore_op_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.SaverDef.restore_op_name)
}
#if LANG_CXX11
inline void SaverDef::set_restore_op_name(::std::string&& value) {
  ...
  restore_op_name_.Set(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:diplomacy.tensorflow.SaverDef.restore_op_name)
}
#endif
inline void SaverDef::set_restore_op_name(const char* value) {
  ...
  restore_op_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.SaverDef.restore_op_name)
}
inline void SaverDef::set_restore_op_name(const char* value,
    size_t size) {
  ...
  restore_op_name_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.SaverDef.restore_op_name)
}
inline ::std::string* SaverDef::mutable_restore_op_name() {
  
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.SaverDef.restore_op_name)
...
inline ::std::string* SaverDef::release_restore_op_name() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.SaverDef.restore_op_name)
...
inline void SaverDef::set_allocated_restore_op_name(::std::string* restore_op_name) {
  ...
  restore_op_name_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), restore_op_name,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:diplomacy.tensorflow.SaverDef.restore_op_name)
}
inline ::std::string* SaverDef::unsafe_arena_release_restore_op_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.SaverDef.restore_op_name)
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
...
inline void SaverDef::unsafe_arena_set_allocated_restore_op_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.SaverDef.restore_op_name)
}
...
inline ::google::protobuf::int32 SaverDef::max_to_keep() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.SaverDef.max_to_keep)
  return max_to_keep_;
}
inline void SaverDef::set_max_to_keep(::google::protobuf::int32 value) {
  
  max_to_keep_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.SaverDef.max_to_keep)
}
...
inline bool SaverDef::sharded() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.SaverDef.sharded)
  return sharded_;
}
inline void SaverDef::set_sharded(bool value) {
  
  sharded_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.SaverDef.sharded)
}
...
inline float SaverDef::keep_checkpoint_every_n_hours() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.SaverDef.keep_checkpoint_every_n_hours)
...
inline void SaverDef::set_keep_checkpoint_every_n_hours(float value) {
  ...
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.SaverDef.keep_checkpoint_every_n_hours)
}
...
inline ::diplomacy::tensorflow::SaverDef_CheckpointFormatVersion SaverDef::version() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.SaverDef.version)
  return static_cast< ::diplomacy::tensorflow::SaverDef_CheckpointFormatVersion >(version_);
}
inline void SaverDef::set_version(::diplomacy::tensorflow::SaverDef_CheckpointFormatVersion value) {
  
  version_ = value;
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.SaverDef.version)
}
...
template <> struct is_proto_enum< ::diplomacy::tensorflow::SaverDef_CheckpointFormatVersion> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::diplomacy::tensorflow::SaverDef_CheckpointFormatVersion>() {
  return ::diplomacy::tensorflow::SaverDef_CheckpointFormatVersion_descriptor();
}
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fprotobuf_2fsaver_2eproto
