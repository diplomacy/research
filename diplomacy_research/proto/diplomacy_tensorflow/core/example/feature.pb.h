...
#ifndef PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fexample_2ffeature_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_diplomacy_5ftensorflow_2fcore_2fexample_2ffeature_2eproto 
...
namespace google {
namespace protobuf {
template<> ::diplomacy::tensorflow::BytesList* Arena::CreateMaybeMessage<::diplomacy::tensorflow::BytesList>(Arena*);
template<> ::diplomacy::tensorflow::Feature* Arena::CreateMaybeMessage<::diplomacy::tensorflow::Feature>(Arena*);
template<> ::diplomacy::tensorflow::FeatureList* Arena::CreateMaybeMessage<::diplomacy::tensorflow::FeatureList>(Arena*);
template<> ::diplomacy::tensorflow::FeatureLists* Arena::CreateMaybeMessage<::diplomacy::tensorflow::FeatureLists>(Arena*);
template<> ::diplomacy::tensorflow::FeatureLists_FeatureListEntry_DoNotUse* Arena::CreateMaybeMessage<::diplomacy::tensorflow::FeatureLists_FeatureListEntry_DoNotUse>(Arena*);
template<> ::diplomacy::tensorflow::Features* Arena::CreateMaybeMessage<::diplomacy::tensorflow::Features>(Arena*);
template<> ::diplomacy::tensorflow::Features_FeatureEntry_DoNotUse* Arena::CreateMaybeMessage<::diplomacy::tensorflow::Features_FeatureEntry_DoNotUse>(Arena*);
template<> ::diplomacy::tensorflow::FloatList* Arena::CreateMaybeMessage<::diplomacy::tensorflow::FloatList>(Arena*);
template<> ::diplomacy::tensorflow::Int64List* Arena::CreateMaybeMessage<::diplomacy::tensorflow::Int64List>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace diplomacy {
namespace tensorflow {
...
class BytesList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.BytesList) */ {
 public:
  BytesList();
  virtual ~BytesList();
 ...
 private:
  ...
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fexample_2ffeature_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class FloatList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.FloatList) */ {
 public:
  FloatList();
  virtual ~FloatList();
...
class Int64List : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.Int64List) */ {
 public:
  Int64List();
  virtual ~Int64List();
...
class Feature : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.Feature) */ {
 public:
  Feature();
  virtual ~Feature();
  ...
  private:
  const ::diplomacy::tensorflow::BytesList& _internal_bytes_list() const;
  public:
  const ::diplomacy::tensorflow::BytesList& bytes_list() const;
  ::diplomacy::tensorflow::BytesList* release_bytes_list();
  ::diplomacy::tensorflow::BytesList* mutable_bytes_list();
  void set_allocated_bytes_list(::diplomacy::tensorflow::BytesList* bytes_list);
  void unsafe_arena_set_allocated_bytes_list(
      ::diplomacy::tensorflow::BytesList* bytes_list);
  ::diplomacy::tensorflow::BytesList* unsafe_arena_release_bytes_list();
  ...
  private:
  const ::diplomacy::tensorflow::FloatList& _internal_float_list() const;
  public:
  const ::diplomacy::tensorflow::FloatList& float_list() const;
  ::diplomacy::tensorflow::FloatList* release_float_list();
  ::diplomacy::tensorflow::FloatList* mutable_float_list();
  void set_allocated_float_list(::diplomacy::tensorflow::FloatList* float_list);
  void unsafe_arena_set_allocated_float_list(
      ::diplomacy::tensorflow::FloatList* float_list);
  ::diplomacy::tensorflow::FloatList* unsafe_arena_release_float_list();
  ...
  private:
  const ::diplomacy::tensorflow::Int64List& _internal_int64_list() const;
  public:
  const ::diplomacy::tensorflow::Int64List& int64_list() const;
  ::diplomacy::tensorflow::Int64List* release_int64_list();
  ::diplomacy::tensorflow::Int64List* mutable_int64_list();
  void set_allocated_int64_list(::diplomacy::tensorflow::Int64List* int64_list);
  void unsafe_arena_set_allocated_int64_list(
      ::diplomacy::tensorflow::Int64List* int64_list);
  ::diplomacy::tensorflow::Int64List* unsafe_arena_release_int64_list();
 ...
 private:
  ...
  union KindUnion {
    KindUnion() {}
    ::diplomacy::tensorflow::BytesList* bytes_list_;
    ::diplomacy::tensorflow::FloatList* float_list_;
    ::diplomacy::tensorflow::Int64List* int64_list_;
  } kind_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
...
class Features : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.Features) */ {
 public:
  Features();
  virtual ~Features();
  ...
  const ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::Feature >&
      feature() const;
  ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::Feature >*
      mutable_feature();
...
class FeatureList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.FeatureList) */ {
 public:
  FeatureList();
  virtual ~FeatureList();
  ...
  void clear_feature();
  static const int kFeatureFieldNumber = 1;
  ::diplomacy::tensorflow::Feature* mutable_feature(int index);
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::Feature >*
      mutable_feature();
  const ::diplomacy::tensorflow::Feature& feature(int index) const;
  ::diplomacy::tensorflow::Feature* add_feature();
  const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::Feature >&
      feature() const;
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::Feature > feature_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_diplomacy_5ftensorflow_2fcore_2fexample_2ffeature_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class FeatureLists : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:diplomacy.tensorflow.FeatureLists) */ {
 public:
  FeatureLists();
  ...
  const ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::FeatureList >&
      feature_list() const;
  ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::FeatureList >*
...
inline const ::std::string& BytesList::value(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.BytesList.value)
  return value_.Get(index);
}
inline ::std::string* BytesList::mutable_value(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.BytesList.value)
  return value_.Mutable(index);
}
inline void BytesList::set_value(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.BytesList.value)
...
inline void BytesList::set_value(int index, const char* value) {
  ...
  value_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:diplomacy.tensorflow.BytesList.value)
}
inline void BytesList::set_value(int index, const void* value, size_t size) {
  value_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:diplomacy.tensorflow.BytesList.value)
}
inline ::std::string* BytesList::add_value() {
  // @@protoc_insertion_point(field_add_mutable:diplomacy.tensorflow.BytesList.value)
  return value_.Add();
}
inline void BytesList::add_value(const ::std::string& value) {
  value_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.BytesList.value)
}
#if LANG_CXX11
...
inline void BytesList::add_value(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  value_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:diplomacy.tensorflow.BytesList.value)
}
inline void BytesList::add_value(const void* value, size_t size) {
  value_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:diplomacy.tensorflow.BytesList.value)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
BytesList::value() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.BytesList.value)
  return value_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
BytesList::mutable_value() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.BytesList.value)
  return &value_;
}
...
inline float FloatList::value(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.FloatList.value)
  return value_.Get(index);
}
inline void FloatList::set_value(int index, float value) {
  value_.Set(index, value);
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.FloatList.value)
}
inline void FloatList::add_value(float value) {
  value_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.FloatList.value)
}
inline const ::google::protobuf::RepeatedField< float >&
FloatList::value() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.FloatList.value)
  return value_;
}
inline ::google::protobuf::RepeatedField< float >*
FloatList::mutable_value() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.FloatList.value)
  return &value_;
}
...
inline ::google::protobuf::int64 Int64List::value(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.Int64List.value)
  return value_.Get(index);
}
inline void Int64List::set_value(int index, ::google::protobuf::int64 value) {
  value_.Set(index, value);
  // @@protoc_insertion_point(field_set:diplomacy.tensorflow.Int64List.value)
}
inline void Int64List::add_value(::google::protobuf::int64 value) {
  value_.Add(value);
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.Int64List.value)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
Int64List::value() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.Int64List.value)
  return value_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
Int64List::mutable_value() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.Int64List.value)
  return &value_;
}
...
inline const ::diplomacy::tensorflow::BytesList& Feature::_internal_bytes_list() const {
  return *kind_.bytes_list_;
}
inline ::diplomacy::tensorflow::BytesList* Feature::release_bytes_list() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.Feature.bytes_list)
  if (has_bytes_list()) {
    clear_has_kind();
      ::diplomacy::tensorflow::BytesList* temp = kind_.bytes_list_;
    if (GetArenaNoVirtual() != NULL) {
...
inline const ::diplomacy::tensorflow::BytesList& Feature::bytes_list() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.Feature.bytes_list)
  return has_bytes_list()
      ? *kind_.bytes_list_
      : *reinterpret_cast< ::diplomacy::tensorflow::BytesList*>(&::diplomacy::tensorflow::_BytesList_default_instance_);
}
inline ::diplomacy::tensorflow::BytesList* Feature::unsafe_arena_release_bytes_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.Feature.bytes_list)
  if (has_bytes_list()) {
    clear_has_kind();
    ::diplomacy::tensorflow::BytesList* temp = kind_.bytes_list_;
    kind_.bytes_list_ = NULL;
...
inline void Feature::unsafe_arena_set_allocated_bytes_list(::diplomacy::tensorflow::BytesList* bytes_list) {
  clear_kind();
  if (bytes_list) {
    set_has_bytes_list();
    kind_.bytes_list_ = bytes_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.Feature.bytes_list)
}
inline ::diplomacy::tensorflow::BytesList* Feature::mutable_bytes_list() {
  if (!has_bytes_list()) {
    clear_kind();
    set_has_bytes_list();
    kind_.bytes_list_ = CreateMaybeMessage< ::diplomacy::tensorflow::BytesList >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.Feature.bytes_list)
  return kind_.bytes_list_;
}
...
inline const ::diplomacy::tensorflow::FloatList& Feature::_internal_float_list() const {
  return *kind_.float_list_;
}
inline ::diplomacy::tensorflow::FloatList* Feature::release_float_list() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.Feature.float_list)
  if (has_float_list()) {
    clear_has_kind();
      ::diplomacy::tensorflow::FloatList* temp = kind_.float_list_;
    if (GetArenaNoVirtual() != NULL) {
      temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::diplomacy::tensorflow::FloatList& Feature::float_list() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.Feature.float_list)
  return has_float_list()
      ? *kind_.float_list_
      : *reinterpret_cast< ::diplomacy::tensorflow::FloatList*>(&::diplomacy::tensorflow::_FloatList_default_instance_);
}
inline ::diplomacy::tensorflow::FloatList* Feature::unsafe_arena_release_float_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.Feature.float_list)
  if (has_float_list()) {
    clear_has_kind();
    ::diplomacy::tensorflow::FloatList* temp = kind_.float_list_;
    kind_.float_list_ = NULL;
...
inline void Feature::unsafe_arena_set_allocated_float_list(::diplomacy::tensorflow::FloatList* float_list) {
  clear_kind();
  if (float_list) {
    set_has_float_list();
    kind_.float_list_ = float_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.Feature.float_list)
}
inline ::diplomacy::tensorflow::FloatList* Feature::mutable_float_list() {
  if (!has_float_list()) {
    clear_kind();
    set_has_float_list();
    kind_.float_list_ = CreateMaybeMessage< ::diplomacy::tensorflow::FloatList >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.Feature.float_list)
  return kind_.float_list_;
}
...
inline const ::diplomacy::tensorflow::Int64List& Feature::_internal_int64_list() const {
  return *kind_.int64_list_;
}
inline ::diplomacy::tensorflow::Int64List* Feature::release_int64_list() {
  // @@protoc_insertion_point(field_release:diplomacy.tensorflow.Feature.int64_list)
  if (has_int64_list()) {
    clear_has_kind();
      ::diplomacy::tensorflow::Int64List* temp = kind_.int64_list_;
    if (GetArenaNoVirtual() != NULL) {
      temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::diplomacy::tensorflow::Int64List& Feature::int64_list() const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.Feature.int64_list)
  return has_int64_list()
      ? *kind_.int64_list_
      : *reinterpret_cast< ::diplomacy::tensorflow::Int64List*>(&::diplomacy::tensorflow::_Int64List_default_instance_);
}
inline ::diplomacy::tensorflow::Int64List* Feature::unsafe_arena_release_int64_list() {
  // @@protoc_insertion_point(field_unsafe_arena_release:diplomacy.tensorflow.Feature.int64_list)
  if (has_int64_list()) {
    clear_has_kind();
    ::diplomacy::tensorflow::Int64List* temp = kind_.int64_list_;
    kind_.int64_list_ = NULL;
...
inline void Feature::unsafe_arena_set_allocated_int64_list(::diplomacy::tensorflow::Int64List* int64_list) {
  clear_kind();
  if (int64_list) {
    set_has_int64_list();
    kind_.int64_list_ = int64_list;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:diplomacy.tensorflow.Feature.int64_list)
}
inline ::diplomacy::tensorflow::Int64List* Feature::mutable_int64_list() {
  if (!has_int64_list()) {
    clear_kind();
    set_has_int64_list();
    kind_.int64_list_ = CreateMaybeMessage< ::diplomacy::tensorflow::Int64List >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.Feature.int64_list)
  return kind_.int64_list_;
}
...
inline const ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::Feature >&
Features::feature() const {
  // @@protoc_insertion_point(field_map:diplomacy.tensorflow.Features.feature)
  return feature_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::Feature >*
Features::mutable_feature() {
  // @@protoc_insertion_point(field_mutable_map:diplomacy.tensorflow.Features.feature)
...
inline ::diplomacy::tensorflow::Feature* FeatureList::mutable_feature(int index) {
  // @@protoc_insertion_point(field_mutable:diplomacy.tensorflow.FeatureList.feature)
  return feature_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::Feature >*
FeatureList::mutable_feature() {
  // @@protoc_insertion_point(field_mutable_list:diplomacy.tensorflow.FeatureList.feature)
  return &feature_;
}
inline const ::diplomacy::tensorflow::Feature& FeatureList::feature(int index) const {
  // @@protoc_insertion_point(field_get:diplomacy.tensorflow.FeatureList.feature)
  return feature_.Get(index);
}
inline ::diplomacy::tensorflow::Feature* FeatureList::add_feature() {
  // @@protoc_insertion_point(field_add:diplomacy.tensorflow.FeatureList.feature)
  return feature_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::diplomacy::tensorflow::Feature >&
FeatureList::feature() const {
  // @@protoc_insertion_point(field_list:diplomacy.tensorflow.FeatureList.feature)
  return feature_;
}
...
inline const ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::FeatureList >&
FeatureLists::feature_list() const {
  // @@protoc_insertion_point(field_map:diplomacy.tensorflow.FeatureLists.feature_list)
  return feature_list_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::diplomacy::tensorflow::FeatureList >*
FeatureLists::mutable_feature_list() {
  // @@protoc_insertion_point(field_mutable_map:diplomacy.tensorflow.FeatureLists.feature_list)
...
#endif  // PROTOBUF_INCLUDED_diplomacy_5ftensorflow_2fcore_2fexample_2ffeature_2eproto
